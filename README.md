...
The list was updated at 01:55:36 03/16/19 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 71459 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17466 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13428 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11698 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7274 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6662 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5821 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 5052 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4852 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4791 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4227 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3448 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3342 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3098 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [retejs/rete](https://github.com/retejs/rete) | 2960 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2932 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2698 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts'` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2465 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2367 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2286 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1973 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [staltz/xstream](https://github.com/staltz/xstream) | 1800 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1596 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1554 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1510 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1510 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1504 | `nyc -x '' mocha` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1445 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1373 | `mocha --opts mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 1361 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1277 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [funkia/list](https://github.com/funkia/list) | 1264 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1228 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [google/gts](https://github.com/google/gts) | 1204 | `nyc mocha build/test` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1184 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1130 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1122 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 1036 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [youzan/zan-proxy](https://github.com/youzan/zan-proxy) | 995 | `nyc mocha dist/**/*.spec.js` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 993 | `mocha bin/tests/test.js` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 984 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 960 | `mocha --opts test/mocha.opts` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 800 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 734 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 662 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 637 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [szokodiakos/typegoose](https://github.com/szokodiakos/typegoose) | 623 | `npm run lint && nyc npm run mocha` | 
...
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 613 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 604 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
| [bbc/sqs-consumer](https://github.com/bbc/sqs-consumer) | 598 | `mocha` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 558 | `tsc && mocha test && yarn lint` | 
| [SierraSoftworks/Iridium](https://github.com/SierraSoftworks/Iridium) | 537 | `mocha --opts test/mocha.opts dist/test` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 534 | `cd test && mocha -r ts-node/register *.ts` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 532 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 514 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 504 | `npm run mocha` | 
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 502 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 499 | `npm run lint && npm run mocha` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 494 | `mocha --opts mocha.opts` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 490 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 445 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 365 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 351 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 341 | `mocha` | 
...
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 327 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 319 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 302 | `mocha lib/test` | 
| [alibaba/pont](https://github.com/alibaba/pont) | 300 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
| [mgechev/aspect.js](https://github.com/mgechev/aspect.js) | 298 | `tsc && mocha -R nyan ./dist/test/**/*.spec.js` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 298 | `cd test && mocha -r ts-node/register *.ts` | 
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 294 | `mocha-webpack "src/**/*.ts"` | 
| [FinNLP/en-inflectors](https://github.com/FinNLP/en-inflectors) | 293 | `mocha` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 283 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [RisingStack/node-typescript-starter](https://github.com/RisingStack/node-typescript-starter) | 269 | `tsc && mocha dist/**/*.spec.js` | 
...
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 260 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
...
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 247 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 203 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
| [zekelevu/typeframework](https://github.com/zekelevu/typeframework) | 200 | `mocha -R spec test/integration` | 
| [JumpFm/jumpfm](https://github.com/JumpFm/jumpfm) | 197 | `mocha js` | 
...
| [pnp/office365-cli](https://github.com/pnp/office365-cli) | 192 | `nyc -r=lcov -r=text mocha "dist/**/*.spec.js"` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 173 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [TrustWallet/trust-ray](https://github.com/TrustWallet/trust-ray) | 143 | `cross-env NODE_ENV=test mocha --recursive --require ts-node/register 'test/**/*.test.ts' --exit` | 
...
| [arfedulov/semantic-ui-calendar-react](https://github.com/arfedulov/semantic-ui-calendar-react) | 144 | `npx cross-env TS_NODE_COMPILER_OPTIONS="{""allowJs"":true}" npx mocha -r ts-node/register ./test/setup.js ./test/**/*.{js,jsx,ts,tsx}` | 
| [calidion/vig](https://github.com/calidion/vig) | 143 | `npm run build && nyc --reporter=text --reporter=html --reporter=lcov mocha --bail --compilers ts:ts-node/register --recursive 'test/**/*.test.ts'` | 
| [TrustWallet/trust-ray](https://github.com/TrustWallet/trust-ray) | 143 | `cross-env NODE_ENV=test mocha --recursive --require ts-node/register 'test/**/*.test.ts' --exit` | 
| [Soluto/graphql-to-mongodb](https://github.com/Soluto/graphql-to-mongodb) | 143 | `ts-mocha tests/**/*.spec.ts` | 
...
| [jvilk/MakeTypes](https://github.com/jvilk/MakeTypes) | 119 | `npm-run-all --serial prepublish generate:test build:test mocha` | 
...
| [googleapis/nodejs-pubsub](https://github.com/googleapis/nodejs-pubsub) | 117 | `nyc mocha build/test` | 
...
| [Azure/azure-cosmos-js](https://github.com/Azure/azure-cosmos-js) | 95 | `mocha -r ./src/test/common/setup.ts ./lib/src/test/ --recursive --timeout 100000 -i -g .*ignore.js` | 
...
| [dupski/json-to-graphql-query](https://github.com/dupski/json-to-graphql-query) | 72 | `mocha -r ts-node/register --recursive "./src/**/__tests__/*"` | 
| [ngduc/node-rem](https://github.com/ngduc/node-rem) | 72 | `cross-env NODE_ENV=test nyc --reporter=html --reporter=text --reporter=lcov mocha --require ts-node/register --full-trace --bail --timeout 20000 --exit tests/**/*.ts` | 
...
| [angular-extensions/model](https://github.com/angular-extensions/model) | 64 | `npm run lint && npm run format:test && nyc mocha {lib,schematics}/**/*.test.ts --require ts-node/register --require source-map-support/register` | 
...
| [RobinBuschmann/react.di](https://github.com/RobinBuschmann/react.di) | 49 | `mocha` | 
...
| [googleapis/github-repo-automation](https://github.com/googleapis/github-repo-automation) | 39 | `nyc mocha build/test` | 
