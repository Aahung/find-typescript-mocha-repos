...
The list was updated at 00:43:51 09/24/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 59819 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 14913 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 8875 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8310 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6763 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5678 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4771 | `npm run mocha` | 
| [Microsoft/sqlopsstudio](https://github.com/Microsoft/sqlopsstudio) | 4359 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 3973 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3262 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2737 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2553 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2405 | `mocha 'test/**/*.ts'` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2367 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2039 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 1994 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1788 | `mocha` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1783 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1726 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1649 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1232 | `nyc -x '' mocha` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1232 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1183 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [funkia/list](https://github.com/funkia/list) | 1173 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1119 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1070 | `mocha --opts mocha.opts` | 
...
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 902 | `mocha --opts test/mocha.opts` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 836 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [google/clasp](https://github.com/google/clasp) | 818 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 768 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 643 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
| [laoqiren/mlhelper](https://github.com/laoqiren/mlhelper) | 642 | `mocha --recursive` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 642 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 627 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 615 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 610 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 570 | `mocha "out/**/*.spec.js" -s 0` | 
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 537 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 483 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 478 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 434 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 429 | `mocha --opts mocha.opts` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 386 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 383 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 356 | `cross-env TS_NODE_COMPILER="ttypescript" mocha --opts mocha.opts` | 
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 350 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [apollographql/persistgraphql](https://github.com/apollographql/persistgraphql) | 316 | `mocha --reporter spec --full-trace lib/test/tests.js` | 
...
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 283 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 267 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 255 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [RisingStack/node-typescript-starter](https://github.com/RisingStack/node-typescript-starter) | 202 | `tsc && mocha dist/**/*.spec.js` | 
...
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 182 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
...
| [ClickSimply/Nano-SQL](https://github.com/ClickSimply/Nano-SQL) | 183 | `mocha -r ts-node/register tests/index.ts` | 
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 182 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 179 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [jacobbogers/blasjs](https://github.com/jacobbogers/blasjs) | 176 | `cross-env-shell NODE_ENV=test TS_NODE_DISABLE_WARNINGS=true nyc mocha` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 154 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 153 | `mocha-webpack "src/**/*.ts"` | 
...
| [Talento90/typescript-node](https://github.com/Talento90/typescript-node) | 135 | `npm run build && mocha --exit --recursive dist/test/unit` | 
...
| [tomastrajan/ngx-model](https://github.com/tomastrajan/ngx-model) | 125 | `npm run clean && tslint *.ts && npm run prettier:ci && mocha ./lib/model.test.ts --require ts-node/register` | 
...
| [cartant/rxjs-marbles](https://github.com/cartant/rxjs-marbles) | 113 | `yarn run lint && yarn run test:build && cross-env FAILING=0 yarn run test:ava && cross-env FAILING=0 yarn run test:jasmine && cross-env FAILING=0 yarn run test:jasmine-angular && cross-env FAILING=0 yarn run test:jest && cross-env FAILING=0 yarn run test:mocha && cross-env FAILING=0 yarn run test:tape` | 
...
| [TreeGateway/tree-gateway](https://github.com/TreeGateway/tree-gateway) | 105 | `cross-env NODE_ENV=test mocha --exit` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 98 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
...
| [matthew-matvei/freeman](https://github.com/matthew-matvei/freeman) | 87 | `xvfb-maybe electron-mocha --renderer __tests__` | 
...
| [nicksenger/react-arcgis](https://github.com/nicksenger/react-arcgis) | 82 | `nyc mocha` | 
...
| [atomist/sdm](https://github.com/atomist/sdm) | 74 | `nyc mocha --require espower-typescript/guess --require source-map-support/register "test/**/*.test.ts"` | 
...
| [codius/codiusd](https://github.com/codius/codiusd) | 70 | `npm run lint && nyc mocha` | 
...
| [wonderful-panda/vue-tsx-support](https://github.com/wonderful-panda/vue-tsx-support) | 65 | `npm-run-all prettier tsc-test mocha` | 
...
| [gcanti/elm-ts](https://github.com/gcanti/elm-ts) | 64 | `npm run lint && npm run mocha` | 
| [olosegres/jsona](https://github.com/olosegres/jsona) | 64 | `npm run test-compile && env NODE_ENV=test ts-mocha ./**/*.test.ts` | 
| [wbhob/nest-middlewares](https://github.com/wbhob/nest-middlewares) | 64 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
...
| [AugurProject/augur-node](https://github.com/AugurProject/augur-node) | 63 | `mocha test/unit` | 
...
| [adrien2p/nestjs-graphql](https://github.com/adrien2p/nestjs-graphql) | 54 | `mocha -r ts-node/register src/**/tests/*.ts` | 
...
| [DavidDuwaer/Coloquent](https://github.com/DavidDuwaer/Coloquent) | 50 | `npm run build && mocha -r ts-node/register tests/**/*.test.ts` | 
...
| [evansolomon/nodejs-kinesis-client-library](https://github.com/evansolomon/nodejs-kinesis-client-library) | 49 | `npm run lint && mocha` | 
| [SomeKittens/gustav](https://github.com/SomeKittens/gustav) | 49 | `mocha dist/test` | 
| [SqrTT/prophet](https://github.com/SqrTT/prophet) | 49 | `node ./node_modules/mocha/bin/mocha -u tdd ./out/tests/` | 
...
| [DhyanaChina/koa2-typescript-guide](https://github.com/DhyanaChina/koa2-typescript-guide) | 44 | `mocha` | 
...
| [dalenguyen/firestore-backup-restore](https://github.com/dalenguyen/firestore-backup-restore) | 34 | `mocha --reporter spec` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 33 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [prismicio/prismic-javascript](https://github.com/prismicio/prismic-javascript) | 30 | `mocha` | 
...
| [sourcegraph/sourcegraph-extension-api](https://github.com/sourcegraph/sourcegraph-extension-api) | 30 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --require ts-node/register --require source-map-support/register --opts mocha.opts` | 
...
| [acrazing/mobx-sync](https://github.com/acrazing/mobx-sync) | 24 | `mocha --require ts-node/register --slow 1000 ./src/**/*.spec.ts` | 
