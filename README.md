...
The list was updated at 01:55:43 12/30/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 66428 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16448 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11318 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9975 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7007 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6241 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5379 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4619 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4465 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3978 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3391 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2845 | `mocha` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2819 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2796 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2437 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2432 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2215 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1878 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1872 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1798 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1755 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1427 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1405 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1383 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1292 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1255 | `mocha --opts mocha.opts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1253 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 1252 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1232 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [funkia/list](https://github.com/funkia/list) | 1223 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1198 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1195 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha test/**/*.ts -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [google/clasp](https://github.com/google/clasp) | 1123 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1121 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1096 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1047 | `tsc -p ./ && mocha` | 
...
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 933 | `mocha --opts test/mocha.opts` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 919 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 870 | `mocha bin/tests/test.js` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 770 | `mocha test/backend` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 740 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
...
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 710 | `mocha` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 670 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 598 | `mocha lib/test/unittest.js --check-leaks --color` | 
| [hacksparrow/node-easyimage](https://github.com/hacksparrow/node-easyimage) | 591 | `npm run lint && npm run mocha` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 567 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 561 | `nyc mocha build/test` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 560 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 552 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 546 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [pgilad/leasot](https://github.com/pgilad/leasot) | 525 | `mocha --require ts-node/register -R spec './tests/*.ts'` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 521 | `mocha test/unit` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 496 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 486 | `mocha --opts mocha.opts` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 474 | `mocha --opts mocha.opts` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 473 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 468 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 456 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 451 | `npm run mocha` | 
| [incrediblesound/story-graph](https://github.com/incrediblesound/story-graph) | 444 | `_mocha --` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 441 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 439 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 438 | `cd test && mocha -r ts-node/register *.ts` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 433 | `tsc && mocha test && yarn lint` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 304 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [alexcambose/motus](https://github.com/alexcambose/motus) | 293 | `cross-env mocha -r ts-node/register 'test/**/*.spec.ts'` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 289 | `mocha` | 
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 287 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
| [mgechev/aspect.js](https://github.com/mgechev/aspect.js) | 286 | `tsc && mocha -R nyan ./dist/test/**/*.spec.js` | 
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 281 | `mocha lib/test` | 
| [spiffcode/ghedit](https://github.com/spiffcode/ghedit) | 274 | `mocha` | 
...
| [RisingStack/node-typescript-starter](https://github.com/RisingStack/node-typescript-starter) | 241 | `tsc && mocha dist/**/*.spec.js` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 230 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 223 | `mocha-webpack "src/**/*.ts"` | 
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 217 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [thiagobustamante/typescript-rest](https://github.com/thiagobustamante/typescript-rest) | 200 | `cross-env NODE_ENV=test mocha --exit` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 196 | `cd test && mocha -r ts-node/register *.ts` | 
| [bmewburn/intelephense](https://github.com/bmewburn/intelephense) | 194 | `mocha -r ts-node/register test/*.ts` | 
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 192 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 183 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [googleapis/nodejs-translate](https://github.com/googleapis/nodejs-translate) | 155 | `nyc mocha build/test` | 
...
| [hydux/hydux](https://github.com/hydux/hydux) | 151 | `npm run mocha -- "src/test/unit/*.test.ts"` | 
| [danvk/localturk](https://github.com/danvk/localturk) | 149 | `mocha --require ts-node/register test/**/*.ts` | 
| [PeterDing/chord](https://github.com/PeterDing/chord) | 147 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [Commit451/skyhook](https://github.com/Commit451/skyhook) | 144 | `mocha -r ts-node/register test/*.ts` | 
| [Microsoft/vscode-vsce](https://github.com/Microsoft/vscode-vsce) | 143 | `gulp compile && mocha` | 
...
| [Soluto/graphql-to-mongodb](https://github.com/Soluto/graphql-to-mongodb) | 124 | `ts-mocha tests/**/*.spec.ts` | 
...
| [Enterprise-JS/vscode-ts-node-debugging](https://github.com/Enterprise-JS/vscode-ts-node-debugging) | 124 | `npm run mocha --recursive ./src/**/__tests__/*` | 
...
| [Goyoo/node-k8s-client](https://github.com/Goyoo/node-k8s-client) | 122 | `mocha test` | 
...
| [gamestdio/colyseus.js](https://github.com/gamestdio/colyseus.js) | 120 | `mocha test/*.ts --require ts-node/register` | 
...
| [bradymholt/cRonstrue](https://github.com/bradymholt/cRonstrue) | 115 | `npx mocha --reporter spec --compilers ts:ts-node/register` | 
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 115 | `mocha` | 
...
| [vrimar/construct-ui](https://github.com/vrimar/construct-ui) | 111 | `cross-env TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [redhat-developer/yaml-language-server](https://github.com/redhat-developer/yaml-language-server) | 108 | `mocha --require ts-node/register --ui tdd ./test/*.test.ts` | 
...
| [googleapis/nodejs-pubsub](https://github.com/googleapis/nodejs-pubsub) | 91 | `nyc mocha build/test` | 
...
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 88 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 84 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [argoproj/argo-ci](https://github.com/argoproj/argo-ci) | 82 | `TS_NODE_PROJECT=./src/tests/tsconfig.json mocha --require ts-node/register ./src/tests/**/*spec.ts` | 
...
| [bpatrik/pigallery2](https://github.com/bpatrik/pigallery2) | 80 | `ng test && mocha --recursive test/backend/unit && mocha --recursive test/backend/integration  && mocha --recursive test/common/unit ` | 
...
| [Cody2333/koa-swagger-decorator](https://github.com/Cody2333/koa-swagger-decorator) | 76 | `./node_modules/mocha/bin/mocha -r babel-core/register test/**/*.js --bail -t 2000000` | 
...
| [MariusAlch/json-to-ts](https://github.com/MariusAlch/json-to-ts) | 73 | `npm run build && mocha ./test/js-integration/index.js && mocha ./build/test` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 73 | `nyc mocha test/**/*.test.ts` | 
...
| [timocov/dts-bundle-generator](https://github.com/timocov/dts-bundle-generator) | 66 | `mocha --timeout 10000 --slow 2500 tests/unittests/**/*.spec.js tests/functional-test-cases.js` | 
...
| [alex-okrushko/backoff-rxjs](https://github.com/alex-okrushko/backoff-rxjs) | 63 | `mocha --opts spec/mocha.opts spec/**/*-spec.ts` | 
| [KoteiIto/node-athena](https://github.com/KoteiIto/node-athena) | 62 | `rm -rf coverage && istanbul cover _mocha -- -R spec build/test/*.js` | 
| [rpgeeganage/async-ray](https://github.com/rpgeeganage/async-ray) | 62 | `nyc mocha` | 
| [KoteiIto/node-athena](https://github.com/KoteiIto/node-athena) | 62 | `rm -rf coverage && istanbul cover _mocha -- -R spec build/test/*.js` | 
| [rpgeeganage/async-ray](https://github.com/rpgeeganage/async-ray) | 62 | `nyc mocha` | 
...
| [matthiasferch/tsm](https://github.com/matthiasferch/tsm) | 59 | `mocha -r ts-node/register test/**/*.spec.ts` | 
...
| [teamdomy/domy-cli](https://github.com/teamdomy/domy-cli) | 56 | `mocha --reporter spec --require ts-node/register 'tests/**/*.spec.ts'` | 
...
| [argoproj/argo-ui](https://github.com/argoproj/argo-ui) | 40 | `mocha --require ts-node/register ./src/app/**/*.spec.ts` | 
...
| [azu/localstorage-ponyfill](https://github.com/azu/localstorage-ponyfill) | 34 | `mocha "test/**/*.ts"` | 
...
| [Dashlane/ts-event-bus](https://github.com/Dashlane/ts-event-bus) | 31 | `mocha --require ts-node/register --inline-diffs --reporter spec --recursive ./test/**/*.ts` | 
...
| [larshp/abaplint](https://github.com/larshp/abaplint) | 31 | `mocha --recursive --reporter progress build/test` | 