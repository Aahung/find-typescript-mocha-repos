...
The list was updated at 01:56:11 03/24/19 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 72002 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17604 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13744 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11857 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7289 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6705 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5874 | `npm run mocha` | 
| [peers/peerjs](https://github.com/peers/peerjs) | 5756 | `mocha -r ts-node/register -r jsdom-global/register test/**/*.ts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 5084 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts && npm run test:packages` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4881 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4877 | `mocha` | 
...
| [williamngan/pts](https://github.com/williamngan/pts) | 3460 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3382 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3142 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [retejs/rete](https://github.com/retejs/rete) | 2985 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2931 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2722 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts'` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2468 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2385 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2303 | `npm run tsc && npm run mocha` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1948 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1593 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1544 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1520 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1512 | `nyc -x '' mocha` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1467 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1385 | `mocha --opts mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 1375 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
...
| [google/gts](https://github.com/google/gts) | 1216 | `nyc mocha build/test` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 989 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 805 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 790 | `mocha test/backend` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 767 | `mocha test/unit` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 738 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 645 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [szokodiakos/typegoose](https://github.com/szokodiakos/typegoose) | 628 | `npm run lint && nyc npm run mocha` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 614 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 561 | `tsc && mocha test && yarn lint` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 544 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 510 | `mocha --opts mocha.opts` | 
...
| [felixfbecker/vscode-php-debug](https://github.com/felixfbecker/vscode-php-debug) | 413 | `mocha out/test --timeout 20000 --slow 1000 --retries 4` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 390 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 346 | `mocha` | 
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 336 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [alibaba/pont](https://github.com/alibaba/pont) | 326 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 314 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 301 | `mocha-webpack "src/**/*.ts"` | 
| [FinNLP/en-inflectors](https://github.com/FinNLP/en-inflectors) | 293 | `mocha` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 292 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 193 | `tsc && mocha` | 
...
| [Talento90/typescript-node](https://github.com/Talento90/typescript-node) | 162 | `npm run build && mocha --exit --recursive dist/test/unit` | 
...
| [vrimar/construct-ui](https://github.com/vrimar/construct-ui) | 143 | `cross-env TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [googleapis/nodejs-pubsub](https://github.com/googleapis/nodejs-pubsub) | 119 | `nyc mocha build/test` | 
...
| [rjmacarthy/express-typescript-starter](https://github.com/rjmacarthy/express-typescript-starter) | 106 | `mocha -r ts-node/register -w ./spec/**/*.spec.ts` | 
| [cartant/ts-action](https://github.com/cartant/ts-action) | 106 | `yarn run lint && yarn run test:build && mocha ./build/**/*-spec.js` | 
...
| [puzzle-js/puzzle-js](https://github.com/puzzle-js/puzzle-js) | 91 | `nyc --check-coverage --lines=85 cross-env NODE_ENV=production mocha -r ts-node/register  --recursive 'test/**/*.spec.ts'` | 
...
| [mrmlnc/vscode-scss](https://github.com/mrmlnc/vscode-scss) | 74 | `mocha out/**/*.spec.js` | 
...
| [Microsoft/vscode-chrome-debug-core](https://github.com/Microsoft/vscode-chrome-debug-core) | 80 | `mocha --exit --recursive -u tdd ./out/test/` | 
...
| [realm/realm-studio](https://github.com/realm/realm-studio) | 55 | `mocha-webpack --opts=configs/mocha-webpack.opts` | 
...
| [evebook/api](https://github.com/evebook/api) | 50 | `nyc --require ts-node/register mocha src/**/*.spec.ts --reporter spec` | 
...
| [gcanti/hyper-ts](https://github.com/gcanti/hyper-ts) | 44 | `npm run prettier && npm run lint && npm run typings-checker && npm run mocha` | 
...
| [lolamtisch/MALSync](https://github.com/lolamtisch/MALSync) | 42 | `webpack --config webpackConfig/test.config.js && mocha --recursive --timeout 30000 --retries 2 test/headless` | 
