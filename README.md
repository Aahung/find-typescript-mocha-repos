...
The list was updated at 01:55:36 11/05/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 63323 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15592 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9794 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8982 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8265 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6898 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5983 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5035 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4477 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4150 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3338 | `mocha --opts mocha.opts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2848 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2779 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2535 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2412 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2333 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2102 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1475 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit` | 
...
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1259 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1232 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [funkia/list](https://github.com/funkia/list) | 1193 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1151 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1146 | `mocha --opts mocha.opts` | 
| [watson-developer-cloud/node-sdk](https://github.com/watson-developer-cloud/node-sdk) | 1140 | `nyc mocha test/unit/ test/integration/ && nyc report --reporter=html` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1099 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1079 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [google/clasp](https://github.com/google/clasp) | 964 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [itchio/itch](https://github.com/itchio/itch) | 937 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 814 | `mocha bin/tests/test.js` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 749 | `mocha test/backend` | 
...
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 682 | `mocha` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 564 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 539 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 418 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts` | 
...
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 292 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 262 | `mocha test` | 
...
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 219 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
| [renke/import-sort](https://github.com/renke/import-sort) | 215 | `mocha --require ts-node/register --recursive "packages/*/test/**/*.ts"` | 
| [FormidableLabs/inspectpack](https://github.com/FormidableLabs/inspectpack) | 210 | `mocha "test/**/*.spec.ts"` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 190 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 178 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 172 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [nozer/quill-delta-to-html](https://github.com/nozer/quill-delta-to-html) | 126 | `./node_modules/nyc/bin/nyc.js ./node_modules/mocha/bin/mocha --compilers ts:ts-node/register -b "./test/**/*.ts"  ` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 124 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [structured-log/structured-log](https://github.com/structured-log/structured-log) | 96 | `mocha --compilers ts:ts-node/register -r src/polyfills/objectAssign.js test/**/*.spec.ts` | 
...
| [secret-tech/backend-ico-dashboard](https://github.com/secret-tech/backend-ico-dashboard) | 92 | `nyc mocha ./src/**/*.spec.ts --require test/prepare.ts` | 
...
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 75 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
...
| [indutny/llparse](https://github.com/indutny/llparse) | 66 | `npm run mocha && npm run lint` | 
...
| [puzzle-js/PuzzleJs](https://github.com/puzzle-js/PuzzleJs) | 57 | `nyc --check-coverage --lines=85 cross-env NODE_ENV=production mocha -r ts-node/register  --recursive 'test/**/*.spec.ts'` | 
...
| [indutny/llhttp](https://github.com/indutny/llhttp) | 45 | `npm run mocha && npm run lint` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 35 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [ashleydavis/grademark](https://github.com/ashleydavis/grademark) | 34 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [hg-pyun/iterize](https://github.com/hg-pyun/iterize) | 31 | `mocha --recursive ./test/*.ts --require ts-node/register` | 
