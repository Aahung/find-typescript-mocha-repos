...
The list was updated at 01:55:32 12/13/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 65541 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16211 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10860 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9670 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8614 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6978 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6127 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5262 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4578 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4367 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3845 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3371 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2822 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2727 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2706 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2426 | `mocha 'test/**/*.ts'` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2398 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2200 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1859 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1857 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1791 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1739 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1412 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1361 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1355 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1246 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1236 | `mocha --opts mocha.opts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1233 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [funkia/list](https://github.com/funkia/list) | 1218 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1194 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1188 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1177 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha test/**/*.ts -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [google/clasp](https://github.com/google/clasp) | 1086 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1040 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 963 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 929 | `mocha --opts test/mocha.opts` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 898 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 860 | `mocha bin/tests/test.js` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 729 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 667 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 665 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 655 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 581 | `mocha lib/test/unittest.js --check-leaks --color` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 557 | `nyc mocha build/test` | 
...
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 550 | `mocha test` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 543 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 538 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 462 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 461 | `mocha --opts mocha.opts` | 
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 451 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 445 | `npm run mocha` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 431 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 410 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [R-js/libRmath.js](https://github.com/R-js/libRmath.js) | 375 | `cross-env-shell NODE_ENV=test TS_NODE_DISABLE_WARNINGS=true nyc mocha` | 
| [itsFrank/vue-typescript](https://github.com/itsFrank/vue-typescript) | 359 | `mocha` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 356 | `mocha test/unit` | 
| [Polymer/prpl-server](https://github.com/Polymer/prpl-server) | 347 | `npm run build && mocha` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 322 | `tsc && mocha test && yarn lint` | 
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 318 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 294 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
| [FinNLP/en-inflectors](https://github.com/FinNLP/en-inflectors) | 289 | `mocha` | 
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 288 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 280 | `mocha` | 
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 279 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 275 | `mocha lib/test` | 
...
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 233 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 219 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 217 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [jedmao/eclint](https://github.com/jedmao/eclint) | 200 | `nyc npm run mocha -- --reporter lcov --reporter spec` | 
...
| [bmewburn/intelephense](https://github.com/bmewburn/intelephense) | 190 | `mocha -r ts-node/register test/*.ts` | 
...
| [funkia/hareactive](https://github.com/funkia/hareactive) | 182 | `nyc mocha --recursive test/**/*.ts` | 
| [microsoftgraph/msgraph-sdk-javascript](https://github.com/microsoftgraph/msgraph-sdk-javascript) | 177 | `mocha lib/spec/core` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 175 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [emmanueltouzery/prelude-ts](https://github.com/emmanueltouzery/prelude-ts) | 160 | `rm tests/apidoc-*; tsc && node ./dist/tests/Comments.js && tsc && ./node_modules/mocha/bin/mocha --throw-deprecation --timeout 60000 ./dist/tests/*.js` | 
...
| [nodejs/llhttp](https://github.com/nodejs/llhttp) | 149 | `npm run mocha && npm run lint` | 
...
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 143 | `tsc && mocha` | 
| [martysweet/cfn-lint](https://github.com/martysweet/cfn-lint) | 140 | `mocha lib/test` | 
| [Microsoft/vscode-vsce](https://github.com/Microsoft/vscode-vsce) | 139 | `gulp compile && mocha` | 
...
| [DotJoshJohnson/vscode-xml](https://github.com/DotJoshJohnson/vscode-xml) | 130 | `npm run compile && mocha ./out/test/**/*.js` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 129 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [atomist/sdm](https://github.com/atomist/sdm) | 123 | `mocha --require espower-typescript/guess "test/**/*.test.ts"` | 
...
| [AzureAD/azure-activedirectory-library-for-nodejs](https://github.com/AzureAD/azure-activedirectory-library-for-nodejs) | 123 | `npm run tsc && mocha -R spec --ui tdd test` | 
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 123 | `nyc --reporter=html --reporter=text mocha` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 117 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [bradymholt/cRonstrue](https://github.com/bradymholt/cRonstrue) | 112 | `npx mocha --reporter spec --compilers ts:ts-node/register` | 
| [nomiclabs/buidler](https://github.com/nomiclabs/buidler) | 112 | `nyc mocha` | 
...
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 109 | `mocha` | 
...
| [tycho01/typical](https://github.com/tycho01/typical) | 104 | `tsc | tee tsc.log && mocha lib/**/*.test.js 2>&1 | sed 's/[0-9]\+)/×/g' | tee errors.log` | 
...
| [Esri/react-arcgis](https://github.com/Esri/react-arcgis) | 100 | `nyc mocha` | 
...
| [englercj/tsd-jsdoc](https://github.com/englercj/tsd-jsdoc) | 98 | `mocha --ui tdd -r ts-node/register test/specs/**.ts` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 96 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
| [nucleojs/nucleo](https://github.com/nucleojs/nucleo) | 96 | `mocha -r ts-node/register` | 
| [nodejs/llparse](https://github.com/nodejs/llparse) | 96 | `npm run mocha && npm run lint` | 
...
| [mysticatea/vue-eslint-parser](https://github.com/mysticatea/vue-eslint-parser) | 91 | `nyc npm run _mocha` | 
...
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 85 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
...
| [argoproj/argo-ci](https://github.com/argoproj/argo-ci) | 79 | `TS_NODE_PROJECT=./src/tests/tsconfig.json mocha --require ts-node/register ./src/tests/**/*spec.ts` | 
...
| [gcanti/elm-ts](https://github.com/gcanti/elm-ts) | 75 | `npm run lint && npm run mocha` | 
...
| [googleapis/nodejs-bigquery](https://github.com/googleapis/nodejs-bigquery) | 73 | `nyc mocha build/test` | 
...
| [MariusAlch/json-to-ts](https://github.com/MariusAlch/json-to-ts) | 68 | `npm run build && mocha ./test/js-integration/index.js && mocha ./build/test` | 
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 68 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [bespoken/virtual-alexa](https://github.com/bespoken/virtual-alexa) | 67 | `nyc mocha lib/**/*Test.js` | 
...
| [firebase/firebase-functions-test](https://github.com/firebase/firebase-functions-test) | 62 | `mocha .tmp/spec/index.spec.js` | 
| [timocov/dts-bundle-generator](https://github.com/timocov/dts-bundle-generator) | 62 | `mocha --timeout 10000 --slow 2500 tests/unittests/**/*.spec.js tests/functional-test-cases.js` | 
...
| [longlho/ts-transform-css-modules](https://github.com/longlho/ts-transform-css-modules) | 52 | `rm -rf test/fixture/*.js && mocha --require ts-node/register --recursive  test/**/*.test.ts` | 
...
| [JustinBeckwith/retry-axios](https://github.com/JustinBeckwith/retry-axios) | 45 | `nyc mocha build/test --timeout 5000 --require source-map-support/register` | 
...
| [googleapis/nodejs-spanner](https://github.com/googleapis/nodejs-spanner) | 42 | `nyc mocha build/test` | 
...
| [cartant/rxjs-observe](https://github.com/cartant/rxjs-observe) | 42 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [soraping/koa-ts](https://github.com/soraping/koa-ts) | 38 | `mocha --recursive` | 
...
| [aleris/zxing-typescript](https://github.com/aleris/zxing-typescript) | 37 | `mocha --compilers js:babel-core/register "build-node/test/core/**/*.js" --timeout 30000 --colors` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 33 | `ttsc --project tsconfig-test.json && mocha` | 
