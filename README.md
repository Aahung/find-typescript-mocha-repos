...
The list was updated at 01:56:12 03/05/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 70246 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17284 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13152 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11489 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7233 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6591 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5771 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4987 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4789 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4765 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4115 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3443 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3253 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3046 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [retejs/rete](https://github.com/retejs/rete) | 2929 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2925 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2669 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts'` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2461 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2343 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2266 | `npm run tsc && npm run mocha` | 
...
| [staltz/xstream](https://github.com/staltz/xstream) | 1795 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1569 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1520 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1457 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1359 | `mocha --opts mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 1337 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1263 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1173 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 977 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 962 | `mocha bin/tests/test.js` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 957 | `mocha --opts test/mocha.opts` | 
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 878 | `npm run mocha` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 797 | `mocha --require ts-node/register` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 787 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 642 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 608 | `nyc mocha build/test` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 604 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [szokodiakos/typegoose](https://github.com/szokodiakos/typegoose) | 603 | `npm run lint && nyc npm run mocha` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 602 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 598 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [bbc/sqs-consumer](https://github.com/bbc/sqs-consumer) | 590 | `mocha` | 
| [pgilad/leasot](https://github.com/pgilad/leasot) | 587 | `mocha --require ts-node/register -R spec './tests/*.ts'` | 
| [mateogianolio/vectorious](https://github.com/mateogianolio/vectorious) | 575 | `nyc mocha -r ts-node/register ./src/*.spec.ts` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 541 | `tsc && mocha test && yarn lint` | 
...
| [benjamn/ast-types](https://github.com/benjamn/ast-types) | 507 | `npm run gen && npm run build && npm run mocha` | 
...
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 495 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 493 | `mocha --opts mocha.opts` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 480 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [amplify-education/serverless-domain-manager](https://github.com/amplify-education/serverless-domain-manager) | 387 | `tsc --project . && nyc mocha -r ts-node/register test/unit-tests/index.test.ts && nyc report --reporter=text-summary` | 
...
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 373 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 353 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 344 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [nefe/pont](https://github.com/nefe/pont) | 258 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 258 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 254 | `nyc mocha` | 
...
| [googleapis/nodejs-storage](https://github.com/googleapis/nodejs-storage) | 241 | `nyc mocha build/test` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 215 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [Enterprise-JS/vscode-ts-node-debugging](https://github.com/Enterprise-JS/vscode-ts-node-debugging) | 139 | `npm run mocha --recursive ./src/**/__tests__/*` | 
| [Soluto/graphql-to-mongodb](https://github.com/Soluto/graphql-to-mongodb) | 138 | `ts-mocha tests/**/*.spec.ts` | 
...
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 136 | `mocha` | 
...
| [wbhob/nest-middlewares](https://github.com/wbhob/nest-middlewares) | 92 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
...
| [olosegres/jsona](https://github.com/olosegres/jsona) | 85 | `npm run test-compile && env NODE_ENV=test ts-mocha ./**/*.test.ts` | 
...
| [puzzle-js/puzzle-js](https://github.com/puzzle-js/puzzle-js) | 84 | `nyc --check-coverage --lines=85 cross-env NODE_ENV=production mocha -r ts-node/register  --recursive 'test/**/*.spec.ts'` | 
...
| [adrien2p/nestjs-graphql](https://github.com/adrien2p/nestjs-graphql) | 80 | `mocha -r ts-node/register src/**/tests/*.ts` | 
...
| [ngduc/node-rem](https://github.com/ngduc/node-rem) | 60 | `cross-env NODE_ENV=test nyc --reporter=html --reporter=text --reporter=lcov mocha --require ts-node/register --full-trace --bail --timeout 20000 --exit tests/**/*.ts` | 
...
| [strongloop/loopback4-example-shopping](https://github.com/strongloop/loopback4-example-shopping) | 50 | `lb-mocha --allow-console-logs "dist/test"` | 
...
| [soraping/koa-ts](https://github.com/soraping/koa-ts) | 46 | `mocha --recursive` | 
| [googleapis/nodejs-spanner](https://github.com/googleapis/nodejs-spanner) | 46 | `nyc mocha build/test` | 
