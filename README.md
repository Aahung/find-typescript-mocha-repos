...
The list was updated at 01:57:17 03/20/19 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 71715 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17536 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13586 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11775 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7277 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6677 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5849 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 5065 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts packages/**/test/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4867 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4853 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4235 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3457 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3365 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3121 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [retejs/rete](https://github.com/retejs/rete) | 2977 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2931 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2707 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts'` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2466 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2377 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2298 | `npm run tsc && npm run mocha` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1945 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1607 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1570 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1522 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1516 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1510 | `nyc -x '' mocha` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1460 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1380 | `mocha --opts mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 1367 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1282 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [funkia/list](https://github.com/funkia/list) | 1268 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1227 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [google/gts](https://github.com/google/gts) | 1211 | `nyc mocha build/test` | 
...
| [youzan/zan-proxy](https://github.com/youzan/zan-proxy) | 1000 | `nyc mocha dist/**/*.spec.js` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 995 | `mocha bin/tests/test.js` | 
...
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 898 | `npm run mocha` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 816 | `mocha --require ts-node/register` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 802 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 788 | `mocha test/backend` | 
| [coinbase/gdax-tt](https://github.com/coinbase/gdax-tt) | 745 | `yarn run lint && yarn run test:mocha` | 
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 741 | `mocha` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 706 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 680 | `mocha test/unit` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 641 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [szokodiakos/typegoose](https://github.com/szokodiakos/typegoose) | 627 | `npm run lint && nyc npm run mocha` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 619 | `nyc mocha build/test` | 
...
| [jaysoo/todomvc-redux-react-typescript](https://github.com/jaysoo/todomvc-redux-react-typescript) | 615 | `tsc && mocha --require test-setup --recursive ./dist/**/__spec__/**/*-spec.js` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 610 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 609 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 608 | `mocha --opts ./src/test/mocha.opts` | 
...
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 562 | `mocha test` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 560 | `tsc && mocha test && yarn lint` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 540 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 520 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 508 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 506 | `npm run mocha` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 494 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
| [43081j/rar.js](https://github.com/43081j/rar.js) | 461 | `npm run build && mocha` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 454 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 430 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 374 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 369 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [arangodb/arangojs](https://github.com/arangodb/arangojs) | 364 | `mocha --growl --reporter spec --require source-map-support/register --timeout 10000 lib/async/test` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 344 | `mocha` | 
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 332 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [alibaba/pont](https://github.com/alibaba/pont) | 311 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 307 | `cd test && mocha -r ts-node/register *.ts` | 
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 303 | `mocha lib/test` | 
| [mgechev/aspect.js](https://github.com/mgechev/aspect.js) | 301 | `tsc && mocha -R nyan ./dist/test/**/*.spec.js` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 289 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
| [spiffcode/ghedit](https://github.com/spiffcode/ghedit) | 283 | `mocha` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 265 | `nyc mocha` | 
...
| [harttle/liquidjs](https://github.com/harttle/liquidjs) | 228 | `npm run build && mocha "test/**/*.ts"` | 
...
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 180 | `tsc && mocha` | 
...
| [nozer/quill-delta-to-html](https://github.com/nozer/quill-delta-to-html) | 159 | `./node_modules/nyc/bin/nyc.js ./node_modules/mocha/bin/mocha --compilers ts:ts-node/register -b "./test/**/*.ts"  ` | 
...
| [Microsoft/monaco-languages](https://github.com/Microsoft/monaco-languages) | 144 | `mocha` | 
...
| [redhat-developer/yaml-language-server](https://github.com/redhat-developer/yaml-language-server) | 136 | `mocha --require ts-node/register --ui tdd ./test/*.test.ts` | 
...
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 132 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
...
| [Esri/react-arcgis](https://github.com/Esri/react-arcgis) | 125 | `nyc mocha` | 
...
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 113 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
| [bpatrik/pigallery2](https://github.com/bpatrik/pigallery2) | 113 | `ng test && mocha --recursive test/backend/unit && mocha --recursive test/backend/integration  && mocha --recursive test/common/unit ` | 
...
| [atlassian/nucleus](https://github.com/atlassian/nucleus) | 111 | `mocha --compilers ts:ts-node/register src/__spec__/rest.ts src/**/__spec__/*_spec.ts src/**/**/__spec__/*_spec.ts` | 
...
| [ChainSafeSystems/lodestar](https://github.com/ChainSafeSystems/lodestar) | 104 | `nyc -r lcov -e .ts -x "*.test.ts" mocha -r ./.babel-register "tests/**/*.test.ts" && nyc report` | 
...
| [levjj/esverify](https://github.com/levjj/esverify) | 98 | `TS_NODE_TRANSPILE_ONLY=true mocha -r ts-node/register tests/*.ts` | 
...
| [googleapis/nodejs-bigquery](https://github.com/googleapis/nodejs-bigquery) | 93 | `nyc mocha build/test` | 
...
| [duffman/tspath](https://github.com/duffman/tspath) | 66 | `mocha -r ts-node/register test/**.*/test.ts` | 
...
| [eclipse/sprotty](https://github.com/eclipse/sprotty) | 49 | `jenkins-mocha --opts ./configs/mocha.opts "./src/**/*.spec.?(ts|tsx)"` | 
...
| [Webtomizer/typeorm-loader](https://github.com/Webtomizer/typeorm-loader) | 39 | `npm run build && [ -d tests ] && NODE_ENV=test mocha $NODE_DEBUG_OPTION -r ts-node/register -r tslib tests/test_**.ts` | 
