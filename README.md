...
The list was updated at 01:55:24 11/17/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 64022 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15779 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10114 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9196 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8383 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6926 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6018 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5102 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4507 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4212 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3351 | `mocha --opts mocha.opts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3100 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2794 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2594 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2427 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2420 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2135 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1819 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1792 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1704 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1562 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1376 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1331 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1289 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1131 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1087 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
...
| [google/clasp](https://github.com/google/clasp) | 1011 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 880 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 828 | `mocha bin/tests/test.js` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 757 | `mocha test/backend` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 643 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 505 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 504 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 439 | `npm run mocha` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 439 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 431 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 431 | `cross-env NODE_ENV=test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 417 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 414 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 390 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 384 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 299 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 298 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 258 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 254 | `mocha` | 
...
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 206 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [bmewburn/intelephense](https://github.com/bmewburn/intelephense) | 183 | `mocha -r ts-node/register test/*.ts` | 
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 183 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
...
| [ohjames/rxjs-websockets](https://github.com/ohjames/rxjs-websockets) | 170 | `npm run build && npm run mocha` | 
...
| [square/babel-codemod](https://github.com/square/babel-codemod) | 165 | `mocha "test/**/*Test.js"` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 148 | `mocha test/unit` | 
...
| [hydux/hydux](https://github.com/hydux/hydux) | 141 | `npm run mocha -- "src/test/unit/*.test.ts"` | 
...
| [dsherret/ts-nameof](https://github.com/dsherret/ts-nameof) | 91 | `yarn run --silent copy-test-files && nyc --reporter=lcov mocha --opts mocha.opts` | 
...
| [indutny/llparse](https://github.com/indutny/llparse) | 78 | `npm run mocha && npm run lint` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 73 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
| [gcanti/elm-ts](https://github.com/gcanti/elm-ts) | 73 | `npm run lint && npm run mocha` | 
...
| [indutny/llhttp](https://github.com/indutny/llhttp) | 71 | `npm run mocha && npm run lint` | 
...
| [argoproj/argo-ci](https://github.com/argoproj/argo-ci) | 69 | `TS_NODE_PROJECT=./src/tests/tsconfig.json mocha --require ts-node/register ./src/tests/**/*spec.ts` | 
...
| [bespoken/virtual-alexa](https://github.com/bespoken/virtual-alexa) | 65 | `nyc mocha lib/**/*Test.js` | 
...
| [theGlenn/apollo-prophecy](https://github.com/theGlenn/apollo-prophecy) | 63 | `rm -rf coverage && nyc mocha --opts mocha.opts` | 
| [Cody2333/koa-swagger-decorator](https://github.com/Cody2333/koa-swagger-decorator) | 63 | `./node_modules/mocha/bin/mocha -r babel-core/register test/**/*.js --bail -t 2000000` | 
...
| [googleapis/node-gtoken](https://github.com/googleapis/node-gtoken) | 57 | `nyc mocha build/test` | 
...
| [PeculiarVentures/xadesjs](https://github.com/PeculiarVentures/xadesjs) | 50 | `mocha` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 49 | `mocha` | 
...
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 48 | `nyc --reporter=html mocha --timeout 0 --require ts-node/register --require source-map-support/register --recursive src/test.ts` | 
...
| [wearetheledger/fabric-node-chaincode-utils](https://github.com/wearetheledger/fabric-node-chaincode-utils) | 46 | `mocha -r ts-node/register test/**/*.spec.ts --reporter spec` | 
...
| [breakstring/xunfeisdk](https://github.com/breakstring/xunfeisdk) | 43 | `tsc && mocha -R nyan -t 15000 -r ts-node/register "./test/**/*.ts"` | 
...
| [ethereum-ts/evm-ts](https://github.com/ethereum-ts/evm-ts) | 38 | `yarn lint && yarn test:mocha` | 
...
| [Unibeautify/vscode](https://github.com/Unibeautify/vscode) | 36 | `mocha` | 
...
| [gcanti/hyper-ts](https://github.com/gcanti/hyper-ts) | 30 | `npm run prettier && npm run lint && npm run typings-checker && npm run mocha` | 
