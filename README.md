...
The list was updated at 00:39:21 11/22/17 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 38901 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 9323 | `cross-env TS_NODE_FAST=true mocha --compilers ts:ts-node/register --opts spec/support/coverage.opts "spec/**/*-spec.ts"` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 3814 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 2593 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 2471 | `nyc --require ts-node/register mocha src/**/*.spec.ts --reporter spec` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2188 | `mocha 'test/**/*.ts'` | 
| [Microsoft/sqlopsstudio](https://github.com/Microsoft/sqlopsstudio) | 2072 | `mocha` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1697 | `mocha` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1414 | `rimraf dist && tsc && cp -r test/fixtures dist/test && mocha dist/test --recursive` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 1373 | `mocha` | 
...
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 1202 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 997 | `cross-env TS_NODE_PROJECT=test/tsconfig.json TS_NODE_DISABLE_WARNINGS=1 nyc mocha --opts test/mocha.opts` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 889 | `mocha --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 762 | `nyc -c -x '' mocha ./out/test --recursive` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 710 | `mocha --require ts-node/register test/**Test.ts` | 
| [angular/dgeni](https://github.com/angular/dgeni) | 682 | `mocha --compilers ts:ts-node/register -R spec src/**/*.spec.ts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 602 | `npm run prettify && mocha --require ts-node/register test/**.ts test/**/*.ts` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 468 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 435 | `mocha bin/tests/test.js` | 
...
| [gcanti/fp-ts](https://github.com/gcanti/fp-ts) | 365 | `npm run lint && npm run prettier && npm run mocha` | 
| [surf-build/surf](https://github.com/surf-build/surf) | 353 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 340 | `node packages/build/bin/run-nyc npm run mocha` | 
...
| [Microsoft/BotFramework-WebChat](https://github.com/Microsoft/BotFramework-WebChat) | 331 | `concurrently  "node test/mock_dl/index.js" "mocha test" ` | 
...
| [coinbase/gdax-tt](https://github.com/coinbase/gdax-tt) | 293 | `yarn run lint && yarn run test:mocha` | 
...
| [gcanti/io-ts](https://github.com/gcanti/io-ts) | 257 | `npm run prettier && npm run lint && npm run typings-checker && npm run mocha` | 
...
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 243 | `mocha --opts mocha.opts` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 239 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
...
| [mgechev/aspect.js](https://github.com/mgechev/aspect.js) | 180 | `tsc && mocha -R nyan ./dist/test/**/*.spec.js` | 
...
| [anandanand84/technicalindicators](https://github.com/anandanand84/technicalindicators) | 163 | `mocha --compilers js:babel-register --require babel-polyfill` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 145 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 145 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [JumpFm/jumpfm](https://github.com/JumpFm/jumpfm) | 133 | `mocha js` | 
...
| [chenhaozhi/Cpage.js](https://github.com/chenhaozhi/Cpage.js) | 130 | `mocha -r ./node_modules/ts-node/register test/**/*_spec.ts --reporter mochawesome` | 
...
| [stipsan/scroll-into-view-if-needed](https://github.com/stipsan/scroll-into-view-if-needed) | 102 | `cypress run --browser chrome --reporter junit --reporter-options 'mochaFile=junit/test-results.xml'` | 
