...
The list was updated at 00:43:57 09/26/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 59938 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 14949 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 8937 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8338 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8063 | `mocha --opts mocha.opts && agadoo shared.js` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4783 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4375 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 3976 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3264 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2739 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2560 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2405 | `mocha 'test/**/*.ts'` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2374 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2739 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2560 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2405 | `mocha 'test/**/*.ts'` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2374 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2049 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 1998 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1788 | `mocha` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1787 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1728 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1651 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1320 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1247 | `nyc -x '' mocha` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1232 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1187 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [funkia/list](https://github.com/funkia/list) | 1173 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1120 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [watson-developer-cloud/node-sdk](https://github.com/watson-developer-cloud/node-sdk) | 1114 | `nyc mocha test/unit/ test/integration/ && nyc report --reporter=html` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1075 | `nyc --reporter=html --reporter=text mocha` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1069 | `mocha --opts mocha.opts` | 
...
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 903 | `mocha --opts test/mocha.opts` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 844 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [google/clasp](https://github.com/google/clasp) | 834 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 770 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
...
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 665 | `mocha` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 628 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 617 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 613 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 571 | `mocha "out/**/*.spec.js" -s 0` | 
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 556 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
...
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 518 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [pgilad/leasot](https://github.com/pgilad/leasot) | 515 | `mocha --require ts-node/register -R spec './tests/*.ts'` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 484 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 479 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 460 | `mocha --opts mocha.opts` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 438 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 435 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 421 | `mocha --opts mocha.opts` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 417 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 413 | `npm run mocha` | 
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 398 | `mocha test` | 
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 395 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
| [surf-build/surf](https://github.com/surf-build/surf) | 389 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 387 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 384 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 383 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 381 | `cross-env NODE_ENV=test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 357 | `cross-env TS_NODE_COMPILER="ttypescript" mocha --opts mocha.opts` | 
...
| [Polymer/prpl-server](https://github.com/Polymer/prpl-server) | 339 | `npm run build && mocha` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 336 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 284 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 269 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
...
| [mgechev/aspect.js](https://github.com/mgechev/aspect.js) | 259 | `tsc && mocha -R nyan ./dist/test/**/*.spec.js` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 211 | `mocha test` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 211 | `mocha test` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 203 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 201 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
...
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 184 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 179 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
| [thiagobustamante/typescript-rest](https://github.com/thiagobustamante/typescript-rest) | 179 | `cross-env NODE_ENV=test mocha` | 
| [jacobbogers/blasjs](https://github.com/jacobbogers/blasjs) | 177 | `cross-env-shell NODE_ENV=test TS_NODE_DISABLE_WARNINGS=true nyc mocha` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 156 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 154 | `mocha-webpack "src/**/*.ts"` | 
...
| [Commit451/skyhook](https://github.com/Commit451/skyhook) | 129 | `mocha -r ts-node/register test/*.ts` | 
...
| [tomastrajan/ngx-model](https://github.com/tomastrajan/ngx-model) | 127 | `npm run clean && tslint *.ts && npm run format:ci && mocha ./lib/model.test.ts --require ts-node/register` | 
...
| [Microsoft/vscode-vsce](https://github.com/Microsoft/vscode-vsce) | 112 | `gulp compile && mocha` | 
...
| [martysweet/cfn-lint](https://github.com/martysweet/cfn-lint) | 110 | `mocha lib/test` | 
...
| [bradymholt/cRonstrue](https://github.com/bradymholt/cRonstrue) | 96 | `npx mocha --reporter spec --compilers ts:ts-node/register` | 
...
| [tycho01/typical](https://github.com/tycho01/typical) | 92 | `tsc | tee tsc.log && mocha lib/**/*.test.js 2>&1 | sed 's/[0-9]\+)/×/g' | tee errors.log` | 
...
| [redhat-developer/yaml-language-server](https://github.com/redhat-developer/yaml-language-server) | 90 | `mocha --require ts-node/register --ui tdd ./test/*.test.ts` | 
| [Kode/KodeStudio](https://github.com/Kode/KodeStudio) | 89 | `mocha` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 89 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [horiuchi/dtsgenerator](https://github.com/horiuchi/dtsgenerator) | 87 | `istanbul cover _mocha test/*.js test/**/*.js` | 
| [functionalone/serverless-iam-roles-per-function](https://github.com/functionalone/serverless-iam-roles-per-function) | 87 | `nyc mocha --require ts-node/register --require source-map-support/register  ./src/test/**/*.test.ts` | 
...
| [MichaelSolati/geofirestore](https://github.com/MichaelSolati/geofirestore) | 85 | `nyc --reporter=html --reporter=text mocha` | 
...
| [atomist/sdm](https://github.com/atomist/sdm) | 76 | `nyc mocha --require espower-typescript/guess --require source-map-support/register "test/**/*.test.ts"` | 
...
| [flagello/Essence](https://github.com/flagello/Essence) | 69 | `mocha` | 
...
| [redhat-developer/vscode-yaml](https://github.com/redhat-developer/vscode-yaml) | 68 | `mocha --ui tdd out/test/extension.test.js` | 
...
| [wonderful-panda/vue-tsx-support](https://github.com/wonderful-panda/vue-tsx-support) | 66 | `npm-run-all prettier tsc-test mocha` | 
...
| [gcanti/elm-ts](https://github.com/gcanti/elm-ts) | 65 | `npm run lint && npm run mocha` | 
| [wbhob/nest-middlewares](https://github.com/wbhob/nest-middlewares) | 65 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
...
| [AugurProject/augur-node](https://github.com/AugurProject/augur-node) | 64 | `mocha test/unit` | 
...
| [troch/path-parser](https://github.com/troch/path-parser) | 63 | `mocha -r ts-node/register 'test/main.js'` | 
...
| [Microsoft/vscode-json-languageservice](https://github.com/Microsoft/vscode-json-languageservice) | 43 | `npm run compile && mocha && npm run lint` | 
...
| [JustinBeckwith/retry-axios](https://github.com/JustinBeckwith/retry-axios) | 38 | `nyc mocha build/test --timeout 5000 --require source-map-support/register` | 
...
| [chanlito/simple-todos](https://github.com/chanlito/simple-todos) | 34 | `cross-env NODE_ENV=test nyc mocha --require test/index.ts --opts test/mocha.opts` | 
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 34 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [dupski/json-to-graphql-query](https://github.com/dupski/json-to-graphql-query) | 33 | `mocha -r ts-node/register --recursive "./src/**/__tests__/*"` | 
