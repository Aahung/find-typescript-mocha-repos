...
The list was updated at 00:43:51 09/18/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 59493 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 14823 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 8724 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8223 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6748 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5557 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4736 | `npm-run-all mocha lint` | 
| [Microsoft/sqlopsstudio](https://github.com/Microsoft/sqlopsstudio) | 4324 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 3942 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3246 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2728 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2513 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2401 | `mocha 'test/**/*.ts'` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2352 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2011 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 1979 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1787 | `mocha` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1775 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1718 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1646 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1313 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1233 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1224 | `nyc -x '' mocha` | 
| [wilk/microjob](https://github.com/wilk/microjob) | 1206 | `node --experimental-worker node_modules/.bin/_mocha -r ts-node/register ./test/**/*.ts` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1173 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [watson-developer-cloud/node-sdk](https://github.com/watson-developer-cloud/node-sdk) | 1110 | `nyc mocha test/unit/ test/integration/ && nyc report --reporter=html` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1075 | `nyc --reporter=html --reporter=text mocha` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1054 | `mocha --opts mocha.opts` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1031 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 977 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 910 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 901 | `mocha --opts test/mocha.opts` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 821 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [google/clasp](https://github.com/google/clasp) | 779 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 765 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 753 | `mocha bin/tests/test.js` | 
...
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 671 | `mocha` | 
| [laoqiren/mlhelper](https://github.com/laoqiren/mlhelper) | 642 | `mocha --recursive` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 641 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 638 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 624 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 614 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 606 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [emilioastarita/lyricfier](https://github.com/emilioastarita/lyricfier) | 533 | `mocha` | 
| [SierraSoftworks/Iridium](https://github.com/SierraSoftworks/Iridium) | 532 | `mocha --opts test/mocha.opts dist/test` | 
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 524 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 514 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 476 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 473 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 432 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 431 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 424 | `mocha --opts mocha.opts` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 418 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 414 | `mocha --opts mocha.opts` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 410 | `npm run mocha` | 
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 393 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 381 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 381 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 379 | `cross-env NODE_ENV=test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
| [felixfbecker/vscode-php-debug](https://github.com/felixfbecker/vscode-php-debug) | 371 | `mocha out/test --timeout 20000 --slow 1000 --retries 4` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 351 | `cross-env TS_NODE_COMPILER="ttypescript" mocha --opts mocha.opts` | 
...
| [arangodb/arangojs](https://github.com/arangodb/arangojs) | 317 | `mocha --growl --reporter spec --require source-map-support/register --timeout 10000 lib/async/test` | 
| [apollographql/persistgraphql](https://github.com/apollographql/persistgraphql) | 313 | `mocha --reporter spec --full-trace lib/test/tests.js` | 
| [FinNLP/en-inflectors](https://github.com/FinNLP/en-inflectors) | 289 | `mocha` | 
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 286 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 280 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 256 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 253 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 217 | `mocha` | 
| [renke/import-sort](https://github.com/renke/import-sort) | 212 | `mocha --require ts-node/register --recursive "packages/*/test/**/*.ts"` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 204 | `mocha test` | 
...
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 198 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 191 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [ClickSimply/Nano-SQL](https://github.com/ClickSimply/Nano-SQL) | 179 | `mocha -r ts-node/register tests/index.ts` | 
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 175 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
...
| [thiagobustamante/typescript-rest](https://github.com/thiagobustamante/typescript-rest) | 174 | `cross-env NODE_ENV=test mocha` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 172 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
| [brentlintner/synt](https://github.com/brentlintner/synt) | 171 | `globstar -- _mocha "test/spec/**/*.coffee"` | 
| [bmewburn/intelephense](https://github.com/bmewburn/intelephense) | 170 | `mocha -r ts-node/register test/*.ts` | 
...
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 166 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [pnp/office365-cli](https://github.com/pnp/office365-cli) | 158 | `nyc -r=lcov -r=text mocha "dist/**/*.spec.js"` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 149 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
| [Microsoft/vscode-node-debug](https://github.com/Microsoft/vscode-node-debug) | 148 | `mocha --timeout 10000 -u tdd ./out/tests/` | 
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 147 | `mocha-webpack "src/**/*.ts"` | 
| [jgranstrom/zipson](https://github.com/jgranstrom/zipson) | 145 | `mocha --require ts-node/register --watch-extensions ts 'test/**/*.ts'` | 
| [microsoftgraph/msgraph-sdk-javascript](https://github.com/microsoftgraph/msgraph-sdk-javascript) | 143 | `mocha lib/spec/core` | 
...
| [Azure/azure-functions-pack](https://github.com/Azure/azure-functions-pack) | 131 | `npm run build && mocha --compilers ts:ts-node/register --recursive test/**/*-spec.ts` | 
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 130 | `tsc && mocha` | 
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 128 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
...
| [tomastrajan/ngx-model](https://github.com/tomastrajan/ngx-model) | 123 | `npm run clean && tslint *.ts && npm run prettier:ci && mocha ./lib/model.test.ts --require ts-node/register` | 
...
| [cartant/rxjs-marbles](https://github.com/cartant/rxjs-marbles) | 111 | `yarn run lint && yarn run test:build && cross-env FAILING=0 yarn run test:ava && cross-env FAILING=0 yarn run test:jasmine && cross-env FAILING=0 yarn run test:jasmine-angular && cross-env FAILING=0 yarn run test:jest && cross-env FAILING=0 yarn run test:mocha && cross-env FAILING=0 yarn run test:tape` | 
...
| [Half-Shot/matrix-appservice-discord](https://github.com/Half-Shot/matrix-appservice-discord) | 110 | `npm run-script build && mocha --opts test/mocha.opts build/test` | 
...
| [Enterprise-JS/vscode-ts-node-debugging](https://github.com/Enterprise-JS/vscode-ts-node-debugging) | 93 | `npm run mocha --recursive ./src/**/__tests__/*` | 
...
| [redhat-developer/yaml-language-server](https://github.com/redhat-developer/yaml-language-server) | 87 | `mocha --require ts-node/register --ui tdd ./test/*.test.ts` | 
...
| [sudheerj/generator-jhipster-primeng](https://github.com/sudheerj/generator-jhipster-primeng) | 86 | `mocha test/* --timeout 500000` | 
...
| [functionalone/serverless-iam-roles-per-function](https://github.com/functionalone/serverless-iam-roles-per-function) | 85 | `nyc mocha --require ts-node/register --require source-map-support/register  ./src/test/**/*.test.ts` | 
...
| [ynab/ynab-sdk-js](https://github.com/ynab/ynab-sdk-js) | 83 | `TS_NODE_PROJECT=./test/tsconfig.json npx mocha --reporter spec --require ts-node/register 'test/**/*.ts'` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 83 | `cd test && mocha -r ts-node/register *.ts` | 
| [cartant/ts-action](https://github.com/cartant/ts-action) | 83 | `yarn run lint && yarn run test:build && mocha ./build/**/*-spec.js` | 
| [MichaelSolati/geofirestore](https://github.com/MichaelSolati/geofirestore) | 82 | `nyc --reporter=html --reporter=text mocha` | 
...
| [jvilk/MakeTypes](https://github.com/jvilk/MakeTypes) | 80 | `npm-run-all --serial prepublish generate:test build:test mocha` | 
...
| [dsherret/ts-nameof](https://github.com/dsherret/ts-nameof) | 75 | `npm run --silent copy-test-files && nyc --reporter=lcov mocha --opts mocha.opts` | 
...
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 71 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
...
| [redhat-developer/vscode-yaml](https://github.com/redhat-developer/vscode-yaml) | 66 | `mocha --ui tdd out/test/extension.test.js` | 
| [jinhduong/linq-fns](https://github.com/jinhduong/linq-fns) | 66 | `mocha -r ts-node/register test/*.ts` | 
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 64 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
...
| [wbhob/nest-middlewares](https://github.com/wbhob/nest-middlewares) | 61 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
...
| [ui-jar/ui-jar](https://github.com/ui-jar/ui-jar) | 58 | `tsc && mocha "dist/test/**/*.js" ` | 
...
| [bespoken/virtual-alexa](https://github.com/bespoken/virtual-alexa) | 57 | `nyc mocha lib/**/*Test.js` | 
...
| [balassy/aws-lambda-typescript](https://github.com/balassy/aws-lambda-typescript) | 55 | `nyc mocha` | 
...
| [googleapis/node-gtoken](https://github.com/googleapis/node-gtoken) | 51 | `nyc mocha build/test` | 
...
| [vechain/thorify](https://github.com/vechain/thorify) | 50 | `NODE_ENV=test mocha --require ts-node/register --timeout 20000 --recursive  './**/*.test.ts'` | 
...
| [Microsoft/vscode-node-debug2](https://github.com/Microsoft/vscode-node-debug2) | 49 | `mocha --timeout 20000 -s 2000 -u tdd --colors --reporter node_modules/vscode-chrome-debug-core-testsupport/out/loggingReporter.js ./out/test/` | 
...
| [Azure/azure-cosmos-js](https://github.com/Azure/azure-cosmos-js) | 47 | `mocha -r ./src/test/common/setup.ts ./lib/test/ --recursive --timeout 100000 -i -g .*ignore.js` | 
...
| [Microsoft/node-jsonc-parser](https://github.com/Microsoft/node-jsonc-parser) | 40 | `npm run compile && mocha` | 
| [vilic/thenfail](https://github.com/vilic/thenfail) | 40 | `mocha && npm run aplus` | 
| [rhysd/fixjson](https://github.com/rhysd/fixjson) | 40 | `mocha test` | 
...
| [alex-okrushko/backoff-rxjs](https://github.com/alex-okrushko/backoff-rxjs) | 39 | `mocha --opts spec/mocha.opts spec/**/*-spec.ts` | 
| [rcjsuen/dockerfile-language-server-nodejs](https://github.com/rcjsuen/dockerfile-language-server-nodejs) | 39 | `mocha out/test` | 
| [duffman/tspath](https://github.com/duffman/tspath) | 39 | `mocha -r ts-node/register test/**.*/test.ts` | 
...
| [pubkey/solidity-cli](https://github.com/pubkey/solidity-cli) | 38 | `mocha --bail --exit ./dist/test/index.test.js  ./dist/test/integration.test.js` | 
...
| [AEB-labs/cruddl](https://github.com/AEB-labs/cruddl) | 38 | `tsc --noEmit --skipLibCheck && mocha --opts ./spec/mocha.opts` | 
...
| [adumont/tplink-cloud-api](https://github.com/adumont/tplink-cloud-api) | 37 | `mocha -r ts-node/register -p tsconfig.json lib/**/*.spec.ts` | 
...
| [wearetheledger/fabric-node-chaincode-utils](https://github.com/wearetheledger/fabric-node-chaincode-utils) | 36 | `mocha -r ts-node/register test/**/*.spec.ts --reporter spec` | 
...
| [mshanemc/shane-sfdx-plugins](https://github.com/mshanemc/shane-sfdx-plugins) | 34 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [dalenguyen/firestore-backup-restore](https://github.com/dalenguyen/firestore-backup-restore) | 32 | `mocha --reporter spec` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 31 | `mocha --forbid-only "test/**/*.test.ts"` | 
| [Jason3S/rx-stream](https://github.com/Jason3S/rx-stream) | 31 | `mocha --recursive "dist/**/*.test.js"` | 
| [microsoftgraph/msgraph-typescript-typings](https://github.com/microsoftgraph/msgraph-typescript-typings) | 31 | `tsc && mocha spec/` | 
...
| [breakstring/xunfeisdk](https://github.com/breakstring/xunfeisdk) | 30 | `tsc && mocha -R nyan -t 15000 -r ts-node/register "./test/**/*.ts"` | 
...
| [Jiasm/typescript-example](https://github.com/Jiasm/typescript-example) | 27 | `mocha -r ts-node/register test/**/*.spec.ts` | 
...
| [dhruvrajvanshi/ts-failable](https://github.com/dhruvrajvanshi/ts-failable) | 27 | `mocha --compilers ts:ts-node/register './test/**/*[tj]s'` | 
...
| [sourcegraph/sourcegraph-extension-api](https://github.com/sourcegraph/sourcegraph-extension-api) | 26 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --require ts-node/register --require source-map-support/register --opts mocha.opts` | 
...
| [vrudikov/typescript-rest-boilerplate](https://github.com/vrudikov/typescript-rest-boilerplate) | 26 | `cross-env NODE_ENV=test mocha` | 
