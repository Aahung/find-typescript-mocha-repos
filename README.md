...
The list was updated at 01:55:47 03/11/19 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 70934 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17373 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13291 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11590 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7257 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6628 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5796 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 5021 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4820 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4782 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4199 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3443 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3298 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3066 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [retejs/rete](https://github.com/retejs/rete) | 2946 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2927 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2687 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts'` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2461 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2355 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2272 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1964 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1581 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1540 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1501 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1493 | `nyc -x '' mocha` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1491 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1377 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1367 | `mocha --opts mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 1351 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1270 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [funkia/list](https://github.com/funkia/list) | 1260 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1228 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1179 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1129 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1118 | `tsc -p ./ && mocha` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 979 | `mocha bin/tests/test.js` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 978 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 958 | `mocha --opts test/mocha.opts` | 
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 889 | `npm run mocha` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 806 | `mocha --require ts-node/register` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 793 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 732 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 670 | `mocha test/unit` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 628 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [szokodiakos/typegoose](https://github.com/szokodiakos/typegoose) | 611 | `npm run lint && nyc npm run mocha` | 
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 609 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 597 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [mateogianolio/vectorious](https://github.com/mateogianolio/vectorious) | 584 | `nyc mocha -r ts-node/register ./src/*.spec.ts` | 
| [emilioastarita/lyricfier](https://github.com/emilioastarita/lyricfier) | 564 | `mocha` | 
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 561 | `mocha test` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 549 | `tsc && mocha test && yarn lint` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 523 | `cd test && mocha -r ts-node/register *.ts` | 
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 510 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 502 | `npm run mocha` | 
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 499 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 485 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [felixfbecker/vscode-php-debug](https://github.com/felixfbecker/vscode-php-debug) | 408 | `mocha out/test --timeout 20000 --slow 1000 --retries 4` | 
...
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 377 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 362 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
| [itsFrank/vue-typescript](https://github.com/itsFrank/vue-typescript) | 361 | `mocha` | 
| [apollographql/persistgraphql](https://github.com/apollographql/persistgraphql) | 360 | `mocha --reporter spec --full-trace lib/test/tests.js` | 
| [arangodb/arangojs](https://github.com/arangodb/arangojs) | 360 | `mocha --growl --reporter spec --require source-map-support/register --timeout 10000 lib/async/test` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 350 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 347 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 335 | `mocha` | 
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 328 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 311 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 301 | `mocha lib/test` | 
...
| [nefe/pont](https://github.com/nefe/pont) | 288 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 287 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [nwtgck/piping-server](https://github.com/nwtgck/piping-server) | 281 | `mocha --require ts-node/register --timeout 10000 test/**/*.ts` | 
| [cdonohue/polychrome](https://github.com/cdonohue/polychrome) | 279 | `mocha --compilers js:babel-register test/**/*.js` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 278 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [RisingStack/node-typescript-starter](https://github.com/RisingStack/node-typescript-starter) | 267 | `tsc && mocha dist/**/*.spec.js` | 
...
| [harttle/liquidjs](https://github.com/harttle/liquidjs) | 223 | `npm run build && mocha "test/**/*.ts"` | 
...
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 214 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [emmanueltouzery/prelude-ts](https://github.com/emmanueltouzery/prelude-ts) | 191 | `rm tests/apidoc-*; tsc && node ./dist/tests/Comments.js && tsc && ./node_modules/mocha/bin/mocha --throw-deprecation --timeout 60000 ./dist/tests/*.js` | 
...
| [Chinachu/Mirakurun](https://github.com/Chinachu/Mirakurun) | 173 | `mocha --exit test/*.spec.js` | 
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 173 | `tsc && mocha` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 169 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 165 | `nyc --reporter=html --reporter=text mocha` | 
...
| [Microsoft/monaco-languages](https://github.com/Microsoft/monaco-languages) | 142 | `mocha` | 
...
| [grantila/fetch-h2](https://github.com/grantila/fetch-h2) | 132 | `npm run lint && node_modules/.bin/nyc --require source-map-support/register npm run mocha` | 
...
| [Esri/react-arcgis](https://github.com/Esri/react-arcgis) | 122 | `nyc mocha` | 
...
| [gcanti/prop-types-ts](https://github.com/gcanti/prop-types-ts) | 108 | `npm run lint && npm run prettier && npm run mocha` | 
...
| [inversify/inversify-express-example](https://github.com/inversify/inversify-express-example) | 108 | `nyc --clean --all --require ts-node/register --require reflect-metadata/Reflect --extension .ts -- mocha --exit --timeout 5000` | 
| [balassy/aws-lambda-typescript](https://github.com/balassy/aws-lambda-typescript) | 107 | `nyc mocha --config ./test/.mocharc.yml` | 
...
| [redhat-developer/vscode-yaml](https://github.com/redhat-developer/vscode-yaml) | 98 | `mocha --ui tdd out/test/extension.test.js` | 
...
| [Azure/azure-cosmos-js](https://github.com/Azure/azure-cosmos-js) | 91 | `mocha -r ./src/test/common/setup.ts ./lib/src/test/ --recursive --timeout 100000 -i -g .*ignore.js` | 
...
| [timocov/dts-bundle-generator](https://github.com/timocov/dts-bundle-generator) | 82 | `mocha --timeout 10000 --slow 2500 tests/unittests/**/*.spec.js tests/functional-test-cases.js` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 80 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
...
| [deerawan/vscode-dash](https://github.com/deerawan/vscode-dash) | 73 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec --ui tdd ./out/test/extension.test.js` | 
...
| [TonyRobotics/RoboWare-Studio](https://github.com/TonyRobotics/RoboWare-Studio) | 69 | `mocha` | 
...
| [interledgerjs/ilp-connector](https://github.com/interledgerjs/ilp-connector) | 68 | `nyc mocha` | 
...
| [MichalLytek/class-transformer-validator](https://github.com/MichalLytek/class-transformer-validator) | 65 | `mocha build/tests/index.js` | 
...
| [ngduc/node-rem](https://github.com/ngduc/node-rem) | 63 | `cross-env NODE_ENV=test nyc --reporter=html --reporter=text --reporter=lcov mocha --require ts-node/register --full-trace --bail --timeout 20000 --exit tests/**/*.ts` | 
...
| [dalenguyen/firestore-backup-restore](https://github.com/dalenguyen/firestore-backup-restore) | 63 | `mocha --timeout 99999999 --exit -r ts-node/register test/**/*.spec.ts` | 
...
| [waitingsong/node-win32-api](https://github.com/waitingsong/node-win32-api) | 62 | `mocha --opts test/mocha.opts` | 
...
| [KennethanCeyer/browser-detect](https://github.com/KennethanCeyer/browser-detect) | 59 | `nyc mocha` | 
...
| [yesmeck/waque](https://github.com/yesmeck/waque) | 57 | `nyc mocha --forbid-only "test/**/*.test.ts"` | 
...
| [Microsoft/vscode-html-languageservice](https://github.com/Microsoft/vscode-html-languageservice) | 50 | `npm run compile && mocha && npm run lint` | 
...
| [eclipse/sprotty](https://github.com/eclipse/sprotty) | 45 | `jenkins-mocha --opts ./configs/mocha.opts "./src/**/*.spec.?(ts|tsx)"` | 
