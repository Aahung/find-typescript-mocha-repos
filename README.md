...
The list was updated at 00:43:44 09/23/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 59783 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 14897 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 8852 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8293 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6757 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5671 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4768 | `npm run mocha` | 
| [Microsoft/sqlopsstudio](https://github.com/Microsoft/sqlopsstudio) | 4356 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 3969 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3258 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2736 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2550 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
...
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 1992 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1788 | `mocha` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1782 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1725 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1648 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1318 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1232 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1228 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1182 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1066 | `mocha --opts mocha.opts` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 834 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [google/clasp](https://github.com/google/clasp) | 794 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 608 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 569 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 532 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 482 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 411 | `npm run mocha` | 
...
| [felixfbecker/vscode-php-debug](https://github.com/felixfbecker/vscode-php-debug) | 374 | `mocha out/test --timeout 20000 --slow 1000 --retries 4` | 
...
| [Polymer/prpl-server](https://github.com/Polymer/prpl-server) | 338 | `npm run build && mocha` | 
...
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 266 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 261 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 257 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 254 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 209 | `mocha test` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 209 | `mocha test` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 202 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 200 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
...
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 180 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
...
| [thiagobustamante/typescript-rest](https://github.com/thiagobustamante/typescript-rest) | 177 | `cross-env NODE_ENV=test mocha` | 
...
| [emmanueltouzery/prelude.ts](https://github.com/emmanueltouzery/prelude.ts) | 136 | `rm tests/apidoc-*; tsc && node ./dist/tests/Comments.js && tsc && ./node_modules/mocha/bin/mocha --throw-deprecation --timeout 60000 ./dist/tests/*.js` | 
...
| [Microsoft/vscode-vsce](https://github.com/Microsoft/vscode-vsce) | 111 | `gulp compile && mocha` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 97 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
...
| [MichaelSolati/geofirestore](https://github.com/MichaelSolati/geofirestore) | 84 | `nyc --reporter=html --reporter=text mocha` | 
...
| [DavidDuwaer/Coloquent](https://github.com/DavidDuwaer/Coloquent) | 49 | `npm run build && mocha -r ts-node/register tests/**/*.test.ts` | 
