...
The list was updated at 00:43:57 10/11/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 61429 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15170 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9288 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8590 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8126 | `mocha --opts mocha.opts && agadoo shared.js` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6836 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5817 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4875 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4429 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4052 | `npm-run-all test:pre -p test:mocha test:rules` | 
...
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2619 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2424 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2406 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2152 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2029 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1751 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1108 | `mocha --opts mocha.opts` | 
...
| [itchio/itch](https://github.com/itchio/itch) | 920 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 909 | `mocha --opts test/mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 884 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 874 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 768 | `mocha bin/tests/test.js` | 
| [google/clasp](https://github.com/google/clasp) | 884 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 874 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 650 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 616 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 398 | `cross-env NODE_ENV=test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 394 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 373 | `cross-env TS_NODE_COMPILER="ttypescript" mocha --opts mocha.opts` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 359 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 295 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 276 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 231 | `mocha test` | 
| [liangzeng/cqrs](https://github.com/liangzeng/cqrs) | 231 | `tsc && mocha` | 
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 231 | `mocha` | 
...
| [martysweet/cfn-lint](https://github.com/martysweet/cfn-lint) | 120 | `mocha lib/test` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 109 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 104 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [functionalone/serverless-iam-roles-per-function](https://github.com/functionalone/serverless-iam-roles-per-function) | 90 | `nyc mocha --require ts-node/register --require source-map-support/register  ./src/test/**/*.test.ts` | 
...
| [troch/path-parser](https://github.com/troch/path-parser) | 66 | `mocha -r ts-node/register 'test/main.js'` | 
...
| [Azure/azure-cosmos-js](https://github.com/Azure/azure-cosmos-js) | 59 | `mocha -r ./src/test/common/setup.ts ./lib/test/ --recursive --timeout 100000 -i -g .*ignore.js` | 
...
| [HdrHistogram/HdrHistogramJS](https://github.com/HdrHistogram/HdrHistogramJS) | 41 | `mocha --opts mocha.opts --watch` | 
