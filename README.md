...
The list was updated at 01:55:17 10/24/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 62605 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15395 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9551 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8811 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8183 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6876 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5924 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4940 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4460 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4110 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3321 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2765 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2716 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2484 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2409 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2260 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2059 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1817 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1789 | `mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1772 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1679 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1343 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1291 | `nyc -x '' mocha` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1232 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1231 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [funkia/list](https://github.com/funkia/list) | 1188 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1140 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [watson-developer-cloud/node-sdk](https://github.com/watson-developer-cloud/node-sdk) | 1135 | `nyc mocha test/unit/ test/integration/ && nyc report --reporter=html` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1131 | `mocha --opts mocha.opts` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1077 | `nyc --reporter=html --reporter=text mocha` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1073 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1061 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1008 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 998 | `tsc -p ./ && mocha` | 
...
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 913 | `mocha --opts test/mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 908 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 868 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 801 | `mocha bin/tests/test.js` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 740 | `mocha test/backend` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 672 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 662 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
| [laoqiren/mlhelper](https://github.com/laoqiren/mlhelper) | 646 | `mocha --recursive` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 641 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 632 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 630 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
| [jaysoo/todomvc-redux-react-typescript](https://github.com/jaysoo/todomvc-redux-react-typescript) | 599 | `tsc && mocha --require test-setup --recursive ./dist/**/__spec__/**/*-spec.js` | 
| [hacksparrow/node-easyimage](https://github.com/hacksparrow/node-easyimage) | 586 | `npm run lint && npm run mocha` | 
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 578 | `mocha "out/**/*.spec.js" -s 0` | 
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 556 | `mocha lib/test/unittest.js --check-leaks --color` | 
| [emilioastarita/lyricfier](https://github.com/emilioastarita/lyricfier) | 546 | `mocha` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 508 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 489 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 474 | `mocha --opts mocha.opts` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 464 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [43081j/rar.js](https://github.com/43081j/rar.js) | 464 | `npm run build && mocha` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 446 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [incrediblesound/story-graph](https://github.com/incrediblesound/story-graph) | 441 | `_mocha --` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 434 | `mocha --opts mocha.opts` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 425 | `npm run mocha` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 424 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 417 | `cross-env NODE_ENV=test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 415 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 403 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 397 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 395 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 370 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 300 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 299 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
| [FinNLP/en-inflectors](https://github.com/FinNLP/en-inflectors) | 290 | `mocha` | 
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 283 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 265 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 245 | `mocha test` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 241 | `mocha` | 
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 236 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 224 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
| [RisingStack/node-typescript-starter](https://github.com/RisingStack/node-typescript-starter) | 217 | `tsc && mocha dist/**/*.spec.js` | 
| [renke/import-sort](https://github.com/renke/import-sort) | 215 | `mocha --require ts-node/register --recursive "packages/*/test/**/*.ts"` | 
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 214 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
| [stardustjs/stardust-core](https://github.com/stardustjs/stardust-core) | 206 | `mocha test` | 
| [Microsoft/vscode-cordova](https://github.com/Microsoft/vscode-cordova) | 205 | `node ./node_modules/mocha/bin/mocha --recursive -u bdd ./out/test/debugger` | 
| [zekelevu/typeframework](https://github.com/zekelevu/typeframework) | 200 | `mocha -R spec test/integration` | 
| [Polymer/polyserve](https://github.com/Polymer/polyserve) | 197 | `npm run build && mocha && tslint "src/**/*.ts"` | 
| [HerringtonDarkholme/av-ts](https://github.com/HerringtonDarkholme/av-ts) | 195 | `mocha dist/test.js` | 
...
| [ClickSimply/Nano-SQL](https://github.com/ClickSimply/Nano-SQL) | 194 | `mocha -r ts-node/register tests/index.ts` | 
| [jedmao/eclint](https://github.com/jedmao/eclint) | 193 | `nyc npm run mocha -- --reporter lcov --reporter spec` | 
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 193 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 187 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [thiagobustamante/typescript-rest](https://github.com/thiagobustamante/typescript-rest) | 183 | `cross-env NODE_ENV=test mocha` | 
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 181 | `mocha-webpack "src/**/*.ts"` | 
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 181 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 165 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 154 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [Chinachu/Mirakurun](https://github.com/Chinachu/Mirakurun) | 151 | `mocha --exit test/*.spec.js` | 
| [Microsoft/vscode-node-debug](https://github.com/Microsoft/vscode-node-debug) | 150 | `mocha --timeout 10000 -u tdd ./out/tests/` | 
...
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 145 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [nozer/quill-delta-to-html](https://github.com/nozer/quill-delta-to-html) | 122 | `./node_modules/nyc/bin/nyc.js ./node_modules/mocha/bin/mocha --compilers ts:ts-node/register -b "./test/**/*.ts"  ` | 
...
| [ConquestArrow/dtsmake](https://github.com/ConquestArrow/dtsmake) | 121 | `mocha --compilers ts:ts-node/register test/*.ts` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 116 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [Soluto/graphql-to-mongodb](https://github.com/Soluto/graphql-to-mongodb) | 108 | `ts-mocha tests/**/*.spec.ts` | 
...
| [bradymholt/cRonstrue](https://github.com/bradymholt/cRonstrue) | 102 | `npx mocha --reporter spec --compilers ts:ts-node/register` | 
...
| [functionalone/serverless-iam-roles-per-function](https://github.com/functionalone/serverless-iam-roles-per-function) | 95 | `nyc mocha --require ts-node/register --require source-map-support/register  ./src/test/**/*.test.ts` | 
...
| [IBM/Decentralized-Energy-Composer](https://github.com/IBM/Decentralized-Energy-Composer) | 94 | `mocha --recursive -t 4000` | 
...
| [mtmr0x/nucleo](https://github.com/mtmr0x/nucleo) | 78 | `mocha -r ts-node/register` | 
...
| [AlexGalays/spacelift](https://github.com/AlexGalays/spacelift) | 76 | `mocha test/test.js && mocha --ui tdd test/option.js && mocha --ui tdd test/result.js` | 
...
| [redhat-developer/vscode-yaml](https://github.com/redhat-developer/vscode-yaml) | 73 | `mocha --ui tdd out/test/extension.test.js` | 
...
| [wbhob/nest-middlewares](https://github.com/wbhob/nest-middlewares) | 71 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
...
| [olosegres/jsona](https://github.com/olosegres/jsona) | 70 | `npm run test-compile && env NODE_ENV=test ts-mocha ./**/*.test.ts` | 
...
| [AlexGalays/immupdate](https://github.com/AlexGalays/immupdate) | 66 | `mocha test/test.js && node test/testCompilationErrors.js` | 
...
| [AndrewPoyntz/time-ago-pipe](https://github.com/AndrewPoyntz/time-ago-pipe) | 63 | `mocha --reporter spec --require ts-node/register test/**/*.spec.ts` | 
...
| [DavidDuwaer/Coloquent](https://github.com/DavidDuwaer/Coloquent) | 55 | `npm run build && mocha -r ts-node/register tests/**/*.test.ts` | 
...
| [argoproj/argo-ci](https://github.com/argoproj/argo-ci) | 54 | `TS_NODE_PROJECT=./src/tests/tsconfig.json mocha --require ts-node/register ./src/tests/**/*spec.ts` | 
...
| [deerawan/vscode-dash](https://github.com/deerawan/vscode-dash) | 50 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec --ui tdd ./out/test/extension.test.js` | 
...
| [duffman/tspath](https://github.com/duffman/tspath) | 46 | `mocha -r ts-node/register test/**.*/test.ts` | 
...
| [sourcegraph/browser-extensions](https://github.com/sourcegraph/browser-extensions) | 41 | `mocha --require ts-node/register --watch --watch-extensions ts './src/**/*.test.ts?(x)'` | 
...
| [wearetheledger/fabric-node-chaincode-utils](https://github.com/wearetheledger/fabric-node-chaincode-utils) | 41 | `mocha -r ts-node/register test/**/*.spec.ts --reporter spec` | 
...
| [zaaack/inker](https://github.com/zaaack/inker) | 37 | `electron-mocha --renderer -r ./tools/register "src/test/**.test.ts"` | 
...
| [vrudikov/typescript-rest-boilerplate](https://github.com/vrudikov/typescript-rest-boilerplate) | 29 | `cross-env NODE_ENV=test mocha` | 
...
| [functionalone/aws-least-privilege](https://github.com/functionalone/aws-least-privilege) | 28 | `nyc mocha --require ts-node/register --require source-map-support/register  ./src/test/**/*.test.ts` | 
