...
The list was updated at 00:43:56 10/05/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 60990 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15101 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9151 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8483 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8100 | `mocha --opts mocha.opts && agadoo shared.js` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6811 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5773 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4845 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4415 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4018 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3290 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2747 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2586 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2406 | `mocha 'test/**/*.ts'` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2398 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2090 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2014 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1795 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1789 | `mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1740 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1665 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1331 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1272 | `nyc -x '' mocha` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1232 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1192 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [funkia/list](https://github.com/funkia/list) | 1174 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1124 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [watson-developer-cloud/node-sdk](https://github.com/watson-developer-cloud/node-sdk) | 1119 | `nyc mocha test/unit/ test/integration/ && nyc report --reporter=html` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1102 | `mocha --opts mocha.opts` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1077 | `nyc --reporter=html --reporter=text mocha` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1044 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 984 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 917 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 906 | `mocha --opts test/mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 865 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 863 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [angular/dgeni](https://github.com/angular/dgeni) | 703 | `mocha --require ts-node/register -R spec src/**/*.spec.ts` | 
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 669 | `mocha` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 654 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 579 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 573 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 502 | `mocha test` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 494 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 443 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [incrediblesound/story-graph](https://github.com/incrediblesound/story-graph) | 441 | `_mocha --` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 438 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 398 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 391 | `cross-env NODE_ENV=test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 387 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [felixfbecker/vscode-php-debug](https://github.com/felixfbecker/vscode-php-debug) | 377 | `mocha out/test --timeout 20000 --slow 1000 --retries 4` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 367 | `cross-env TS_NODE_COMPILER="ttypescript" mocha --opts mocha.opts` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 348 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 291 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
| [FinNLP/en-inflectors](https://github.com/FinNLP/en-inflectors) | 289 | `mocha` | 
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 288 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
| [alexcambose/motus](https://github.com/alexcambose/motus) | 279 | `cross-env mocha -r ts-node/register 'test/**/*.spec.ts'` | 
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 275 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 272 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 258 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
| [albburtsev/bem-cn](https://github.com/albburtsev/bem-cn) | 256 | `mocha src/**/*.spec.ts` | 
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 256 | `mocha lib/test` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 227 | `mocha` | 
| [duniter/duniter](https://github.com/duniter/duniter) | 226 | `nyc --reporter html mocha` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 219 | `mocha test` | 
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 215 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
| [renke/import-sort](https://github.com/renke/import-sort) | 214 | `mocha --require ts-node/register --recursive "packages/*/test/**/*.ts"` | 
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 206 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
...
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 184 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 181 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 163 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 161 | `mocha-webpack "src/**/*.ts"` | 
...
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 158 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [microsoftgraph/msgraph-sdk-javascript](https://github.com/microsoftgraph/msgraph-sdk-javascript) | 154 | `mocha lib/spec/core` | 
...
| [hydux/hydux](https://github.com/hydux/hydux) | 129 | `npm run mocha -- "src/test/unit/*.test.ts"` | 
...
| [DotJoshJohnson/vscode-xml](https://github.com/DotJoshJohnson/vscode-xml) | 122 | `npm run compile && mocha ./out/test/**/*.js` | 
...
| [Microsoft/monaco-languages](https://github.com/Microsoft/monaco-languages) | 106 | `mocha` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 97 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [JoshGlazebrook/socks](https://github.com/JoshGlazebrook/socks) | 93 | `NODE_ENV=test mocha --recursive --compilers ts:ts-node/register test/**/*.ts` | 
...
| [MichaelSolati/geofirestore](https://github.com/MichaelSolati/geofirestore) | 90 | `nyc --reporter=html --reporter=text mocha` | 
| [matthew-matvei/freeman](https://github.com/matthew-matvei/freeman) | 89 | `xvfb-maybe electron-mocha --renderer __tests__` | 
...
| [wonderful-panda/vue-tsx-support](https://github.com/wonderful-panda/vue-tsx-support) | 83 | `npm-run-all prettier tsc-test mocha` | 
...
| [atomist/sdm](https://github.com/atomist/sdm) | 81 | `nyc mocha --require espower-typescript/guess --require source-map-support/register "test/**/*.test.ts"` | 
...
| [atlassian/nucleus](https://github.com/atlassian/nucleus) | 72 | `mocha --compilers ts:ts-node/register src/__spec__/rest.ts src/**/__spec__/*_spec.ts src/**/**/__spec__/*_spec.ts` | 
...
| [flagello/Essence](https://github.com/flagello/Essence) | 71 | `mocha` | 
...
| [wbhob/nest-middlewares](https://github.com/wbhob/nest-middlewares) | 68 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
...
| [gcanti/elm-ts](https://github.com/gcanti/elm-ts) | 67 | `npm run lint && npm run mocha` | 
...
| [googleapis/nodejs-bigquery](https://github.com/googleapis/nodejs-bigquery) | 63 | `mocha build/test` | 
...
| [theGlenn/apollo-prophecy](https://github.com/theGlenn/apollo-prophecy) | 60 | `rm -rf coverage && nyc mocha --opts mocha.opts` | 
| [bespoken/virtual-alexa](https://github.com/bespoken/virtual-alexa) | 60 | `nyc mocha lib/**/*Test.js` | 
...
| [Azure/azure-cosmos-js](https://github.com/Azure/azure-cosmos-js) | 56 | `mocha -r ./src/test/common/setup.ts ./lib/test/ --recursive --timeout 100000 -i -g .*ignore.js` | 
| [isc30/linq-collections](https://github.com/isc30/linq-collections) | 56 | `nyc mocha ./build/test/TestSuite.js --slow 0` | 
| [metadevpro/openapi3-ts](https://github.com/metadevpro/openapi3-ts) | 56 | `mocha --recursive --compilers ts:ts-node/register --require source-map-support/register "src/**/*.spec.ts"` | 
...
| [cartant/rxjs-etc](https://github.com/cartant/rxjs-etc) | 54 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [mceachen/exiftool-vendored.js](https://github.com/mceachen/exiftool-vendored.js) | 52 | `nyc mocha --opts .mocha.opts` | 
...
| [matthiasferch/tsm](https://github.com/matthiasferch/tsm) | 50 | `mocha -r ts-node/register test/**/*.spec.ts` | 
| [matthiasferch/tsm](https://github.com/matthiasferch/tsm) | 50 | `mocha -r ts-node/register test/**/*.spec.ts` | 
...
| [timocov/dts-bundle-generator](https://github.com/timocov/dts-bundle-generator) | 47 | `mocha --timeout 10000 --slow 2500 tests/all-test-cases.js` | 
...
| [Anonyfox/vuex-store-module-example](https://github.com/Anonyfox/vuex-store-module-example) | 43 | `rm -rf dist && tsc -p . && npm run lint && mocha dist/test` | 
...
| [w11k/ngx-componentdestroyed](https://github.com/w11k/ngx-componentdestroyed) | 41 | `mocha --opts spec/mocha.opts src/**/*test.ts` | 
...
| [ryu1kn/vscode-partial-diff](https://github.com/ryu1kn/vscode-partial-diff) | 38 | `mocha --opts cli-test-mocha.opts` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 38 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [sourcegraph/sourcegraph-extension-api](https://github.com/sourcegraph/sourcegraph-extension-api) | 36 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --require ts-node/register --require source-map-support/register --opts mocha.opts` | 
...
| [dupski/json-to-graphql-query](https://github.com/dupski/json-to-graphql-query) | 35 | `mocha -r ts-node/register --recursive "./src/**/__tests__/*"` | 
...
| [tgreyjs/typedoc-plugin-markdown](https://github.com/tgreyjs/typedoc-plugin-markdown) | 34 | `mocha test/test.js` | 
...
| [evebook/api](https://github.com/evebook/api) | 32 | `nyc --require ts-node/register mocha src/**/*.spec.ts --reporter spec` | 
...
| [bpowers/sd.js](https://github.com/bpowers/sd.js) | 29 | `tsc -p .tsconfig.test.json && mocha` | 
| [danrevah/typeserializer](https://github.com/danrevah/typeserializer) | 29 | `NODE_ENV=test mocha -r ts-node/register src/*.spec.ts src/**/*.spec.ts` | 
...
| [KennethanCeyer/browser-detect](https://github.com/KennethanCeyer/browser-detect) | 29 | `nyc mocha` | 
...
| [typeorm/typescript-example](https://github.com/typeorm/typescript-example) | 25 | `mocha -r ts-node/register test/**/*.spec.ts` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 25 | `mocha` | 
