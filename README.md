...
The list was updated at 01:55:32 12/14/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 65625 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16232 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10913 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9684 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8624 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6979 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6138 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5264 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4583 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4370 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3860 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3371 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2823 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2731 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2714 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2427 | `mocha 'test/**/*.ts'` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1860 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1858 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1413 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1362 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1357 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1249 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1237 | `mocha --opts mocha.opts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1233 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [funkia/list](https://github.com/funkia/list) | 1219 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1194 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1188 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1178 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha test/**/*.ts -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1110 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1091 | `nyc --reporter=html --reporter=text mocha` | 
| [google/clasp](https://github.com/google/clasp) | 1089 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1041 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 964 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 930 | `mocha --opts test/mocha.opts` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 899 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 861 | `mocha bin/tests/test.js` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 672 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 584 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 534 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 472 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 467 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 463 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 436 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 412 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 376 | `mocha test/unit` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 280 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 234 | `npx ts-mocha ./src/tests/**.ts` | 
| [duniter/duniter](https://github.com/duniter/duniter) | 225 | `nyc --reporter html mocha` | 
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 222 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
| [renke/import-sort](https://github.com/renke/import-sort) | 221 | `mocha --require ts-node/register --recursive "packages/*/test/**/*.ts"` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 219 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [DotJoshJohnson/vscode-xml](https://github.com/DotJoshJohnson/vscode-xml) | 131 | `npm run compile && mocha ./out/test/**/*.js` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 130 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [Half-Shot/matrix-appservice-discord](https://github.com/Half-Shot/matrix-appservice-discord) | 127 | `npm run-script build && mocha --opts test/mocha.opts build/test/config.js build/test` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 118 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [dsherret/ts-nameof](https://github.com/dsherret/ts-nameof) | 112 | `yarn run --silent copy-test-files && nyc --reporter=lcov mocha --opts mocha.opts` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 99 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [mysticatea/vue-eslint-parser](https://github.com/mysticatea/vue-eslint-parser) | 92 | `nyc npm run _mocha` | 
...
| [bpatrik/pigallery2](https://github.com/bpatrik/pigallery2) | 72 | `ng test && mocha --recursive test/backend/unit && mocha --recursive test/backend/integration  && mocha --recursive test/common/unit ` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 70 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [PeculiarVentures/graphene](https://github.com/PeculiarVentures/graphene) | 66 | `mocha` | 
...
| [waitingsong/node-win32-api](https://github.com/waitingsong/node-win32-api) | 47 | `mocha --opts test/mocha.opts` | 
...
| [aleris/zxing-typescript](https://github.com/aleris/zxing-typescript) | 38 | `mocha --compilers js:babel-core/register "build-node/test/core/**/*.js" --timeout 30000 --colors` | 
