...
The list was updated at 01:55:42 01/04/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 66681 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16501 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11411 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10078 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7019 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6259 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5419 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4622 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4484 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3998 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3398 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2853 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2851 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2812 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 2629 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2453 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2433 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2228 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1874 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1801 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1756 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1432 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1410 | `nyc -x '' mocha` | 
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1395 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1304 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1265 | `mocha --opts mocha.opts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1262 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
...
| [cherow/cherow](https://github.com/cherow/cherow) | 1212 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha test/**/*.ts -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1203 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [google/clasp](https://github.com/google/clasp) | 1130 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 768 | `mocha test/backend` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 746 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
...
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 707 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 607 | `mocha "out/**/*.spec.js" -s 0` | 
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 602 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [angular/dgeni](https://github.com/angular/dgeni) | 710 | `mocha --require ts-node/register -R spec src/**/*.spec.ts` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 707 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 682 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 681 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 667 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
| [laoqiren/mlhelper](https://github.com/laoqiren/mlhelper) | 648 | `mocha --recursive` | 
| [jaysoo/todomvc-redux-react-typescript](https://github.com/jaysoo/todomvc-redux-react-typescript) | 612 | `tsc && mocha --require test-setup --recursive ./dist/**/__spec__/**/*-spec.js` | 
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 607 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 566 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 545 | `mocha test/unit` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 499 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 487 | `mocha --opts mocha.opts` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 477 | `mocha --opts mocha.opts` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 476 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 461 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 454 | `npm run mocha` | 
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 449 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 446 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 440 | `tsc && mocha test && yarn lint` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 400 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [Polymer/prpl-server](https://github.com/Polymer/prpl-server) | 354 | `npm run build && mocha` | 
...
| [arangodb/arangojs](https://github.com/arangodb/arangojs) | 336 | `mocha --growl --reporter spec --require source-map-support/register --timeout 10000 lib/async/test` | 
...
| [alexcambose/motus](https://github.com/alexcambose/motus) | 295 | `cross-env mocha -r ts-node/register 'test/**/*.spec.ts'` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 294 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 292 | `mocha` | 
| [FinNLP/en-inflectors](https://github.com/FinNLP/en-inflectors) | 291 | `mocha` | 
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 290 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
| [mgechev/aspect.js](https://github.com/mgechev/aspect.js) | 287 | `tsc && mocha -R nyan ./dist/test/**/*.spec.js` | 
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 284 | `mocha lib/test` | 
...
| [FormidableLabs/inspectpack](https://github.com/FormidableLabs/inspectpack) | 250 | `mocha "test/**/*.spec.ts"` | 
...
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 242 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 236 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
| [liangzeng/cqrs](https://github.com/liangzeng/cqrs) | 235 | `tsc && mocha` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 233 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [thiagobustamante/typescript-rest](https://github.com/thiagobustamante/typescript-rest) | 203 | `cross-env NODE_ENV=test mocha --exit` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 197 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 192 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [danvk/localturk](https://github.com/danvk/localturk) | 150 | `mocha --require ts-node/register test/**/*.ts` | 
...
| [nozer/quill-delta-to-html](https://github.com/nozer/quill-delta-to-html) | 140 | `./node_modules/nyc/bin/nyc.js ./node_modules/mocha/bin/mocha --compilers ts:ts-node/register -b "./test/**/*.ts"  ` | 
| [ConquestArrow/dtsmake](https://github.com/ConquestArrow/dtsmake) | 139 | `mocha --compilers ts:ts-node/register test/*.ts` | 
...
| [cartant/rxjs-marbles](https://github.com/cartant/rxjs-marbles) | 130 | `yarn run lint && yarn run test:build && cross-env FAILING=0 yarn run test:ava && cross-env FAILING=0 yarn run test:jasmine && cross-env FAILING=0 yarn run test:jasmine-angular && cross-env FAILING=0 yarn run test:jest && cross-env FAILING=0 yarn run test:mocha && cross-env FAILING=0 yarn run test:tape` | 
| [atomist/sdm](https://github.com/atomist/sdm) | 130 | `mocha --require espower-typescript/guess "test/**/*.test.ts"` | 
...
| [Enterprise-JS/vscode-ts-node-debugging](https://github.com/Enterprise-JS/vscode-ts-node-debugging) | 127 | `npm run mocha --recursive ./src/**/__tests__/*` | 
...
| [vrimar/construct-ui](https://github.com/vrimar/construct-ui) | 123 | `cross-env TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 119 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [arfedulov/semantic-ui-calendar-react](https://github.com/arfedulov/semantic-ui-calendar-react) | 117 | `npx cross-env TS_NODE_COMPILER_OPTIONS="{""allowJs"":true}" npx mocha -r ts-node/register ./test/setup.js ./test/**/*.{js,jsx,ts,tsx}` | 
| [nomiclabs/buidler](https://github.com/nomiclabs/buidler) | 117 | `nyc mocha` | 
...
| [matthew-matvei/freeman](https://github.com/matthew-matvei/freeman) | 111 | `xvfb-maybe electron-mocha --renderer __tests__` | 
...
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 111 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
| [grantila/fetch-h2](https://github.com/grantila/fetch-h2) | 109 | `npm run lint && node_modules/.bin/nyc npm run mocha` | 
| [Microsoft/TypeScript-TmLanguage](https://github.com/Microsoft/TypeScript-TmLanguage) | 109 | `mocha --full-trace tests/test.js  --reporter mocha-multi-reporters` | 
...
| [mysticatea/vue-eslint-parser](https://github.com/mysticatea/vue-eslint-parser) | 99 | `nyc npm run _mocha` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 81 | `nyc mocha test/**/*.test.ts` | 
...
| [rpgeeganage/async-ray](https://github.com/rpgeeganage/async-ray) | 66 | `nyc mocha` | 
...
| [teamdomy/domy-cli](https://github.com/teamdomy/domy-cli) | 60 | `mocha --reporter spec --require ts-node/register 'tests/**/*.spec.ts'` | 
...
| [ninoseki/mitaka](https://github.com/ninoseki/mitaka) | 54 | `nyc mocha -r ts-node/register "src/**/*.spec.ts"` | 
...
| [dupski/json-to-graphql-query](https://github.com/dupski/json-to-graphql-query) | 51 | `mocha -r ts-node/register --recursive "./src/**/__tests__/*"` | 
...
| [hg-pyun/iterize](https://github.com/hg-pyun/iterize) | 48 | `mocha --recursive ./test/*.ts --require ts-node/register` | 
...
| [Unibeautify/vscode](https://github.com/Unibeautify/vscode) | 45 | `mocha` | 
...
| [bpowers/sd.js](https://github.com/bpowers/sd.js) | 33 | `tsc -p .tsconfig.test.json && mocha` | 
