...
The list was updated at 01:55:50 12/03/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 64946 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16030 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10516 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9435 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8572 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6948 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6087 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5216 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4547 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4283 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3742 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
...
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2675 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2598 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2426 | `mocha 'test/**/*.ts'` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2376 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2168 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1841 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1652 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 20000 --max-parallel=1 --exit` | 
...
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1328 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1200 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1193 | `mocha --opts mocha.opts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1178 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1149 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1034 | `tsc -p ./ && mocha` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 890 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 850 | `mocha bin/tests/test.js` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 649 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 403 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 314 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 221 | `mocha test/unit` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 208 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 155 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [Microsoft/vscode-vsce](https://github.com/Microsoft/vscode-vsce) | 131 | `gulp compile && mocha` | 
...
| [Microsoft/monaco-languages](https://github.com/Microsoft/monaco-languages) | 118 | `mocha` | 
...
| [levjj/esverify](https://github.com/levjj/esverify) | 83 | `TS_NODE_TRANSPILE_ONLY=true mocha -r ts-node/register tests/*.ts` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 60 | `mocha` | 
...
| [getsentry/sentry-electron](https://github.com/getsentry/sentry-electron) | 56 | `cross-env TS_NODE_PROJECT=tsconfig.json xvfb-maybe electron-mocha --require ts-node/register/transpile-only --timeout 3000 ./test/unit/**/*.ts` | 
...
| [Anonyfox/vuex-store-module-example](https://github.com/Anonyfox/vuex-store-module-example) | 46 | `rm -rf dist && tsc -p . && npm run lint && mocha dist/test` | 
...
| [hg-pyun/iterize](https://github.com/hg-pyun/iterize) | 35 | `mocha --recursive ./test/*.ts --require ts-node/register` | 
