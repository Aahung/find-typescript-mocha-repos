...
The list was updated at 01:55:44 11/16/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 63954 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15764 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10089 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9180 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8376 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6925 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6016 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5097 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4502 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4210 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3351 | `mocha --opts mocha.opts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3082 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2793 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2592 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2426 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2418 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2131 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1558 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1374 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
...
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1168 | `mocha --opts mocha.opts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1165 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1128 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [google/clasp](https://github.com/google/clasp) | 1006 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [itchio/itch](https://github.com/itchio/itch) | 941 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 827 | `mocha bin/tests/test.js` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 693 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 503 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 477 | `mocha --opts mocha.opts` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 458 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 416 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 413 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 412 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
| [surf-build/surf](https://github.com/surf-build/surf) | 391 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 387 | `cd test && mocha -r ts-node/register *.ts` | 
| [felixfbecker/vscode-php-debug](https://github.com/felixfbecker/vscode-php-debug) | 386 | `mocha out/test --timeout 20000 --slow 1000 --retries 4` | 
...
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 297 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 279 | `mocha test` | 
...
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 227 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
...
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 204 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 149 | `mocha test/unit` | 
...
| [dsherret/ts-nameof](https://github.com/dsherret/ts-nameof) | 90 | `yarn run --silent copy-test-files && nyc --reporter=lcov mocha --opts mocha.opts` | 
...
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 79 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 71 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [indutny/llhttp](https://github.com/indutny/llhttp) | 68 | `npm run mocha && npm run lint` | 
...
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 47 | `nyc --reporter=html mocha --timeout 0 --require ts-node/register --require source-map-support/register --recursive src/test.ts` | 
...
| [indutny/bitcode](https://github.com/indutny/bitcode) | 34 | `npm run mocha && npm run lint` | 
...
| [gcanti/hyper-ts](https://github.com/gcanti/hyper-ts) | 29 | `npm run prettier && npm run lint && npm run typings-checker && npm run mocha` | 
