...
The list was updated at 01:56:01 01/25/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 67921 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16795 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11980 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10580 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7090 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6357 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5564 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4675 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4603 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4393 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3498 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3412 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3020 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2903 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2868 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2523 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2441 | `mocha 'test/**/*.ts'` | 
...
| [benjamn/recast](https://github.com/benjamn/recast) | 2196 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1910 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [staltz/xstream](https://github.com/staltz/xstream) | 1776 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1455 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1366 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1327 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1286 | `mocha --opts mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1256 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1218 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [google/clasp](https://github.com/google/clasp) | 1206 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [itchio/itch](https://github.com/itchio/itch) | 1010 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 907 | `mocha bin/tests/test.js` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 774 | `mocha test/backend` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 595 | `mocha test/unit` | 
| [hacksparrow/node-easyimage](https://github.com/hacksparrow/node-easyimage) | 593 | `npm run lint && npm run mocha` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 586 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 585 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 579 | `nyc mocha build/test` | 
| [pgilad/leasot](https://github.com/pgilad/leasot) | 579 | `mocha --require ts-node/register -R spec './tests/*.ts'` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 572 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 535 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 471 | `npm run mocha` | 
...
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 464 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
...
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 425 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 331 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 314 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 308 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 261 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
...
| [RisingStack/node-typescript-starter](https://github.com/RisingStack/node-typescript-starter) | 250 | `tsc && mocha dist/**/*.spec.js` | 
...
| [googleapis/nodejs-storage](https://github.com/googleapis/nodejs-storage) | 220 | `nyc mocha build/test` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 208 | `nyc mocha` | 
...
| [ohjames/rxjs-websockets](https://github.com/ohjames/rxjs-websockets) | 178 | `npm run build && npm run mocha` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 169 | `nyc mocha test/**/*.test.ts --exit` | 
...
| [danvk/localturk](https://github.com/danvk/localturk) | 152 | `mocha --require ts-node/register test/**/*.ts` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 142 | `nyc --reporter=html --reporter=text mocha` | 
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 141 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [Microsoft/monaco-languages](https://github.com/Microsoft/monaco-languages) | 136 | `mocha` | 
...
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 122 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
...
| [moodysalem/react-tournament-bracket](https://github.com/moodysalem/react-tournament-bracket) | 115 | `mocha --require ts-node/register src/**/*.test.tsx` | 
...
| [englercj/tsd-jsdoc](https://github.com/englercj/tsd-jsdoc) | 109 | `mocha --ui tdd -r ts-node/register test/specs/**.ts` | 
...
| [jvilk/MakeTypes](https://github.com/jvilk/MakeTypes) | 103 | `npm-run-all --serial prepublish generate:test build:test mocha` | 
...
| [googleapis/nodejs-pubsub](https://github.com/googleapis/nodejs-pubsub) | 99 | `nyc mocha build/test` | 
| [gcanti/prop-types-ts](https://github.com/gcanti/prop-types-ts) | 98 | `npm run lint && npm run prettier && npm run mocha` | 
...
| [redhat-developer/vscode-yaml](https://github.com/redhat-developer/vscode-yaml) | 86 | `mocha --ui tdd out/test/extension.test.js` | 
...
| [balassy/aws-lambda-typescript](https://github.com/balassy/aws-lambda-typescript) | 82 | `nyc mocha` | 
| [rh389/dynamodb-geo.js](https://github.com/rh389/dynamodb-geo.js) | 82 | `mocha --require ts-node/register test/**/*.ts` | 
| [googleapis/nodejs-bigquery](https://github.com/googleapis/nodejs-bigquery) | 81 | `nyc mocha build/test` | 
...
| [googleapis/nodejs-datastore](https://github.com/googleapis/nodejs-datastore) | 74 | `nyc mocha build/test` | 
...
| [alex-okrushko/backoff-rxjs](https://github.com/alex-okrushko/backoff-rxjs) | 67 | `mocha --opts spec/mocha.opts spec/**/*-spec.ts` | 
...
| [ninoseki/mitaka](https://github.com/ninoseki/mitaka) | 59 | `nyc mocha -r ts-node/register "src/**/*.spec.ts"` | 
...
| [Unibeautify/vscode](https://github.com/Unibeautify/vscode) | 51 | `mocha` | 
...
| [cartant/rxjs-observe](https://github.com/cartant/rxjs-observe) | 48 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [BeTomorrow/ReImproveJS](https://github.com/BeTomorrow/ReImproveJS) | 46 | `mocha --reporter spec --compilers ts:ts-node/register 'test/*.spec.ts' --timeout 120000` | 
...
| [jackrobertscott/graphql-api-demo](https://github.com/jackrobertscott/graphql-api-demo) | 41 | `NODE_ENV=test mocha --require=ts-node/register --recursive --exit 'src/**/*.spec.ts'` | 
...
| [Webtomizer/typeorm-loader](https://github.com/Webtomizer/typeorm-loader) | 35 | `npm run build && [ -d tests ] && NODE_ENV=test mocha $NODE_DEBUG_OPTION -r ts-node/register -r tslib tests/test_**.ts` | 
...
| [angular-extensions/model](https://github.com/angular-extensions/model) | 34 | `npm run lint && npm run format:test && nyc mocha {lib,schematics}/**/*.test.ts --require ts-node/register --require source-map-support/register` | 
