...
The list was updated at 01:56:19 03/07/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 70432 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17320 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13197 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11532 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7241 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6601 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5783 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4998 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4803 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4774 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4154 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3445 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3267 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3056 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [retejs/rete](https://github.com/retejs/rete) | 2936 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2924 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2673 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts'` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2461 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2347 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1469 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1362 | `mocha --opts mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 1341 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1265 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [itchio/itch](https://github.com/itchio/itch) | 1033 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 971 | `mocha bin/tests/test.js` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 957 | `mocha --opts test/mocha.opts` | 
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 882 | `npm run mocha` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 800 | `mocha --require ts-node/register` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 668 | `mocha test/unit` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 644 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 612 | `nyc mocha build/test` | 
| [szokodiakos/typegoose](https://github.com/szokodiakos/typegoose) | 610 | `npm run lint && nyc npm run mocha` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 604 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 604 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 601 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [bbc/sqs-consumer](https://github.com/bbc/sqs-consumer) | 592 | `mocha` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 482 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 321 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 305 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 283 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [nefe/pont](https://github.com/nefe/pont) | 274 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
...
| [slothking-online/diagram](https://github.com/slothking-online/diagram) | 267 | `mocha -r ts-node/register src/**/*.spec.ts` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 259 | `nyc mocha` | 
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 258 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 254 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [googleapis/nodejs-storage](https://github.com/googleapis/nodejs-storage) | 245 | `nyc mocha build/test` | 
...
| [thiagobustamante/typescript-rest](https://github.com/thiagobustamante/typescript-rest) | 226 | `cross-env NODE_ENV=test mocha --exit` | 
...
| [emmanueltouzery/prelude-ts](https://github.com/emmanueltouzery/prelude-ts) | 188 | `rm tests/apidoc-*; tsc && node ./dist/tests/Comments.js && tsc && ./node_modules/mocha/bin/mocha --throw-deprecation --timeout 60000 ./dist/tests/*.js` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 166 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
...
| [nomiclabs/buidler](https://github.com/nomiclabs/buidler) | 158 | `nyc mocha` | 
...
| [cartant/rxjs-marbles](https://github.com/cartant/rxjs-marbles) | 153 | `yarn run lint && yarn run test:build && cross-env FAILING=0 yarn run test:ava && cross-env FAILING=0 yarn run test:jasmine && cross-env FAILING=0 yarn run test:jasmine-angular && cross-env FAILING=0 yarn run test:jest && cross-env FAILING=0 yarn run test:mocha && cross-env FAILING=0 yarn run test:tape` | 
...
| [PeculiarVentures/graphene](https://github.com/PeculiarVentures/graphene) | 69 | `mocha` | 
...
| [TonyRobotics/RoboWare-Studio](https://github.com/TonyRobotics/RoboWare-Studio) | 66 | `mocha` | 
...
| [balmbees/dynamo-types](https://github.com/balmbees/dynamo-types) | 58 | `AWS_REGION=us-east-1 AWS_ACCESS_KEY_ID=mock AWS_SECRET_ACCESS_KEY=mock DYNAMO_TYPES_ENDPOINT=http://127.0.0.1:8000 mocha -t 20000 dst/**/__test__/**/*.js` | 
