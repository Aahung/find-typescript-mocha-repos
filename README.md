...
The list was updated at 01:56:11 03/15/19 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 71337 | `mocha` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11688 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7271 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6654 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5817 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4790 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4225 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3445 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3337 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3092 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3445 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3337 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3092 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [retejs/rete](https://github.com/retejs/rete) | 2957 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2931 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2697 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts'` | 
...
| [benjamn/recast](https://github.com/benjamn/recast) | 2284 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1972 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1943 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1812 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1799 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1591 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1551 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1509 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1504 | `nyc -x '' mocha` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1442 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1371 | `mocha --opts mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 1358 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
...
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1183 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1129 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1121 | `tsc -p ./ && mocha` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 992 | `mocha bin/tests/test.js` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 983 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 959 | `mocha --opts test/mocha.opts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 959 | `mocha --opts test/mocha.opts` | 
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 893 | `npm run mocha` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 810 | `mocha --require ts-node/register` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 798 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 634 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [szokodiakos/typegoose](https://github.com/szokodiakos/typegoose) | 620 | `npm run lint && nyc npm run mocha` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 616 | `nyc mocha build/test` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 603 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
| [bbc/sqs-consumer](https://github.com/bbc/sqs-consumer) | 598 | `mocha` | 
| [benjamn/ast-types](https://github.com/benjamn/ast-types) | 511 | `npm run gen && npm run build && npm run mocha` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 489 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
| [43081j/rar.js](https://github.com/43081j/rar.js) | 461 | `npm run build && mocha` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 453 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
| [incrediblesound/story-graph](https://github.com/incrediblesound/story-graph) | 445 | `_mocha --` | 
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 443 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
...
| [amplify-education/serverless-domain-manager](https://github.com/amplify-education/serverless-domain-manager) | 393 | `tsc --project . && nyc mocha -r ts-node/register test/unit-tests/index.test.ts && nyc report --reporter=text-summary` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 364 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
| [arangodb/arangojs](https://github.com/arangodb/arangojs) | 362 | `mocha --growl --reporter spec --require source-map-support/register --timeout 10000 lib/async/test` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 317 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 302 | `mocha lib/test` | 
| [alibaba/pont](https://github.com/alibaba/pont) | 299 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
| [mgechev/aspect.js](https://github.com/mgechev/aspect.js) | 297 | `tsc && mocha -R nyan ./dist/test/**/*.spec.js` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 296 | `cd test && mocha -r ts-node/register *.ts` | 
| [FinNLP/en-inflectors](https://github.com/FinNLP/en-inflectors) | 293 | `mocha` | 
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 292 | `mocha-webpack "src/**/*.ts"` | 
| [spiffcode/ghedit](https://github.com/spiffcode/ghedit) | 282 | `mocha` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 282 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [juanfranblanco/vscode-solidity](https://github.com/juanfranblanco/vscode-solidity) | 269 | `nyc --require ts-node/register --require source-map-support/register mocha test/**/*.spec.ts` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 261 | `nyc mocha` | 
...
| [googleapis/nodejs-storage](https://github.com/googleapis/nodejs-storage) | 250 | `nyc mocha build/test` | 
...
| [renke/import-sort](https://github.com/renke/import-sort) | 239 | `mocha --require ts-node/register --recursive "packages/*/test/**/*.ts"` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 199 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
...
| [JumpFm/jumpfm](https://github.com/JumpFm/jumpfm) | 196 | `mocha js` | 
| [PeterDing/chord](https://github.com/PeterDing/chord) | 195 | `mocha --delay` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 171 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 167 | `nyc --reporter=html --reporter=text mocha` | 
...
| [arfedulov/semantic-ui-calendar-react](https://github.com/arfedulov/semantic-ui-calendar-react) | 143 | `npx cross-env TS_NODE_COMPILER_OPTIONS="{""allowJs"":true}" npx mocha -r ts-node/register ./test/setup.js ./test/**/*.{js,jsx,ts,tsx}` | 
...
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 111 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
...
| [ngduc/node-rem](https://github.com/ngduc/node-rem) | 70 | `cross-env NODE_ENV=test nyc --reporter=html --reporter=text --reporter=lcov mocha --require ts-node/register --full-trace --bail --timeout 20000 --exit tests/**/*.ts` | 
...
| [argoproj/argo-ui](https://github.com/argoproj/argo-ui) | 54 | `mocha --require ts-node/register ./src/app/**/*.spec.ts` | 
...
| [mj1618/serverless-offline-sns](https://github.com/mj1618/serverless-offline-sns) | 49 | `nyc ts-mocha "test/**/*.ts" -p src/` | 
