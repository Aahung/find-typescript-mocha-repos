...
The list was updated at 01:55:25 11/01/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 63128 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15533 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9725 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8932 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8234 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6892 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5968 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5010 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4466 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4138 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3332 | `mocha --opts mocha.opts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2788 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2770 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2511 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2411 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2308 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2087 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1825 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1796 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1790 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1689 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1418 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1358 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1311 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1249 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1148 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1142 | `mocha --opts mocha.opts` | 
| [watson-developer-cloud/node-sdk](https://github.com/watson-developer-cloud/node-sdk) | 1138 | `nyc mocha test/unit/ test/integration/ && nyc report --reporter=html` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1095 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1078 | `nyc --reporter=html --reporter=text mocha` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1070 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1063 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1006 | `tsc -p ./ && mocha` | 
| [google/clasp](https://github.com/google/clasp) | 951 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [itchio/itch](https://github.com/itchio/itch) | 935 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 809 | `mocha bin/tests/test.js` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 746 | `mocha test/backend` | 
| [coinbase/gdax-tt](https://github.com/coinbase/gdax-tt) | 722 | `yarn run lint && yarn run test:mocha` | 
| [angular/dgeni](https://github.com/angular/dgeni) | 707 | `mocha --require ts-node/register -R spec src/**/*.spec.ts` | 
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 678 | `mocha` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 675 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 671 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 636 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
| [jaysoo/todomvc-redux-react-typescript](https://github.com/jaysoo/todomvc-redux-react-typescript) | 602 | `tsc && mocha --require test-setup --recursive ./dist/**/__spec__/**/*-spec.js` | 
| [hacksparrow/node-easyimage](https://github.com/hacksparrow/node-easyimage) | 586 | `npm run lint && npm run mocha` | 
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 581 | `mocha "out/**/*.spec.js" -s 0` | 
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 559 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 512 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 494 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 490 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 453 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [incrediblesound/story-graph](https://github.com/incrediblesound/story-graph) | 441 | `_mocha --` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 440 | `mocha --opts mocha.opts` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 430 | `npm run mocha` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 425 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 420 | `cross-env NODE_ENV=test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 413 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 406 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 398 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 370 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [arangodb/arangojs](https://github.com/arangodb/arangojs) | 324 | `mocha --growl --reporter spec --require source-map-support/register --timeout 10000 lib/async/test` | 
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 303 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 288 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 287 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
...
| [mgechev/aspect.js](https://github.com/mgechev/aspect.js) | 271 | `tsc && mocha -R nyan ./dist/test/**/*.spec.js` | 
...
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 265 | `mocha lib/test` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 255 | `mocha test` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 245 | `mocha` | 
...
| [RisingStack/node-typescript-starter](https://github.com/RisingStack/node-typescript-starter) | 223 | `tsc && mocha dist/**/*.spec.js` | 
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 223 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 217 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 194 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 186 | `mocha-webpack "src/**/*.ts"` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 176 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 174 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [FormidableLabs/inspectpack](https://github.com/FormidableLabs/inspectpack) | 165 | `mocha "test/**/*.spec.ts"` | 
| [pnp/office365-cli](https://github.com/pnp/office365-cli) | 164 | `nyc -r=lcov -r=text mocha "dist/**/*.spec.js"` | 
| [microsoftgraph/msgraph-sdk-javascript](https://github.com/microsoftgraph/msgraph-sdk-javascript) | 163 | `mocha lib/spec/core` | 
| [square/babel-codemod](https://github.com/square/babel-codemod) | 158 | `mocha "test/**/*Test.js"` | 
...
| [emmanueltouzery/prelude.ts](https://github.com/emmanueltouzery/prelude.ts) | 147 | `rm tests/apidoc-*; tsc && node ./dist/tests/Comments.js && tsc && ./node_modules/mocha/bin/mocha --throw-deprecation --timeout 60000 ./dist/tests/*.js` | 
...
| [hydux/hydux](https://github.com/hydux/hydux) | 135 | `npm run mocha -- "src/test/unit/*.test.ts"` | 
...
| [martysweet/cfn-lint](https://github.com/martysweet/cfn-lint) | 126 | `mocha lib/test` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 122 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [cartant/rxjs-marbles](https://github.com/cartant/rxjs-marbles) | 119 | `yarn run lint && yarn run test:build && cross-env FAILING=0 yarn run test:ava && cross-env FAILING=0 yarn run test:jasmine && cross-env FAILING=0 yarn run test:jasmine-angular && cross-env FAILING=0 yarn run test:jest && cross-env FAILING=0 yarn run test:mocha && cross-env FAILING=0 yarn run test:tape` | 
...
| [AzureAD/azure-activedirectory-library-for-nodejs](https://github.com/AzureAD/azure-activedirectory-library-for-nodejs) | 116 | `npm run tsc && mocha -R spec --ui tdd test` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 106 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
...
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 98 | `mocha` | 
...
| [tycho01/typical](https://github.com/tycho01/typical) | 96 | `tsc | tee tsc.log && mocha lib/**/*.test.js 2>&1 | sed 's/[0-9]\+)/×/g' | tee errors.log` | 
...
| [nucleojs/nucleo](https://github.com/nucleojs/nucleo) | 89 | `mocha -r ts-node/register` | 
...
| [atomist/sdm](https://github.com/atomist/sdm) | 87 | `nyc mocha --require espower-typescript/guess --require source-map-support/register "test/**/*.test.ts"` | 
...
| [dsherret/ts-nameof](https://github.com/dsherret/ts-nameof) | 86 | `npm run --silent copy-test-files && nyc --reporter=lcov mocha --opts mocha.opts` | 
...
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 83 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
...
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 73 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
| [wbhob/nest-middlewares](https://github.com/wbhob/nest-middlewares) | 73 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
...
| [cartant/rxjs-etc](https://github.com/cartant/rxjs-etc) | 59 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [DavidDuwaer/Coloquent](https://github.com/DavidDuwaer/Coloquent) | 57 | `npm run build && mocha -r ts-node/register tests/**/*.test.ts` | 
...
| [jsonapi-suite/jsorm](https://github.com/jsonapi-suite/jsorm) | 52 | `NODE_ENV=test mocha --opts test/mocha.opts` | 
| [deerawan/vscode-dash](https://github.com/deerawan/vscode-dash) | 52 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec --ui tdd ./out/test/extension.test.js` | 
...
| [DhyanaChina/koa2-typescript-guide](https://github.com/DhyanaChina/koa2-typescript-guide) | 48 | `mocha` | 
...
| [CommandBlockLogic/spu](https://github.com/CommandBlockLogic/spu) | 45 | `mocha --require espower-typescript/guess "./src/tests/**/*.ts"` | 
...
| [mshanemc/shane-sfdx-plugins](https://github.com/mshanemc/shane-sfdx-plugins) | 41 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [chanlito/simple-todos](https://github.com/chanlito/simple-todos) | 41 | `cross-env NODE_ENV=test nyc mocha --require test/index.ts --opts test/mocha.opts` | 
...
| [ninoseki/mitaka](https://github.com/ninoseki/mitaka) | 40 | `nyc mocha -r ts-node/register "src/**/*.spec.ts"` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 39 | `mocha` | 
...
| [RobinBuschmann/react.di](https://github.com/RobinBuschmann/react.di) | 38 | `mocha` | 
...
| [danrevah/typeserializer](https://github.com/danrevah/typeserializer) | 36 | `NODE_ENV=test mocha -r ts-node/register src/*.spec.ts src/**/*.spec.ts` | 
...
| [KennethanCeyer/browser-detect](https://github.com/KennethanCeyer/browser-detect) | 35 | `nyc mocha` | 
| [prismicio/prismic-javascript](https://github.com/prismicio/prismic-javascript) | 34 | `mocha` | 
| [evebook/api](https://github.com/evebook/api) | 34 | `nyc --require ts-node/register mocha src/**/*.spec.ts --reporter spec` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 30 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
