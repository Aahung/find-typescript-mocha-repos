...
The list was updated at 01:55:37 12/12/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 65457 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16192 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10822 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9651 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8611 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6975 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6119 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5257 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4577 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4359 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3829 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3370 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2821 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2724 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2699 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
...
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2197 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1858 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [staltz/xstream](https://github.com/staltz/xstream) | 1736 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1697 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 20000 --max-parallel=1 --exit` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1409 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1360 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1353 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1239 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1234 | `mocha --opts mocha.opts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1233 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [funkia/list](https://github.com/funkia/list) | 1216 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1187 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1183 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1176 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha test/**/*.ts -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [google/clasp](https://github.com/google/clasp) | 1082 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 896 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 728 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
| [angular/dgeni](https://github.com/angular/dgeni) | 711 | `mocha --require ts-node/register -R spec src/**/*.spec.ts` | 
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 703 | `mocha` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 699 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 665 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 661 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 579 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 541 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 460 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 450 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 434 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 430 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 409 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 286 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 277 | `mocha test/unit` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 218 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [jedmao/eclint](https://github.com/jedmao/eclint) | 199 | `nyc npm run mocha -- --reporter lcov --reporter spec` | 
...
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 142 | `tsc && mocha` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 127 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 115 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [palantir/react-layered-chart](https://github.com/palantir/react-layered-chart) | 101 | `mocha 'test/**/*.ts' && tslint --project tsconfig.json` | 
...
| [indutny/llparse](https://github.com/indutny/llparse) | 96 | `npm run mocha && npm run lint` | 
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 95 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [AndrewPoyntz/time-ago-pipe](https://github.com/AndrewPoyntz/time-ago-pipe) | 71 | `mocha --reporter spec --require ts-node/register test/**/*.spec.ts` | 
...
| [bpatrik/pigallery2](https://github.com/bpatrik/pigallery2) | 70 | `ng test && mocha --recursive test/backend/unit && mocha --recursive test/backend/integration  && mocha --recursive test/common/unit ` | 
...
| [longlho/ts-transform-css-modules](https://github.com/longlho/ts-transform-css-modules) | 50 | `rm -rf test/fixture/*.js && mocha --require ts-node/register --recursive  test/**/*.test.ts` | 
...
| [mstssk/sw2dts](https://github.com/mstssk/sw2dts) | 46 | `mocha test/*.js` | 
...
| [HdrHistogram/HdrHistogramJS](https://github.com/HdrHistogram/HdrHistogramJS) | 45 | `mocha --opts mocha.opts --watch` | 
...
| [lukeautry/ts-app](https://github.com/lukeautry/ts-app) | 44 | `cross-env TS_NODE_PROJECT=./api/tsconfig.json mocha -t 15000 -r ts-node/register "./api/**/*.spec.ts"` | 
...
| [ashleydavis/grademark](https://github.com/ashleydavis/grademark) | 42 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [googleapis/nodejs-spanner](https://github.com/googleapis/nodejs-spanner) | 41 | `nyc mocha build/test` | 
| [Unibeautify/vscode](https://github.com/Unibeautify/vscode) | 41 | `mocha` | 
| [mrmlnc/vscode-csscomb](https://github.com/mrmlnc/vscode-csscomb) | 41 | `mocha out/{,**/}*.spec.js -s 0` | 
| [googleapis/nodejs-spanner](https://github.com/googleapis/nodejs-spanner) | 41 | `nyc mocha build/test` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 31 | `ttsc --project tsconfig-test.json && mocha` | 
