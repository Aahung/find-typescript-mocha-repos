...
The list was updated at 01:55:59 01/08/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 66858 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16553 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11486 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10193 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7030 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6276 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5459 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4635 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4500 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4022 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3400 | `mocha --opts mocha.opts` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3007 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2881 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2856 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2824 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
...
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2235 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1885 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1804 | `mocha` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1402 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1313 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1278 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1270 | `mocha --opts mocha.opts` | 
...
| [cherow/cherow](https://github.com/cherow/cherow) | 1220 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha test/**/*.ts -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1206 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1099 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1053 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 994 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 937 | `mocha --opts test/mocha.opts` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 692 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 573 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 556 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 555 | `mocha test` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 553 | `mocha test/unit` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 510 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 464 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 452 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 449 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 404 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 315 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [alexcambose/motus](https://github.com/alexcambose/motus) | 297 | `cross-env mocha -r ts-node/register 'test/**/*.spec.ts'` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 203 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 194 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 153 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 126 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 121 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [cartant/ts-action](https://github.com/cartant/ts-action) | 95 | `yarn run lint && yarn run test:build && mocha ./build/**/*-spec.js` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 90 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [yakovlevga/brickyeditor](https://github.com/yakovlevga/brickyeditor) | 77 | `mocha --compilers js:babel-core/register --recursive` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 47 | `ttsc --project tsconfig-test.json && mocha` | 
...
| [pokemongo-dev-contrib/pokemongo-json-pokedex](https://github.com/pokemongo-dev-contrib/pokemongo-json-pokedex) | 36 | `mocha --recursive --compilers ts:ts-node/register,ts:tsconfig-paths/register test/*.ts test/**/*.ts` | 
...
| [ProjectOpenSea/opensea-js](https://github.com/ProjectOpenSea/opensea-js) | 35 | `./node_modules/.bin/mocha test/*.ts --require ts-node/register --timeout 10000` | 
