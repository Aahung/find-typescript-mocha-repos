...
The list was updated at 01:56:27 03/21/19 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 71787 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17551 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13630 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11809 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7279 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6686 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5854 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 5072 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts && npm run test:packages` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4871 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4863 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4242 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3457 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3371 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3127 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [retejs/rete](https://github.com/retejs/rete) | 2982 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2931 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2711 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts'` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2468 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2378 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2300 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1978 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1612 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1577 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1535 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
...
| [cherow/cherow](https://github.com/cherow/cherow) | 1464 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1382 | `mocha --opts mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 1369 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
...
| [google/gts](https://github.com/google/gts) | 1213 | `nyc mocha build/test` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1188 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
...
| [itchio/itch](https://github.com/itchio/itch) | 1038 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [youzan/zan-proxy](https://github.com/youzan/zan-proxy) | 1001 | `nyc mocha dist/**/*.spec.js` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 999 | `mocha bin/tests/test.js` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 707 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 682 | `mocha test/unit` | 
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 662 | `mocha "out/**/*.spec.js" -s 0` | 
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 651 | `mocha lib/test/unittest.js --check-leaks --color` | 
| [laoqiren/mlhelper](https://github.com/laoqiren/mlhelper) | 647 | `mocha --recursive` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 643 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 611 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 541 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 509 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 495 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 381 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
| [Polymer/prpl-server](https://github.com/Polymer/prpl-server) | 374 | `npm run build && mocha` | 
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 371 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 323 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
| [alibaba/pont](https://github.com/alibaba/pont) | 318 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 309 | `cd test && mocha -r ts-node/register *.ts` | 
| [mgechev/aspect.js](https://github.com/mgechev/aspect.js) | 304 | `tsc && mocha -R nyan ./dist/test/**/*.spec.js` | 
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 303 | `mocha lib/test` | 
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 296 | `mocha-webpack "src/**/*.ts"` | 
| [FinNLP/en-inflectors](https://github.com/FinNLP/en-inflectors) | 293 | `mocha` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 290 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [googleapis/nodejs-storage](https://github.com/googleapis/nodejs-storage) | 254 | `nyc mocha build/test` | 
...
| [emmanueltouzery/prelude-ts](https://github.com/emmanueltouzery/prelude-ts) | 194 | `rm tests/apidoc-*; tsc && node ./dist/tests/Comments.js && tsc && ./node_modules/mocha/bin/mocha --throw-deprecation --timeout 60000 ./dist/tests/*.js` | 
...
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 181 | `tsc && mocha` | 
...
| [DotJoshJohnson/vscode-xml](https://github.com/DotJoshJohnson/vscode-xml) | 142 | `npm run compile && mocha ./out/test/**/*.js` | 
...
| [AzureAD/azure-activedirectory-library-for-nodejs](https://github.com/AzureAD/azure-activedirectory-library-for-nodejs) | 134 | `npm run tsc && mocha -R spec --ui tdd test` | 
| [colyseus/colyseus.js](https://github.com/colyseus/colyseus.js) | 134 | `mocha test/*.ts --require ts-node/register` | 
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 133 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
...
| [tycho01/typical](https://github.com/tycho01/typical) | 121 | `tsc | tee tsc.log && mocha lib/**/*.test.js 2>&1 | sed 's/[0-9]\+)/×/g' | tee errors.log` | 
...
| [bpatrik/pigallery2](https://github.com/bpatrik/pigallery2) | 114 | `ng test && mocha --recursive test/backend/unit && mocha --recursive test/backend/integration  && mocha --recursive test/common/unit ` | 
...
| [ChainSafeSystems/lodestar](https://github.com/ChainSafeSystems/lodestar) | 105 | `nyc -r lcov -e .ts -x "*.test.ts" mocha -r ./.babel-register "tests/**/*.test.ts" && nyc report` | 
...
| [matthiasferch/tsm](https://github.com/matthiasferch/tsm) | 65 | `mocha -r ts-node/register test/**/*.spec.ts` | 
...
| [strongloop/loopback4-example-shopping](https://github.com/strongloop/loopback4-example-shopping) | 54 | `lb-mocha --allow-console-logs "dist/test"` | 
...
| [heremaps/harp.gl](https://github.com/heremaps/harp.gl) | 43 | `ts-mocha -r tsconfig-paths/register ./test/*.ts ./@here/*/test/*.ts` | 
