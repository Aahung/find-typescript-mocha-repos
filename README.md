...
The list was updated at 00:43:51 10/03/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 60823 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15081 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9094 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8439 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8095 | `mocha --opts mocha.opts && agadoo shared.js` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6809 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5768 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4831 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4409 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4011 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3288 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2747 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2584 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2406 | `mocha 'test/**/*.ts'` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2392 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2087 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2008 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [staltz/xstream](https://github.com/staltz/xstream) | 1662 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1264 | `nyc -x '' mocha` | 
...
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1099 | `mocha --opts mocha.opts` | 
...
| [itchio/itch](https://github.com/itchio/itch) | 918 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 905 | `mocha --opts test/mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 861 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 860 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 652 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 632 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 573 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
...
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 496 | `mocha test` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 492 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 401 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 395 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 385 | `cross-env NODE_ENV=test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 366 | `cross-env TS_NODE_COMPILER="ttypescript" mocha --opts mocha.opts` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 344 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 290 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
| [FinNLP/en-inflectors](https://github.com/FinNLP/en-inflectors) | 289 | `mocha` | 
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 287 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 210 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 205 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
...
| [pnp/office365-cli](https://github.com/pnp/office365-cli) | 160 | `nyc -r=lcov -r=text mocha "dist/**/*.spec.js"` | 
...
| [Goyoo/node-k8s-client](https://github.com/Goyoo/node-k8s-client) | 117 | `mocha test` | 
...
| [wonderful-panda/vue-tsx-support](https://github.com/wonderful-panda/vue-tsx-support) | 82 | `npm-run-all prettier tsc-test mocha` | 
...
| [googleapis/nodejs-bigquery](https://github.com/googleapis/nodejs-bigquery) | 61 | `mocha build/test` | 
