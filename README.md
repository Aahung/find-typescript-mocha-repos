...
The list was updated at 00:43:59 10/04/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 60914 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15094 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9118 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8466 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8098 | `mocha --opts mocha.opts && agadoo shared.js` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6810 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5771 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4839 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4413 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4013 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3289 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2747 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2585 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2407 | `mocha 'test/**/*.ts'` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2396 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
...
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2011 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1793 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [staltz/xstream](https://github.com/staltz/xstream) | 1664 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1329 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1268 | `nyc -x '' mocha` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1125 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [watson-developer-cloud/node-sdk](https://github.com/watson-developer-cloud/node-sdk) | 1117 | `nyc mocha test/unit/ test/integration/ && nyc report --reporter=html` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1100 | `mocha --opts mocha.opts` | 
...
| [google/clasp](https://github.com/google/clasp) | 863 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [coinbase/gdax-tt](https://github.com/coinbase/gdax-tt) | 718 | `yarn run lint && yarn run test:mocha` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 653 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 619 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 574 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 573 | `mocha "out/**/*.spec.js" -s 0` | 
| [emilioastarita/lyricfier](https://github.com/emilioastarita/lyricfier) | 536 | `mocha` | 
...
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 499 | `mocha test` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 493 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 442 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 396 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 388 | `cross-env NODE_ENV=test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
...
| [felixfbecker/vscode-php-debug](https://github.com/felixfbecker/vscode-php-debug) | 376 | `mocha out/test --timeout 20000 --slow 1000 --retries 4` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 347 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 226 | `mocha` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 211 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 182 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 162 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
...
| [microsoftgraph/msgraph-sdk-javascript](https://github.com/microsoftgraph/msgraph-sdk-javascript) | 153 | `mocha lib/spec/core` | 
...
| [hydux/hydux](https://github.com/hydux/hydux) | 128 | `npm run mocha -- "src/test/unit/*.test.ts"` | 
...
| [Microsoft/monaco-languages](https://github.com/Microsoft/monaco-languages) | 104 | `mocha` | 
...
| [dsherret/ts-nameof](https://github.com/dsherret/ts-nameof) | 78 | `npm run --silent copy-test-files && nyc --reporter=lcov mocha --opts mocha.opts` | 
...
| [googleapis/nodejs-bigquery](https://github.com/googleapis/nodejs-bigquery) | 62 | `mocha build/test` | 
...
| [Azure/azure-cosmos-js](https://github.com/Azure/azure-cosmos-js) | 53 | `mocha -r ./src/test/common/setup.ts ./lib/test/ --recursive --timeout 100000 -i -g .*ignore.js` | 
| [akoenig/gulp-svg2png](https://github.com/akoenig/gulp-svg2png) | 53 | `npm run build && npm run mocha` | 
| [cartant/rxjs-etc](https://github.com/cartant/rxjs-etc) | 53 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 37 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [sourcegraph/sourcegraph-extension-api](https://github.com/sourcegraph/sourcegraph-extension-api) | 34 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --require ts-node/register --require source-map-support/register --opts mocha.opts` | 
