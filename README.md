...
The list was updated at 00:43:54 09/13/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 59154 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 14755 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 8577 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8132 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6730 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5517 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4710 | `npm-run-all mocha lint` | 
| [Microsoft/sqlopsstudio](https://github.com/Microsoft/sqlopsstudio) | 4301 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 3925 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3228 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2726 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2484 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2399 | `mocha 'test/**/*.ts'` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2333 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 1983 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 1973 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1708 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1646 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1307 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1233 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1217 | `nyc -x '' mocha` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1115 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [watson-developer-cloud/node-sdk](https://github.com/watson-developer-cloud/node-sdk) | 1106 | `nyc mocha test/unit/ test/integration/ && nyc report --reporter=html` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1070 | `nyc --reporter=html --reporter=text mocha` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1048 | `mocha --opts mocha.opts` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 976 | `tsc -p ./ && mocha` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 811 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [google/clasp](https://github.com/google/clasp) | 758 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 744 | `mocha bin/tests/test.js` | 
...
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 666 | `mocha` | 
| [laoqiren/mlhelper](https://github.com/laoqiren/mlhelper) | 641 | `mocha --recursive` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 638 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 633 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 620 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [SierraSoftworks/Iridium](https://github.com/SierraSoftworks/Iridium) | 529 | `mocha --opts test/mocha.opts dist/test` | 
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 522 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 392 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
| [surf-build/surf](https://github.com/surf-build/surf) | 387 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 378 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 344 | `cross-env TS_NODE_COMPILER="ttypescript" mocha --opts mocha.opts` | 
| [Polymer/prpl-server](https://github.com/Polymer/prpl-server) | 336 | `npm run build && mocha` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 329 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 284 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 279 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 258 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
...
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 252 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 252 | `mocha lib/test` | 
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 251 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 251 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 215 | `mocha` | 
| [renke/import-sort](https://github.com/renke/import-sort) | 211 | `mocha --require ts-node/register --recursive "packages/*/test/**/*.ts"` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 203 | `mocha test` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 186 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 172 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
...
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 156 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
| [pnp/office365-cli](https://github.com/pnp/office365-cli) | 155 | `nyc -r=lcov -r=text mocha "dist/**/*.spec.js"` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 146 | `mocha-webpack "src/**/*.ts"` | 
...
| [Talento90/typescript-node](https://github.com/Talento90/typescript-node) | 132 | `npm run build && mocha --exit --recursive dist/test/unit` | 
...
| [nozer/quill-delta-to-html](https://github.com/nozer/quill-delta-to-html) | 118 | `./node_modules/nyc/bin/nyc.js ./node_modules/mocha/bin/mocha --compilers ts:ts-node/register -b "./test/**/*.ts"  ` | 
...
| [Microsoft/monaco-languages](https://github.com/Microsoft/monaco-languages) | 100 | `mocha` | 
...
| [bradymholt/cRonstrue](https://github.com/bradymholt/cRonstrue) | 95 | `npx mocha --reporter spec --compilers ts:ts-node/register` | 
...
| [Enterprise-JS/vscode-ts-node-debugging](https://github.com/Enterprise-JS/vscode-ts-node-debugging) | 92 | `npm run mocha --recursive ./src/**/__tests__/*` | 
...
| [redhat-developer/yaml-language-server](https://github.com/redhat-developer/yaml-language-server) | 84 | `mocha --require ts-node/register --ui tdd ./test/*.test.ts` | 
| [shlomiassaf/ngc-webpack](https://github.com/shlomiassaf/ngc-webpack) | 84 | `npm run build-test && ./node_modules/.bin/mocha dist/test/*.spec.js --recursive` | 
| [redhat-developer/yaml-language-server](https://github.com/redhat-developer/yaml-language-server) | 84 | `mocha --require ts-node/register --ui tdd ./test/*.test.ts` | 
...
| [MichaelSolati/geofirestore](https://github.com/MichaelSolati/geofirestore) | 80 | `nyc --reporter=html --reporter=text mocha` | 
| [jvilk/MakeTypes](https://github.com/jvilk/MakeTypes) | 79 | `npm-run-all --serial prepublish generate:test build:test mocha` | 
...
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 70 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
...
| [troch/path-parser](https://github.com/troch/path-parser) | 61 | `mocha -r ts-node/register 'test/main.js'` | 
...
| [wonderful-panda/vue-tsx-support](https://github.com/wonderful-panda/vue-tsx-support) | 59 | `npm-run-all prettier tsc-test mocha` | 
...
| [Microsoft/vscode-node-debug2](https://github.com/Microsoft/vscode-node-debug2) | 47 | `mocha --timeout 20000 -s 2000 -u tdd --colors --reporter node_modules/vscode-chrome-debug-core-testsupport/out/loggingReporter.js ./out/test/` | 
...
| [w11k/ngx-componentdestroyed](https://github.com/w11k/ngx-componentdestroyed) | 37 | `mocha --opts spec/mocha.opts src/**/*test.ts` | 
...
| [AlCalzone/node-tradfri-client](https://github.com/AlCalzone/node-tradfri-client) | 36 | `node_modules/.bin/mocha --watch` | 
...
| [duffman/tspath](https://github.com/duffman/tspath) | 35 | `mocha -r ts-node/register test/**.*/test.ts` | 
...
| [microsoftgraph/msgraph-typescript-typings](https://github.com/microsoftgraph/msgraph-typescript-typings) | 29 | `tsc && mocha spec/` | 
...
| [ClickerMonkey/vuex-router-actions](https://github.com/ClickerMonkey/vuex-router-actions) | 25 | `mocha -r ts-node/register tests/**/*.ts` | 
