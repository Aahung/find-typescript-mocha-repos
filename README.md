...
The list was updated at 01:55:34 02/09/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 68811 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16982 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12438 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10966 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7156 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6456 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5638 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4730 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4695 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4680 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3771 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3423 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3082 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2955 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2887 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2576 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2445 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2297 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2213 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1934 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1513 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1419 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1371 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1318 | `mocha --opts mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1278 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [google/clasp](https://github.com/google/clasp) | 1251 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [itchio/itch](https://github.com/itchio/itch) | 1020 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 623 | `mocha test/unit` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 588 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 587 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [pgilad/leasot](https://github.com/pgilad/leasot) | 582 | `mocha --require ts-node/register -R spec './tests/*.ts'` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 502 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
| [benjamn/ast-types](https://github.com/benjamn/ast-types) | 500 | `npm run gen && npm run build && npm run mocha` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 500 | `tsc && mocha test && yarn lint` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 489 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 486 | `npm run mocha` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 485 | `npm run lint && npm run mocha` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 483 | `cd test && mocha -r ts-node/register *.ts` | 
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 477 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
| [43081j/rar.js](https://github.com/43081j/rar.js) | 462 | `npm run build && mocha` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 462 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 314 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 262 | `mocha-webpack "src/**/*.ts"` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 257 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 226 | `nyc mocha` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 193 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 155 | `tsc && mocha` | 
...
| [nwtgck/piping-server](https://github.com/nwtgck/piping-server) | 150 | `mocha --require ts-node/register --timeout 10000 test/**/*.ts` | 
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 146 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [atomist/sdm](https://github.com/atomist/sdm) | 139 | `mocha --require espower-typescript/guess "test/**/*.test.ts"` | 
...
| [nomiclabs/buidler](https://github.com/nomiclabs/buidler) | 124 | `nyc mocha` | 
...
| [ynab/ynab-sdk-js](https://github.com/ynab/ynab-sdk-js) | 95 | `TS_NODE_PROJECT=./test/tsconfig.json npx mocha --reporter spec --require ts-node/register/type-check 'test/**/*.ts'` | 
...
| [argoproj/argo-ci](https://github.com/argoproj/argo-ci) | 94 | `TS_NODE_PROJECT=./src/tests/tsconfig.json mocha --require ts-node/register ./src/tests/**/*spec.ts` | 
...
| [balassy/aws-lambda-typescript](https://github.com/balassy/aws-lambda-typescript) | 91 | `nyc mocha` | 
...
| [mceachen/exiftool-vendored.js](https://github.com/mceachen/exiftool-vendored.js) | 64 | `nyc mocha --opts .mocha.opts` | 
