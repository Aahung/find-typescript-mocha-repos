...
The list was updated at 01:55:23 01/13/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 67223 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16627 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11625 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10297 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7039 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6298 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5501 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4650 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4533 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4096 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3406 | `mocha --opts mocha.opts` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3216 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2924 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2865 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2844 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2481 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
...
| [benjamn/recast](https://github.com/benjamn/recast) | 2174 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1889 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [staltz/xstream](https://github.com/staltz/xstream) | 1765 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1405 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1332 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1288 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1275 | `mocha --opts mocha.opts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1233 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1229 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [google/clasp](https://github.com/google/clasp) | 1154 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1101 | `nyc --reporter=html --reporter=text mocha` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 894 | `mocha bin/tests/test.js` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 698 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 687 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 575 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 568 | `nyc mocha build/test` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 563 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 617 | `mocha "out/**/*.spec.js" -s 0` | 
| [jaysoo/todomvc-redux-react-typescript](https://github.com/jaysoo/todomvc-redux-react-typescript) | 610 | `tsc && mocha --require test-setup --recursive ./dist/**/__spec__/**/*-spec.js` | 
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 604 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 516 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 484 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
...
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 457 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 457 | `cd test && mocha -r ts-node/register *.ts` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 454 | `tsc && mocha test && yarn lint` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 308 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 300 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 300 | `mocha` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 243 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 238 | `mocha-webpack "src/**/*.ts"` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 212 | `cd test && mocha -r ts-node/register *.ts` | 
| [stardustjs/stardust-core](https://github.com/stardustjs/stardust-core) | 211 | `mocha test` | 
| [googleapis/nodejs-storage](https://github.com/googleapis/nodejs-storage) | 211 | `nyc mocha build/test` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 199 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
...
| [microsoftgraph/msgraph-sdk-javascript](https://github.com/microsoftgraph/msgraph-sdk-javascript) | 186 | `mocha lib/spec/core` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 174 | `nyc mocha` | 
...
| [nozer/quill-delta-to-html](https://github.com/nozer/quill-delta-to-html) | 147 | `./node_modules/nyc/bin/nyc.js ./node_modules/mocha/bin/mocha --compilers ts:ts-node/register -b "./test/**/*.ts"  ` | 
...
| [Soluto/graphql-to-mongodb](https://github.com/Soluto/graphql-to-mongodb) | 127 | `ts-mocha tests/**/*.spec.ts` | 
...
| [arfedulov/semantic-ui-calendar-react](https://github.com/arfedulov/semantic-ui-calendar-react) | 121 | `npx cross-env TS_NODE_COMPILER_OPTIONS="{""allowJs"":true}" npx mocha -r ts-node/register ./test/setup.js ./test/**/*.{js,jsx,ts,tsx}` | 
...
| [gcanti/prop-types-ts](https://github.com/gcanti/prop-types-ts) | 95 | `npm run lint && npm run prettier && npm run mocha` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 93 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [rpgeeganage/async-ray](https://github.com/rpgeeganage/async-ray) | 74 | `nyc mocha` | 
...
| [realm/realm-studio](https://github.com/realm/realm-studio) | 46 | `mocha-webpack --opts=configs/mocha-webpack.opts` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 44 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
...
| [olivierlsc/swagger-express-ts](https://github.com/olivierlsc/swagger-express-ts) | 35 | `echo "Testing..." && npm run build && nyc mocha` | 
