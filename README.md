...
The list was updated at 01:55:29 11/28/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 64701 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15931 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10387 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9377 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8539 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6943 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6062 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5192 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4528 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4263 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3690 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3360 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2809 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2638 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2543 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2424 | `mocha 'test/**/*.ts'` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2362 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2156 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1850 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1834 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1792 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1727 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1629 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 20000 --max-parallel=1 --exit` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1395 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1346 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1319 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1190 | `mocha --opts mocha.opts` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1180 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1173 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1139 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1101 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1089 | `nyc --reporter=html --reporter=text mocha` | 
| [google/clasp](https://github.com/google/clasp) | 1043 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1026 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 951 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 925 | `mocha --opts test/mocha.opts` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 887 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 844 | `mocha bin/tests/test.js` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 709 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 698 | `mocha` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 649 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [laoqiren/mlhelper](https://github.com/laoqiren/mlhelper) | 648 | `mocha --recursive` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 646 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 574 | `mocha lib/test/unittest.js --check-leaks --color` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 552 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [emilioastarita/lyricfier](https://github.com/emilioastarita/lyricfier) | 550 | `mocha` | 
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 543 | `mocha test` | 
| [SierraSoftworks/Iridium](https://github.com/SierraSoftworks/Iridium) | 536 | `mocha --opts test/mocha.opts dist/test` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 530 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 517 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 508 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 454 | `mocha --opts mocha.opts` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 450 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 447 | `cross-env NODE_ENV=test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 437 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 435 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 426 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 397 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 389 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 312 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 302 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 299 | `tsc && mocha test && yarn lint` | 
| [FinNLP/en-inflectors](https://github.com/FinNLP/en-inflectors) | 289 | `mocha` | 
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 286 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 278 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 272 | `mocha lib/test` | 
...
| [worr/node-imdb-api](https://github.com/worr/node-imdb-api) | 268 | `nyc --require ts-node/register --reporter=lcov node_modules/mocha/bin/mocha test/*.ts` | 
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 267 | `mocha` | 
...
| [FormidableLabs/inspectpack](https://github.com/FormidableLabs/inspectpack) | 242 | `mocha "test/**/*.spec.ts"` | 
...
| [ClickSimply/Nano-SQL](https://github.com/ClickSimply/Nano-SQL) | 214 | `mocha -r ts-node/register tests/index.ts` | 
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 211 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 209 | `mocha test/unit` | 
| [stardustjs/stardust-core](https://github.com/stardustjs/stardust-core) | 208 | `mocha test` | 
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 205 | `mocha-webpack "src/**/*.ts"` | 
...
| [stardustjs/stardust-core](https://github.com/stardustjs/stardust-core) | 208 | `mocha test` | 
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 205 | `mocha-webpack "src/**/*.ts"` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 203 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [jedmao/eclint](https://github.com/jedmao/eclint) | 197 | `nyc npm run mocha -- --reporter lcov --reporter spec` | 
...
| [thiagobustamante/typescript-rest](https://github.com/thiagobustamante/typescript-rest) | 193 | `cross-env NODE_ENV=test mocha` | 
...
| [funkia/hareactive](https://github.com/funkia/hareactive) | 179 | `nyc mocha --recursive test/**/*.ts` | 
...
| [Chinachu/Mirakurun](https://github.com/Chinachu/Mirakurun) | 157 | `mocha --exit test/*.spec.js` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 152 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [nozer/quill-delta-to-html](https://github.com/nozer/quill-delta-to-html) | 131 | `./node_modules/nyc/bin/nyc.js ./node_modules/mocha/bin/mocha --compilers ts:ts-node/register -b "./test/**/*.ts"  ` | 
...
| [Microsoft/vscode-vsce](https://github.com/Microsoft/vscode-vsce) | 128 | `gulp compile && mocha` | 
...
| [Soluto/graphql-to-mongodb](https://github.com/Soluto/graphql-to-mongodb) | 118 | `ts-mocha tests/**/*.spec.ts` | 
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 118 | `nyc --reporter=html --reporter=text mocha` | 
...
| [indutny/llhttp](https://github.com/indutny/llhttp) | 113 | `npm run mocha && npm run lint` | 
...
| [moodysalem/react-tournament-bracket](https://github.com/moodysalem/react-tournament-bracket) | 111 | `mocha --require ts-node/register src/**/*.test.tsx` | 
| [mgechev/ngresizable](https://github.com/mgechev/ngresizable) | 110 | `mocha --require ts-node/register test/**/*.spec.ts --recursive` | 
| [bradymholt/cRonstrue](https://github.com/bradymholt/cRonstrue) | 109 | `npx mocha --reporter spec --compilers ts:ts-node/register` | 
...
| [nomiclabs/buidler](https://github.com/nomiclabs/buidler) | 106 | `nyc mocha` | 
...
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 105 | `mocha` | 
...
| [atomist/sdm](https://github.com/atomist/sdm) | 104 | `mocha --require espower-typescript/guess "test/**/*.test.ts"` | 
| [palantir/typesettable](https://github.com/palantir/typesettable) | 103 | `npm-run-all build test:mocha test:coverage lint` | 
| [JoshGlazebrook/socks](https://github.com/JoshGlazebrook/socks) | 103 | `NODE_ENV=test mocha --recursive --compilers ts:ts-node/register test/**/*.ts` | 
...
| [philcockfield/storybook-host](https://github.com/philcockfield/storybook-host) | 98 | `./node_modules/mocha/bin/mocha --require ts-node/register --watch-extensions ts,tsx 'src/**/*.test.ts{,x}'` | 
...
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 95 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
...
| [vladotesanovic/typescript-mongoose-express](https://github.com/vladotesanovic/typescript-mongoose-express) | 87 | `mocha` | 
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 86 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 81 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
...
| [vrimar/construct-ui](https://github.com/vrimar/construct-ui) | 73 | `cross-env TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [ui-jar/ui-jar](https://github.com/ui-jar/ui-jar) | 72 | `tsc && mocha "dist/test/**/*.js" ` | 
...
| [Microsoft/vscode-mock-debug](https://github.com/Microsoft/vscode-mock-debug) | 67 | `mocha -u tdd ./out/tests/` | 
| [theGlenn/apollo-prophecy](https://github.com/theGlenn/apollo-prophecy) | 67 | `rm -rf coverage && nyc mocha --opts mocha.opts` | 
| [Cody2333/koa-swagger-decorator](https://github.com/Cody2333/koa-swagger-decorator) | 67 | `./node_modules/mocha/bin/mocha -r babel-core/register test/**/*.js --bail -t 2000000` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 58 | `mocha` | 
| [matthiasferch/tsm](https://github.com/matthiasferch/tsm) | 57 | `mocha -r ts-node/register test/**/*.spec.ts` | 
| [alex-okrushko/backoff-rxjs](https://github.com/alex-okrushko/backoff-rxjs) | 57 | `mocha --opts spec/mocha.opts spec/**/*-spec.ts` | 
...
| [firebase/firebase-functions-test](https://github.com/firebase/firebase-functions-test) | 55 | `mocha .tmp/spec/index.spec.js` | 
...
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 53 | `nyc --reporter=html mocha --timeout 0 --require ts-node/register --require source-map-support/register --recursive src/test.ts` | 
...
| [Microsoft/node-jsonc-parser](https://github.com/Microsoft/node-jsonc-parser) | 47 | `npm run compile && mocha` | 
...
| [mstssk/sw2dts](https://github.com/mstssk/sw2dts) | 44 | `mocha test/*.js` | 
...
| [brunolm/ts-react-redux-startup](https://github.com/brunolm/ts-react-redux-startup) | 42 | `npm run lint && mocha dist/spec` | 
...
| [gcanti/io-ts-codegen](https://github.com/gcanti/io-ts-codegen) | 41 | `npm run prettier && npm run lint && npm run mocha` | 
...
| [Unibeautify/vscode](https://github.com/Unibeautify/vscode) | 40 | `mocha` | 
...
| [lukeautry/ts-app](https://github.com/lukeautry/ts-app) | 38 | `cross-env TS_NODE_PROJECT=./api/tsconfig.json mocha -t 15000 -r ts-node/register "./api/**/*.spec.ts"` | 
...
| [RocketChat/Rocket.Chat.js.SDK](https://github.com/RocketChat/Rocket.Chat.js.SDK) | 29 | `nyc mocha './src/lib/**/*.spec.ts'` | 
| [bespoken/virtual-device-sdk](https://github.com/bespoken/virtual-device-sdk) | 29 | `nyc mocha lib/test/*Test.js` | 
| [Pravez/ReImproveJS](https://github.com/Pravez/ReImproveJS) | 29 | `mocha --reporter spec --compilers ts:ts-node/register 'test/*.spec.ts' --timeout 120000` | 
