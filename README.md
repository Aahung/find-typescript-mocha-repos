...
The list was updated at 01:55:29 10/22/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 62429 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15345 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9481 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8771 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8168 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6865 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5893 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4917 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4460 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4098 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3317 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2764 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2701 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2475 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2411 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2239 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2052 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1815 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1789 | `mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1770 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1293 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1288 | `nyc -x '' mocha` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1232 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1224 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [funkia/list](https://github.com/funkia/list) | 1187 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1137 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [watson-developer-cloud/node-sdk](https://github.com/watson-developer-cloud/node-sdk) | 1131 | `nyc mocha test/unit/ test/integration/ && nyc report --reporter=html` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1129 | `mocha --opts mocha.opts` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1076 | `nyc --reporter=html --reporter=text mocha` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1068 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 977 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [itchio/itch](https://github.com/itchio/itch) | 933 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 911 | `mocha --opts test/mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 903 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 867 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 798 | `mocha bin/tests/test.js` | 
...
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 675 | `mocha` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 671 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 640 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 630 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 627 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 554 | `mocha lib/test/unittest.js --check-leaks --color` | 
| [emilioastarita/lyricfier](https://github.com/emilioastarita/lyricfier) | 545 | `mocha` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 535 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [SierraSoftworks/Iridium](https://github.com/SierraSoftworks/Iridium) | 534 | `mocha --opts test/mocha.opts dist/test` | 
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 533 | `mocha test` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 462 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 433 | `mocha --opts mocha.opts` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 424 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 421 | `npm run mocha` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 394 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 360 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 298 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 297 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 230 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
| [duniter/duniter](https://github.com/duniter/duniter) | 225 | `nyc --reporter html mocha` | 
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 220 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
...
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 212 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
...
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 190 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 164 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 150 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 113 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [moodysalem/react-tournament-bracket](https://github.com/moodysalem/react-tournament-bracket) | 108 | `mocha --require ts-node/register src/**/*.test.tsx` | 
...
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 99 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [structured-log/structured-log](https://github.com/structured-log/structured-log) | 92 | `mocha --compilers ts:ts-node/register -r src/polyfills/objectAssign.js test/**/*.spec.ts` | 
| [any-json/any-json](https://github.com/any-json/any-json) | 92 | `npm run build && cp -Rf test/fixtures out/test/ && mocha --ui tdd out/test/` | 
| [Kode/KodeStudio](https://github.com/Kode/KodeStudio) | 92 | `mocha` | 
| [structured-log/structured-log](https://github.com/structured-log/structured-log) | 92 | `mocha --compilers ts:ts-node/register -r src/polyfills/objectAssign.js test/**/*.spec.ts` | 
...
| [mtmr0x/nucleo](https://github.com/mtmr0x/nucleo) | 38 | `mocha -r ts-node/register` | 
...
| [vrudikov/typescript-rest-boilerplate](https://github.com/vrudikov/typescript-rest-boilerplate) | 28 | `cross-env NODE_ENV=test mocha` | 
