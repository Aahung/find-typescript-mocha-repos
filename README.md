...
The list was updated at 01:55:20 12/25/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 66203 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16363 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11211 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9887 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6997 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6223 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5342 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4607 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4421 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3957 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3383 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2835 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2776 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2771 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1870 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1401 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1371 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1249 | `mocha --opts mocha.opts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1239 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
...
| [cherow/cherow](https://github.com/cherow/cherow) | 1193 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha test/**/*.ts -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [google/clasp](https://github.com/google/clasp) | 1112 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1094 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1043 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 971 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 553 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 506 | `mocha test/unit` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 491 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 471 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 434 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 301 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [alexcambose/motus](https://github.com/alexcambose/motus) | 287 | `cross-env mocha -r ts-node/register 'test/**/*.spec.ts'` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 232 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [nodejs/llhttp](https://github.com/nodejs/llhttp) | 157 | `npm run mocha && npm run lint` | 
...
| [Commit451/skyhook](https://github.com/Commit451/skyhook) | 142 | `mocha -r ts-node/register test/*.ts` | 
...
| [MariusAlch/json-to-ts](https://github.com/MariusAlch/json-to-ts) | 71 | `npm run build && mocha ./test/js-integration/index.js && mocha ./build/test` | 
...
| [rpgeeganage/async-ray](https://github.com/rpgeeganage/async-ray) | 59 | `nyc mocha` | 
...
| [soraping/koa-ts](https://github.com/soraping/koa-ts) | 41 | `mocha --recursive` | 
