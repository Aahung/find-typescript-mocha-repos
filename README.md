...
The list was updated at 00:43:53 09/25/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 59876 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 14933 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 8911 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8325 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6766 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5687 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4776 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4366 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 3974 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3262 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2738 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2555 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2405 | `mocha 'test/**/*.ts'` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2370 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2041 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 1996 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1788 | `mocha` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1784 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1238 | `nyc -x '' mocha` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1232 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1184 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1068 | `mocha --opts mocha.opts` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 841 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [google/clasp](https://github.com/google/clasp) | 824 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 769 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 616 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 611 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 549 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
...
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 452 | `mocha --opts mocha.opts` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 351 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 295 | `mocha test` | 
...
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 268 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
...
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 183 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
...
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 153 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [tomastrajan/ngx-model](https://github.com/tomastrajan/ngx-model) | 125 | `npm run clean && tslint *.ts && npm run format:ci && mocha ./lib/model.test.ts --require ts-node/register` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 99 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
...
| [Azure/azure-cosmos-js](https://github.com/Azure/azure-cosmos-js) | 50 | `mocha -r ./src/test/common/setup.ts ./lib/test/ --recursive --timeout 100000 -i -g .*ignore.js` | 
...
| [rauschma/stringio](https://github.com/rauschma/stringio) | 42 | `mocha --ui qunit` | 
