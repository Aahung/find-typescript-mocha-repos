...
The list was updated at 01:55:14 10/26/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 62779 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15419 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9603 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8851 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8196 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6881 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5933 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4963 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4465 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4117 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3323 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2768 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2728 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2487 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2409 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2276 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1820 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1389 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1293 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1235 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1142 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1132 | `mocha --opts mocha.opts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1082 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1032 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1001 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 931 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 914 | `mocha --opts test/mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 913 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 804 | `mocha bin/tests/test.js` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 557 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 511 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 465 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 224 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
| [RisingStack/node-typescript-starter](https://github.com/RisingStack/node-typescript-starter) | 219 | `tsc && mocha dist/**/*.spec.js` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 183 | `mocha-webpack "src/**/*.ts"` | 
...
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 159 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [Soluto/graphql-to-mongodb](https://github.com/Soluto/graphql-to-mongodb) | 109 | `ts-mocha tests/**/*.spec.ts` | 
...
| [sourcegraph/browser-extensions](https://github.com/sourcegraph/browser-extensions) | 43 | `mocha --require ts-node/register --watch --watch-extensions ts './src/**/*.test.ts?(x)'` | 
...
| [wearetheledger/fabric-node-chaincode-utils](https://github.com/wearetheledger/fabric-node-chaincode-utils) | 42 | `mocha -r ts-node/register test/**/*.spec.ts --reporter spec` | 
