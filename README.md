...
The list was updated at 01:56:02 02/14/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 69182 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17042 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12602 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11079 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7169 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6489 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5665 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4792 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4711 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4704 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3844 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3432 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3107 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2973 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2892 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2598 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2446 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2310 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2221 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1938 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1921 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1527 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1472 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1459 | `nyc -x '' mocha` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1441 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1385 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1326 | `mocha --opts mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1285 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [google/clasp](https://github.com/google/clasp) | 1271 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [funkia/list](https://github.com/funkia/list) | 1243 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1241 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1086 | `tsc -p ./ && mocha` | 
...
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 854 | `npm run mocha` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 743 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 709 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 684 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 509 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
...
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 482 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 466 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [apollographql/persistgraphql](https://github.com/apollographql/persistgraphql) | 346 | `mocha --reporter spec --full-trace lib/test/tests.js` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 321 | `mocha` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 267 | `mocha-webpack "src/**/*.ts"` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 263 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 255 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
| [nwtgck/piping-server](https://github.com/nwtgck/piping-server) | 255 | `mocha --require ts-node/register --timeout 10000 test/**/*.ts` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 225 | `nyc mocha test/**/*.test.ts --exit` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 152 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [mysticatea/vue-eslint-parser](https://github.com/mysticatea/vue-eslint-parser) | 107 | `nyc npm run _mocha` | 
...
| [giantmachines/redux-websocket](https://github.com/giantmachines/redux-websocket) | 90 | `mocha --compilers js:babel-core/register` | 
| [googleapis/nodejs-bigquery](https://github.com/googleapis/nodejs-bigquery) | 89 | `nyc mocha build/test` | 
| [wbhob/nest-middlewares](https://github.com/wbhob/nest-middlewares) | 89 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
...
| [ui-jar/ui-jar](https://github.com/ui-jar/ui-jar) | 82 | `tsc && mocha "dist/test/**/*.js" ` | 
...
| [MariusAlch/json-to-ts](https://github.com/MariusAlch/json-to-ts) | 78 | `npm run build && mocha ./test/js-integration/index.js && mocha ./build/test` | 
...
| [lukeautry/ts-app](https://github.com/lukeautry/ts-app) | 62 | `cross-env TS_NODE_PROJECT=./api/tsconfig.json mocha -t 15000 -r ts-node/register "./api/**/*.spec.ts"` | 
...
| [w11k/ngx-componentdestroyed](https://github.com/w11k/ngx-componentdestroyed) | 57 | `mocha --opts spec/mocha.opts src/**/*test.ts` | 
...
| [angular-extensions/model](https://github.com/angular-extensions/model) | 53 | `npm run lint && npm run format:test && nyc mocha {lib,schematics}/**/*.test.ts --require ts-node/register --require source-map-support/register` | 
...
| [Lusito/forget-me-not](https://github.com/Lusito/forget-me-not) | 47 | `nyc mocha --require source-map-support/register --require ts-node/register test/**/*.ts` | 
...
| [strongloop/loopback4-example-shopping](https://github.com/strongloop/loopback4-example-shopping) | 43 | `lb-mocha --allow-console-logs "dist/test"` | 
...
| [eclipse/sprotty](https://github.com/eclipse/sprotty) | 40 | `jenkins-mocha --opts ./configs/mocha.opts "./src/**/*.spec.?(ts|tsx)"` | 
