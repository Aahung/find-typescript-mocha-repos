...
The list was updated at 01:55:36 01/12/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 67166 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16616 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11610 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10290 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7038 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6292 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5500 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4649 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4529 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4049 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3407 | `mocha --opts mocha.opts` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3210 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2921 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2863 | `mocha` | 
...
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2480 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2437 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2242 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2171 | `npm run tsc && npm run mocha` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1881 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1806 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1764 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1325 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1290 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1274 | `mocha --opts mocha.opts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1233 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1227 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [google/clasp](https://github.com/google/clasp) | 1151 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1058 | `tsc -p ./ && mocha` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 755 | `mocha --require ts-node/register` | 
| [coinbase/gdax-tt](https://github.com/coinbase/gdax-tt) | 735 | `yarn run lint && yarn run test:mocha` | 
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 718 | `mocha` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 713 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 615 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 572 | `mocha test/unit` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 515 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 454 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
...
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 147 | `tsc && mocha` | 
...
| [MariusAlch/json-to-ts](https://github.com/MariusAlch/json-to-ts) | 75 | `npm run build && mocha ./test/js-integration/index.js && mocha ./build/test` | 
...
| [rpgeeganage/async-ray](https://github.com/rpgeeganage/async-ray) | 71 | `nyc mocha` | 
...
| [realm/realm-studio](https://github.com/realm/realm-studio) | 45 | `mocha-webpack --opts=configs/mocha-webpack.opts` | 
