...
The list was updated at 01:55:32 01/09/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 66971 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16567 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11515 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10227 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7034 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6283 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5471 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4638 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4514 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4026 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3399 | `mocha --opts mocha.opts` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3091 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2891 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2859 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2828 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2467 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2437 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2238 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1886 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1878 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1805 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1760 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1435 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1318 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1281 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1272 | `mocha --opts mocha.opts` | 
...
| [cherow/cherow](https://github.com/cherow/cherow) | 1221 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha test/**/*.ts -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1208 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [google/clasp](https://github.com/google/clasp) | 1141 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 574 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 571 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 565 | `nyc mocha build/test` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 558 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 550 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [pgilad/leasot](https://github.com/pgilad/leasot) | 527 | `mocha --require ts-node/register -R spec './tests/*.ts'` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 770 | `mocha test/backend` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 751 | `mocha --require ts-node/register` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 693 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 684 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 667 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 571 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 565 | `nyc mocha build/test` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 559 | `mocha test/unit` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 558 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 555 | `mocha test` | 
| [emilioastarita/lyricfier](https://github.com/emilioastarita/lyricfier) | 552 | `mocha` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 550 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [rill-js/rill](https://github.com/rill-js/rill) | 528 | `nyc --extension=.ts --include=src/**/*.ts --reporter=lcov --reporter=text-summary npm run mocha` | 
| [pgilad/leasot](https://github.com/pgilad/leasot) | 527 | `mocha --require ts-node/register -R spec './tests/*.ts'` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 512 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 479 | `mocha --opts mocha.opts` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 478 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 471 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 465 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 453 | `cd test && mocha -r ts-node/register *.ts` | 
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 451 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 450 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 447 | `tsc && mocha test && yarn lint` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 405 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [arangodb/arangojs](https://github.com/arangodb/arangojs) | 338 | `mocha --growl --reporter spec --require source-map-support/register --timeout 10000 lib/async/test` | 
...
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 316 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 297 | `mocha` | 
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 296 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 241 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
| [SpoonX/wetland](https://github.com/SpoonX/wetland) | 237 | `mocha dist/test/helper dist/test/unit/{*.spec.js,**/*.spec.js} --timeout 15000` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 237 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
| [liangzeng/cqrs](https://github.com/liangzeng/cqrs) | 235 | `tsc && mocha` | 
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 233 | `mocha-webpack "src/**/*.ts"` | 
...
| [googleapis/nodejs-storage](https://github.com/googleapis/nodejs-storage) | 209 | `nyc mocha build/test` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 206 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 195 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
...
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 146 | `tsc && mocha` | 
...
| [nozer/quill-delta-to-html](https://github.com/nozer/quill-delta-to-html) | 142 | `./node_modules/nyc/bin/nyc.js ./node_modules/mocha/bin/mocha --compilers ts:ts-node/register -b "./test/**/*.ts"  ` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 127 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [vrimar/construct-ui](https://github.com/vrimar/construct-ui) | 126 | `cross-env TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 125 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 117 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 117 | `mocha` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 91 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 91 | `nyc mocha test/**/*.test.ts` | 
...
| [argoproj/argo-ci](https://github.com/argoproj/argo-ci) | 85 | `TS_NODE_PROJECT=./src/tests/tsconfig.json mocha --require ts-node/register ./src/tests/**/*spec.ts` | 
...
| [metadevpro/openapi3-ts](https://github.com/metadevpro/openapi3-ts) | 72 | `mocha --recursive --compilers ts:ts-node/register --require source-map-support/register "src/**/*.spec.ts"` | 
...
| [bespoken/virtual-alexa](https://github.com/bespoken/virtual-alexa) | 71 | `nyc mocha lib/**/*Test.js` | 
...
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 69 | `nyc --reporter=html mocha --timeout 0 --require ts-node/register --require source-map-support/register --recursive src/test.ts && lua tests/spec.lua` | 
...
| [pact-foundation/pact-node](https://github.com/pact-foundation/pact-node) | 65 | `cross-env LOGLEVEL=debug PACT_DO_NOT_TRACK=true mocha -r ts-node/register -R mocha-unfunk-reporter -t 15000 -s 5000 -b --check-leaks --exit "{src,test,bin,standalone}/**/*.spec.ts"` | 
...
| [deerawan/vscode-dash](https://github.com/deerawan/vscode-dash) | 61 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec --ui tdd ./out/test/extension.test.js` | 
...
| [DhyanaChina/koa2-typescript-guide](https://github.com/DhyanaChina/koa2-typescript-guide) | 57 | `mocha` | 
...
| [duffman/tspath](https://github.com/duffman/tspath) | 56 | `mocha -r ts-node/register test/**.*/test.ts` | 
...
| [Microsoft/node-jsonc-parser](https://github.com/Microsoft/node-jsonc-parser) | 53 | `npm run compile && mocha` | 
...
| [w11k/ngx-componentdestroyed](https://github.com/w11k/ngx-componentdestroyed) | 51 | `mocha --opts spec/mocha.opts src/**/*test.ts` | 
...
| [Microsoft/vscode-json-languageservice](https://github.com/Microsoft/vscode-json-languageservice) | 48 | `npm run compile && mocha && npm run lint` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 43 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
...
| [shogogg/ts-option](https://github.com/shogogg/ts-option) | 33 | `mocha --reporter spec --compilers ts:espower-typescript/guess` | 
...
| [laurence-myers/tsdv-joi](https://github.com/laurence-myers/tsdv-joi) | 32 | `mocha --require source-map-support/register "dist/test/**/*.js"` | 
...
| [olivierlsc/swagger-express-ts](https://github.com/olivierlsc/swagger-express-ts) | 32 | `echo "Testing..." && npm run build && nyc mocha` | 