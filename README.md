...
The list was updated at 01:55:26 12/24/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 66172 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16354 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11188 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9877 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6996 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6219 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5333 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4606 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4411 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3954 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
...
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2773 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2765 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2431 | `mocha 'test/**/*.ts'` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2422 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2209 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1868 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1400 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1370 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1276 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1248 | `mocha --opts mocha.opts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1235 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1193 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1190 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha test/**/*.ts -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [google/clasp](https://github.com/google/clasp) | 1111 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1093 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1042 | `tsc -p ./ && mocha` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 736 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 606 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 551 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 500 | `mocha test/unit` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 487 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 486 | `mocha --opts mocha.opts` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 471 | `mocha --opts mocha.opts` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 470 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 452 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 431 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 347 | `tsc && mocha test && yarn lint` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 324 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 290 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 239 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 190 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 168 | `nyc mocha` | 
...
| [englercj/tsd-jsdoc](https://github.com/englercj/tsd-jsdoc) | 100 | `mocha --ui tdd -r ts-node/register test/specs/**.ts` | 
...
| [rpgeeganage/async-ray](https://github.com/rpgeeganage/async-ray) | 58 | `nyc mocha` | 
...
| [DhyanaChina/todo-live](https://github.com/DhyanaChina/todo-live) | 51 | `mocha` | 
| [mono/TsToCSharp](https://github.com/mono/TsToCSharp) | 51 | `npm run lint && mocha  ./dist/TsToCSharpTests.js` | 
...
| [soraping/koa-ts](https://github.com/soraping/koa-ts) | 40 | `mocha --recursive` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 39 | `ttsc --project tsconfig-test.json && mocha` | 
