...
The list was updated at 01:56:06 02/21/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 69593 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17146 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12837 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11229 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7189 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6530 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5696 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4882 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4739 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4738 | `mocha` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3152 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3004 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2905 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2627 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2451 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2318 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2241 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1946 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1929 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1810 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1788 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1929 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1810 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1788 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1548 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1482 | `nyc -x '' mocha` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1459 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1426 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1341 | `mocha --opts mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1293 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [google/clasp](https://github.com/google/clasp) | 1292 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
| [funkia/list](https://github.com/funkia/list) | 1251 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1246 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1227 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1164 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1119 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1100 | `tsc -p ./ && mocha` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 946 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 941 | `mocha bin/tests/test.js` | 
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 863 | `npm run mocha` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 784 | `mocha --require ts-node/register` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 782 | `mocha test/backend` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 750 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 718 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 647 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 630 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 604 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 600 | `nyc mocha build/test` | 
...
| [bbc/sqs-consumer](https://github.com/bbc/sqs-consumer) | 582 | `mocha` | 
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 580 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 520 | `tsc && mocha test && yarn lint` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 517 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
| [benjamn/ast-types](https://github.com/benjamn/ast-types) | 502 | `npm run gen && npm run build && npm run mocha` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 502 | `mocha --opts mocha.opts` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 500 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 492 | `npm run mocha` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 473 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [amplify-education/serverless-domain-manager](https://github.com/amplify-education/serverless-domain-manager) | 379 | `tsc --project . && nyc mocha -r ts-node/register test/unit-tests/index.test.ts && nyc report --reporter=text-summary` | 
| [Polymer/prpl-server](https://github.com/Polymer/prpl-server) | 364 | `npm run build && mocha` | 
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 364 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
| [itsFrank/vue-typescript](https://github.com/itsFrank/vue-typescript) | 361 | `mocha` | 
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 360 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [apollographql/persistgraphql](https://github.com/apollographql/persistgraphql) | 350 | `mocha --reporter spec --full-trace lib/test/tests.js` | 
...
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 338 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 336 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 326 | `mocha` | 
...
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 318 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
...
| [nwtgck/piping-server](https://github.com/nwtgck/piping-server) | 273 | `mocha --require ts-node/register --timeout 10000 test/**/*.ts` | 
...
| [FormidableLabs/inspectpack](https://github.com/FormidableLabs/inspectpack) | 266 | `mocha "test/**/*.spec.ts"` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 251 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 240 | `nyc mocha` | 
...
| [renke/import-sort](https://github.com/renke/import-sort) | 231 | `mocha --require ts-node/register --recursive "packages/*/test/**/*.ts"` | 
...
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 208 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 160 | `tsc && mocha` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 156 | `nyc --reporter=html --reporter=text mocha` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 150 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
| [Half-Shot/matrix-appservice-discord](https://github.com/Half-Shot/matrix-appservice-discord) | 149 | `npm run-script build && mocha --opts test/mocha.opts build/test/config.js build/test` | 
...
| [arfedulov/semantic-ui-calendar-react](https://github.com/arfedulov/semantic-ui-calendar-react) | 133 | `npx cross-env TS_NODE_COMPILER_OPTIONS="{""allowJs"":true}" npx mocha -r ts-node/register ./test/setup.js ./test/**/*.{js,jsx,ts,tsx}` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 127 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [googleapis/nodejs-pubsub](https://github.com/googleapis/nodejs-pubsub) | 105 | `nyc mocha build/test` | 
...
| [balassy/aws-lambda-typescript](https://github.com/balassy/aws-lambda-typescript) | 97 | `nyc mocha` | 
...
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 78 | `npm run build && npx nyc --reporter=html mocha --timeout 0 --recursive out/test.js && lua tests/spec.lua` | 
...
| [Cellule/dndGenerator](https://github.com/Cellule/dndGenerator) | 66 | `mocha -r ./mocha-setup src/**/*.spec.ts` | 
...
| [JustinBeckwith/retry-axios](https://github.com/JustinBeckwith/retry-axios) | 61 | `nyc mocha build/test --timeout 5000 --require source-map-support/register` | 
| [dupski/json-to-graphql-query](https://github.com/dupski/json-to-graphql-query) | 61 | `mocha -r ts-node/register --recursive "./src/**/__tests__/*"` | 
...
| [KennethanCeyer/formulize](https://github.com/KennethanCeyer/formulize) | 52 | `nyc mocha --opts test/mocha.opts` | 
...
| [ethereumjs/ethereumjs-blockstream](https://github.com/ethereumjs/ethereumjs-blockstream) | 49 | `mocha --require ts-node/register tests/**/*.ts` | 
...
| [strongloop/loopback4-example-shopping](https://github.com/strongloop/loopback4-example-shopping) | 46 | `lb-mocha --allow-console-logs "dist/test"` | 
