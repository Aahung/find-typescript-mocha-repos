...
The list was updated at 01:56:14 02/06/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 68524 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16951 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12332 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10900 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7145 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6431 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5628 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4690 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4668 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4660 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3764 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3420 | `mocha --opts mocha.opts` | 
...
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2945 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2885 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2565 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2443 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2291 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2211 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1926 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1910 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1510 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1445 | `nyc -x '' mocha` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1413 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1359 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1315 | `mocha --opts mocha.opts` | 
...
| [google/clasp](https://github.com/google/clasp) | 1235 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1232 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1229 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1148 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 936 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 929 | `mocha bin/tests/test.js` | 
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 845 | `npm run mocha` | 
...
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 780 | `mocha test/backend` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 615 | `mocha test/unit` | 
...
| [bbc/sqs-consumer](https://github.com/bbc/sqs-consumer) | 572 | `mocha` | 
...
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 557 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [benjamn/ast-types](https://github.com/benjamn/ast-types) | 500 | `npm run gen && npm run tsc && npm run mocha` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 500 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 493 | `tsc && mocha test && yarn lint` | 
...
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 433 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 413 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [amplify-education/serverless-domain-manager](https://github.com/amplify-education/serverless-domain-manager) | 371 | `tsc --project . && nyc mocha -r ts-node/register test/unit-tests/index.test.ts && nyc report --reporter=text-summary` | 
| [itsFrank/vue-typescript](https://github.com/itsFrank/vue-typescript) | 361 | `mocha` | 
| [Polymer/prpl-server](https://github.com/Polymer/prpl-server) | 361 | `npm run build && mocha` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 323 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 259 | `mocha-webpack "src/**/*.ts"` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 220 | `nyc mocha` | 
| [Microsoft/vscode-cordova](https://github.com/Microsoft/vscode-cordova) | 217 | `node ./node_modules/mocha/bin/mocha --recursive -u bdd ./out/test/debugger` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 210 | `nyc mocha test/**/*.test.ts --exit` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 147 | `nyc --reporter=html --reporter=text mocha` | 
...
| [Half-Shot/matrix-appservice-discord](https://github.com/Half-Shot/matrix-appservice-discord) | 142 | `npm run-script build && mocha --opts test/mocha.opts build/test/config.js build/test` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 126 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
...
| [gcanti/prop-types-ts](https://github.com/gcanti/prop-types-ts) | 102 | `npm run lint && npm run prettier && npm run mocha` | 
...
| [redhat-developer/vscode-yaml](https://github.com/redhat-developer/vscode-yaml) | 90 | `mocha --ui tdd out/test/extension.test.js` | 
...
| [realm/realm-studio](https://github.com/realm/realm-studio) | 50 | `mocha-webpack --opts=configs/mocha-webpack.opts` | 
...
| [rpgeeganage/ifto](https://github.com/rpgeeganage/ifto) | 49 | `nyc mocha` | 
...
| [angular-extensions/model](https://github.com/angular-extensions/model) | 48 | `npm run lint && npm run format:test && nyc mocha {lib,schematics}/**/*.test.ts --require ts-node/register --require source-map-support/register` | 
...
| [ProjectOpenSea/opensea-js](https://github.com/ProjectOpenSea/opensea-js) | 40 | `./node_modules/.bin/mocha test/*.ts --require ts-node/register --timeout 15000` | 
