...
The list was updated at 01:55:28 10/29/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 62929 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15462 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9650 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8878 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8206 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6886 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5950 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4986 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4464 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4127 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3328 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2769 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2736 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2492 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2409 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2286 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2071 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1823 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1790 | `mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1783 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1685 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1402 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1349 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1297 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1242 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1146 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1088 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1077 | `nyc --reporter=html --reporter=text mocha` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1065 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1043 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [google/clasp](https://github.com/google/clasp) | 921 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 914 | `mocha --opts test/mocha.opts` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 874 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 807 | `mocha bin/tests/test.js` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 743 | `mocha test/backend` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 632 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 484 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 436 | `mocha --opts mocha.opts` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 405 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts` | 
...
| [mgechev/aspect.js](https://github.com/mgechev/aspect.js) | 268 | `tsc && mocha -R nyan ./dist/test/**/*.spec.js` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 252 | `mocha test` | 
...
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 166 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [Chinachu/Mirakurun](https://github.com/Chinachu/Mirakurun) | 152 | `mocha --exit test/*.spec.js` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 117 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 106 | `nyc --reporter=html --reporter=text mocha` | 
...
| [functionalone/serverless-iam-roles-per-function](https://github.com/functionalone/serverless-iam-roles-per-function) | 98 | `nyc mocha --require ts-node/register --require source-map-support/register  ./src/test/**/*.test.ts` | 
...
| [IBM/Decentralized-Energy-Composer](https://github.com/IBM/Decentralized-Energy-Composer) | 96 | `mocha --recursive -t 4000` | 
...
| [wildbit/postmark.js](https://github.com/wildbit/postmark.js) | 92 | `node_modules/mocha/bin/mocha --timeout 10000 --retries 1 -r ts-node/register test/**/*test.ts` | 
...
| [adrien2p/nestjs-graphql](https://github.com/adrien2p/nestjs-graphql) | 60 | `mocha -r ts-node/register src/**/tests/*.ts` | 
| [wix/rawss](https://github.com/wix/rawss) | 60 | `mocha` | 
| [interledgerjs/ilp-connector](https://github.com/interledgerjs/ilp-connector) | 60 | `nyc mocha` | 
| [KoteiIto/node-athena](https://github.com/KoteiIto/node-athena) | 59 | `rm -rf coverage && istanbul cover _mocha -- -R spec build/test/*.js` | 
...
| [sourcegraph/sourcegraph-extension-api](https://github.com/sourcegraph/sourcegraph-extension-api) | 41 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --require ts-node/register --require source-map-support/register --opts mocha.opts` | 
...
| [chanlito/simple-todos](https://github.com/chanlito/simple-todos) | 40 | `cross-env NODE_ENV=test nyc mocha --require test/index.ts --opts test/mocha.opts` | 
...
| [ninoseki/mitaka](https://github.com/ninoseki/mitaka) | 32 | `nyc mocha -r ts-node/register "src/**/*.spec.ts"` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 28 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
