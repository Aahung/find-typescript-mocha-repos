...
The list was updated at 01:56:05 03/12/19 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 71019 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17390 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13311 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11621 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7264 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6637 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5802 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 5025 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4830 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4786 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4206 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3444 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3303 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3071 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [retejs/rete](https://github.com/retejs/rete) | 2948 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2930 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2688 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts'` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2462 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2356 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2273 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1967 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1583 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1543 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1502 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1496 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1494 | `nyc -x '' mocha` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1400 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 980 | `mocha bin/tests/test.js` | 
...
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 890 | `npm run mocha` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 794 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 739 | `mocha` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 702 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 672 | `mocha test/unit` | 
...
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 610 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 606 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [mateogianolio/vectorious](https://github.com/mateogianolio/vectorious) | 585 | `nyc mocha -r ts-node/register ./src/*.spec.ts` | 
| [emilioastarita/lyricfier](https://github.com/emilioastarita/lyricfier) | 565 | `mocha` | 
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 561 | `mocha test` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 552 | `tsc && mocha test && yarn lint` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 525 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [Asana/typed-react](https://github.com/Asana/typed-react) | 382 | `istanbul cover _mocha -- --reporter ${MOCHA_REPORTER-nyan} --slow 10 --ui tdd --recursive build/**/*_test.js` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 363 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 348 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 337 | `mocha` | 
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 329 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 312 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 312 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
...
| [nefe/pont](https://github.com/nefe/pont) | 292 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 289 | `cd test && mocha -r ts-node/register *.ts` | 
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 285 | `mocha-webpack "src/**/*.ts"` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 279 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 243 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [JumpFm/jumpfm](https://github.com/JumpFm/jumpfm) | 194 | `mocha js` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 171 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
...
| [googleapis/nodejs-translate](https://github.com/googleapis/nodejs-translate) | 168 | `nyc mocha build/test` | 
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 166 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 153 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 138 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [inversify/inversify-express-example](https://github.com/inversify/inversify-express-example) | 109 | `nyc --clean --all --require ts-node/register --require reflect-metadata/Reflect --extension .ts -- mocha --exit --timeout 5000` | 
...
| [argoproj/argo-ui](https://github.com/argoproj/argo-ui) | 52 | `mocha --require ts-node/register ./src/app/**/*.spec.ts` | 
