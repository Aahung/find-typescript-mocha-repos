...
The list was updated at 01:56:28 02/26/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 69829 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17208 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12963 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11320 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7211 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6554 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5725 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4941 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4763 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4749 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3917 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3439 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3174 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3023 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2913 | `mocha` | 
| [retejs/rete](https://github.com/retejs/rete) | 2909 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2643 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2456 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2327 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2251 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1952 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1553 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1489 | `nyc -x '' mocha` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1485 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1483 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1434 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1348 | `mocha --opts mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 1312 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1295 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [funkia/list](https://github.com/funkia/list) | 1256 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1254 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 967 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 955 | `mocha --opts test/mocha.opts` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 949 | `mocha bin/tests/test.js` | 
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 871 | `npm run mocha` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 776 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 724 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 652 | `mocha test/unit` | 
| [laoqiren/mlhelper](https://github.com/laoqiren/mlhelper) | 646 | `mocha --recursive` | 
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 638 | `mocha lib/test/unittest.js --check-leaks --color` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 612 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 589 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 531 | `tsc && mocha test && yarn lint` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 521 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 508 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 496 | `npm run mocha` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 494 | `npm run lint && npm run mocha` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 492 | `mocha --opts mocha.opts` | 
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 487 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 347 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 296 | `mocha lib/test` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 276 | `mocha-webpack "src/**/*.ts"` | 
| [nwtgck/piping-server](https://github.com/nwtgck/piping-server) | 276 | `mocha --require ts-node/register --timeout 10000 test/**/*.ts` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 268 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 262 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 245 | `nyc mocha` | 
| [nefe/pont](https://github.com/nefe/pont) | 240 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 167 | `mocha --delay` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 156 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
| [nozer/quill-delta-to-html](https://github.com/nozer/quill-delta-to-html) | 156 | `./node_modules/nyc/bin/nyc.js ./node_modules/mocha/bin/mocha --compilers ts:ts-node/register -b "./test/**/*.ts"  ` | 
...
| [nomiclabs/buidler](https://github.com/nomiclabs/buidler) | 150 | `nyc mocha` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 130 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [dalenguyen/firestore-backup-restore](https://github.com/dalenguyen/firestore-backup-restore) | 58 | `mocha --timeout 99999999 --exit -r ts-node/register test/**/*.spec.ts` | 
...
| [typeorm/typescript-example](https://github.com/typeorm/typescript-example) | 35 | `mocha -r ts-node/register test/**/*.spec.ts` | 
