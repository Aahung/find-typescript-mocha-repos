...
The list was updated at 01:55:56 03/09/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 70762 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17355 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13255 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11566 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7251 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6612 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5789 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 5009 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4814 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4777 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4186 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3443 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3285 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
...
| [retejs/rete](https://github.com/retejs/rete) | 2940 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2925 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2682 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts'` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2462 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2353 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2269 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1961 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1575 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1534 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1480 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1364 | `mocha --opts mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1346 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1115 | `tsc -p ./ && mocha` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 977 | `mocha bin/tests/test.js` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 664 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 596 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 547 | `tsc && mocha test && yarn lint` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 509 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [arangodb/arangojs](https://github.com/arangodb/arangojs) | 359 | `mocha --growl --reporter spec --require source-map-support/register --timeout 10000 lib/async/test` | 
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 357 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 347 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 325 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 325 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 309 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 309 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 286 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [redhat-developer/yaml-language-server](https://github.com/redhat-developer/yaml-language-server) | 133 | `mocha --require ts-node/register --ui tdd ./test/*.test.ts` | 
...
| [googleapis/nodejs-pubsub](https://github.com/googleapis/nodejs-pubsub) | 114 | `nyc mocha build/test` | 
...
| [gcanti/prop-types-ts](https://github.com/gcanti/prop-types-ts) | 107 | `npm run lint && npm run prettier && npm run mocha` | 
...
| [dalenguyen/firestore-backup-restore](https://github.com/dalenguyen/firestore-backup-restore) | 61 | `mocha --timeout 99999999 --exit -r ts-node/register test/**/*.spec.ts` | 
...
| [typeorm/typescript-example](https://github.com/typeorm/typescript-example) | 36 | `mocha -r ts-node/register test/**/*.spec.ts` | 
| [tsframework/ts-framework](https://github.com/tsframework/ts-framework) | 36 | `mocha build-test --recursive` | 
| [laurence-myers/tsdv-joi](https://github.com/laurence-myers/tsdv-joi) | 36 | `mocha --require source-map-support/register "dist/test/**/*.js"` | 
| [googleapis/github-repo-automation](https://github.com/googleapis/github-repo-automation) | 36 | `nyc mocha build/test` | 
| [lolamtisch/MALSync](https://github.com/lolamtisch/MALSync) | 36 | `webpack --config webpackConfig/test.config.js && mocha --recursive --timeout 30000 --retries 2 test/headless` | 
