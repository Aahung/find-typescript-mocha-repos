...
The list was updated at 01:55:59 01/24/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 67854 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16781 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11942 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10560 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7084 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6353 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5558 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4674 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4600 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4372 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3478 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3412 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3018 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2896 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2869 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2521 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2440 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2266 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2194 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1909 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1454 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1434 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1423 | `nyc -x '' mocha` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1361 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1324 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1285 | `mocha --opts mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1253 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1217 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [google/clasp](https://github.com/google/clasp) | 1205 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [itchio/itch](https://github.com/itchio/itch) | 1008 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 942 | `mocha --opts test/mocha.opts` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 905 | `mocha bin/tests/test.js` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 772 | `mocha test/backend` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 766 | `mocha --require ts-node/register` | 
...
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 715 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
| [angular/dgeni](https://github.com/angular/dgeni) | 712 | `mocha --require ts-node/register -R spec src/**/*.spec.ts` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 710 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 626 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 596 | `mocha test/unit` | 
...
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 580 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [pgilad/leasot](https://github.com/pgilad/leasot) | 579 | `mocha --require ts-node/register -R spec './tests/*.ts'` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 578 | `nyc mocha build/test` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 570 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 533 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 491 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 488 | `mocha --opts mocha.opts` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 487 | `mocha --opts mocha.opts` | 
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 476 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 475 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 469 | `npm run mocha` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 469 | `cd test && mocha -r ts-node/register *.ts` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 468 | `tsc && mocha test && yarn lint` | 
...
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 347 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 306 | `mocha` | 
...
| [albburtsev/bem-cn](https://github.com/albburtsev/bem-cn) | 266 | `mocha src/**/*.spec.ts` | 
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 259 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [googleapis/nodejs-storage](https://github.com/googleapis/nodejs-storage) | 219 | `nyc mocha build/test` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 206 | `nyc mocha` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 163 | `nyc mocha test/**/*.test.ts --exit` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 141 | `nyc --reporter=html --reporter=text mocha` | 
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 140 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [implydata/plyql](https://github.com/implydata/plyql) | 137 | `mocha` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 134 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [bradymholt/cRonstrue](https://github.com/bradymholt/cRonstrue) | 124 | `npx mocha --reporter spec --compilers ts:ts-node/register` | 
...
| [matthew-matvei/freeman](https://github.com/matthew-matvei/freeman) | 117 | `xvfb-maybe electron-mocha --renderer __tests__` | 
| [redhat-developer/yaml-language-server](https://github.com/redhat-developer/yaml-language-server) | 117 | `mocha --require ts-node/register --ui tdd ./test/*.test.ts` | 
...
| [IBM/Decentralized-Energy-Composer](https://github.com/IBM/Decentralized-Energy-Composer) | 110 | `mocha --recursive -t 4000` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 105 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [googleapis/nodejs-pubsub](https://github.com/googleapis/nodejs-pubsub) | 98 | `nyc mocha build/test` | 
...
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 93 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
...
| [redhat-developer/vscode-yaml](https://github.com/redhat-developer/vscode-yaml) | 85 | `mocha --ui tdd out/test/extension.test.js` | 
...
| [balassy/aws-lambda-typescript](https://github.com/balassy/aws-lambda-typescript) | 81 | `nyc mocha` | 
| [flagello/Essence](https://github.com/flagello/Essence) | 81 | `mocha` | 
| [neon-bindings/neon-cli](https://github.com/neon-bindings/neon-cli) | 81 | `npm run transpile && mocha dist/neon-cli-test/acceptance` | 
| [googleapis/nodejs-bigquery](https://github.com/googleapis/nodejs-bigquery) | 80 | `nyc mocha build/test` | 
...
| [theGlenn/apollo-prophecy](https://github.com/theGlenn/apollo-prophecy) | 71 | `rm -rf coverage && nyc mocha --opts mocha.opts` | 
...
| [ninoseki/mitaka](https://github.com/ninoseki/mitaka) | 57 | `nyc mocha -r ts-node/register "src/**/*.spec.ts"` | 
...
| [Anonyfox/vuex-store-module-example](https://github.com/Anonyfox/vuex-store-module-example) | 52 | `rm -rf dist && tsc -p . && npm run lint && mocha dist/test` | 
...
| [BeTomorrow/ReImproveJS](https://github.com/BeTomorrow/ReImproveJS) | 45 | `mocha --reporter spec --compilers ts:ts-node/register 'test/*.spec.ts' --timeout 120000` | 
