...
The list was updated at 01:56:10 01/29/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 68124 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16853 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12103 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10665 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7099 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6375 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5581 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4681 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4630 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4466 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3575 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3412 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3049 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2912 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2872 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2538 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2443 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2277 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1900 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1460 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1446 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1427 | `nyc -x '' mocha` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1380 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1341 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1286 | `mocha --opts mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1262 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1138 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 921 | `mocha bin/tests/test.js` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 578 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 565 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 540 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 496 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 478 | `tsc && mocha test && yarn lint` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 471 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 428 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 411 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 327 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 311 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 308 | `mocha` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 269 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 249 | `mocha-webpack "src/**/*.ts"` | 
...
| [googleapis/nodejs-storage](https://github.com/googleapis/nodejs-storage) | 222 | `nyc mocha build/test` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 211 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 211 | `nyc mocha` | 
...
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 201 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 180 | `nyc mocha test/**/*.test.ts --exit` | 
...
| [drew-y/cliffy](https://github.com/drew-y/cliffy) | 171 | `tsc && cd dist && mocha` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 144 | `nyc --reporter=html --reporter=text mocha` | 
...
| [Enterprise-JS/vscode-ts-node-debugging](https://github.com/Enterprise-JS/vscode-ts-node-debugging) | 132 | `npm run mocha --recursive ./src/**/__tests__/*` | 
...
| [matthew-matvei/freeman](https://github.com/matthew-matvei/freeman) | 121 | `xvfb-maybe electron-mocha --renderer __tests__` | 
| [nomiclabs/buidler](https://github.com/nomiclabs/buidler) | 120 | `nyc mocha` | 
| [TreeGateway/tree-gateway](https://github.com/TreeGateway/tree-gateway) | 119 | `cross-env NODE_ENV=test mocha --exit` | 
...
| [functionalone/serverless-iam-roles-per-function](https://github.com/functionalone/serverless-iam-roles-per-function) | 116 | `nyc mocha --require ts-node/register --require source-map-support/register  ./src/test/**/*.test.ts` | 
...
| [grantila/fetch-h2](https://github.com/grantila/fetch-h2) | 115 | `npm run lint && node_modules/.bin/nyc --require source-map-support/register npm run mocha` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 109 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [levjj/esverify](https://github.com/levjj/esverify) | 94 | `TS_NODE_TRANSPILE_ONLY=true mocha -r ts-node/register tests/*.ts` | 
...
| [googleapis/nodejs-bigquery](https://github.com/googleapis/nodejs-bigquery) | 83 | `nyc mocha build/test` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 73 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
...
| [AlCalzone/node-tradfri-client](https://github.com/AlCalzone/node-tradfri-client) | 57 | `node_modules/.bin/mocha --watch` | 
...
| [rpgeeganage/ifto](https://github.com/rpgeeganage/ifto) | 39 | `nyc mocha` | 
...
| [microsoftgraph/msgraph-typescript-typings](https://github.com/microsoftgraph/msgraph-typescript-typings) | 38 | `tsc && mocha spec/` | 
...
| [angular-extensions/model](https://github.com/angular-extensions/model) | 37 | `npm run lint && npm run format:test && nyc mocha {lib,schematics}/**/*.test.ts --require ts-node/register --require source-map-support/register` | 
...
| [strongloop/loopback4-example-shopping](https://github.com/strongloop/loopback4-example-shopping) | 36 | `lb-mocha --allow-console-logs "dist/test"` | 
