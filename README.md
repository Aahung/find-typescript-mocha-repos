...
The list was updated at 01:55:58 12/10/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 65312 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16154 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10728 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9603 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8597 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6969 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6114 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5244 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4562 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4342 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3801 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
...
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2712 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2675 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2426 | `mocha 'test/**/*.ts'` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2396 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2188 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1852 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1686 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 20000 --max-parallel=1 --exit` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1405 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1231 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1173 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
...
| [google/clasp](https://github.com/google/clasp) | 1074 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1038 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 960 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
...
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 695 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 663 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 658 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 536 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 534 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 530 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 464 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
| [43081j/rar.js](https://github.com/43081j/rar.js) | 462 | `npm run build && mocha` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 459 | `mocha --opts mocha.opts` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 455 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 447 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 433 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
...
| [apollographql/persistgraphql](https://github.com/apollographql/persistgraphql) | 333 | `mocha --reporter spec --full-trace lib/test/tests.js` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 318 | `tsc && mocha test && yarn lint` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 291 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 277 | `mocha` | 
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 276 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 240 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 233 | `mocha test/unit` | 
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 230 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [ClickSimply/Nano-SQL](https://github.com/ClickSimply/Nano-SQL) | 219 | `mocha -r ts-node/register tests/index.ts` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 213 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 173 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [codemod-js/codemod](https://github.com/codemod-js/codemod) | 172 | `mocha "test/**/*Test.js"` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 167 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [emmanueltouzery/prelude-ts](https://github.com/emmanueltouzery/prelude-ts) | 155 | `rm tests/apidoc-*; tsc && node ./dist/tests/Comments.js && tsc && ./node_modules/mocha/bin/mocha --throw-deprecation --timeout 60000 ./dist/tests/*.js` | 
...
| [indutny/llhttp](https://github.com/indutny/llhttp) | 141 | `npm run mocha && npm run lint` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 121 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [atomist/sdm](https://github.com/atomist/sdm) | 120 | `mocha --require espower-typescript/guess "test/**/*.test.ts"` | 
...
| [dsherret/ts-nameof](https://github.com/dsherret/ts-nameof) | 109 | `yarn run --silent copy-test-files && nyc --reporter=lcov mocha --opts mocha.opts` | 
...
| [indutny/llparse](https://github.com/indutny/llparse) | 94 | `npm run mocha && npm run lint` | 
...
| [Microsoft/vscode-mock-debug](https://github.com/Microsoft/vscode-mock-debug) | 69 | `mocha -u tdd ./out/tests/` | 
...
| [bpatrik/pigallery2](https://github.com/bpatrik/pigallery2) | 66 | `ng test && mocha --recursive test/backend/unit && mocha --recursive test/backend/integration  && mocha --recursive test/common/unit ` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 65 | `mocha` | 
...
| [longlho/ts-transform-css-modules](https://github.com/longlho/ts-transform-css-modules) | 48 | `rm -rf test/fixture/*.js && mocha --require ts-node/register --recursive  test/**/*.test.ts` | 
...
| [lukeautry/ts-app](https://github.com/lukeautry/ts-app) | 42 | `cross-env TS_NODE_PROJECT=./api/tsconfig.json mocha -t 15000 -r ts-node/register "./api/**/*.spec.ts"` | 
...
| [hg-pyun/iterize](https://github.com/hg-pyun/iterize) | 39 | `mocha --recursive ./test/*.ts --require ts-node/register` | 
