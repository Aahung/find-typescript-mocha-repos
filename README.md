...
The list was updated at 01:56:26 02/27/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 69887 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17212 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13003 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11344 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7214 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6564 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5734 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4945 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4770 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4756 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3924 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3438 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3178 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3025 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2913 | `mocha` | 
| [retejs/rete](https://github.com/retejs/rete) | 2912 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2646 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2457 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2330 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2252 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1953 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1556 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1490 | `nyc -x '' mocha` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1488 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1485 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1436 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1350 | `mocha --opts mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 1318 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1297 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 971 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 955 | `mocha --opts test/mocha.opts` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 951 | `mocha bin/tests/test.js` | 
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 873 | `npm run mocha` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 793 | `mocha --require ts-node/register` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 783 | `mocha test/backend` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 777 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [coinbase/gdax-tt](https://github.com/coinbase/gdax-tt) | 741 | `yarn run lint && yarn run test:mocha` | 
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 733 | `mocha` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 695 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 655 | `mocha test/unit` | 
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 655 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 613 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 603 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 600 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [JustClear/blurify](https://github.com/JustClear/blurify) | 597 | `mocha test/index.js` | 
| [szokodiakos/typegoose](https://github.com/szokodiakos/typegoose) | 596 | `npm run lint && nyc npm run mocha` | 
...
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 590 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 534 | `tsc && mocha test && yarn lint` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 522 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 510 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 498 | `npm run mocha` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 495 | `npm run lint && npm run mocha` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 492 | `mocha --opts mocha.opts` | 
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 489 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 475 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 421 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 348 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 336 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 279 | `mocha-webpack "src/**/*.ts"` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 267 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 264 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 247 | `nyc mocha` | 
...
| [nefe/pont](https://github.com/nefe/pont) | 244 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 231 | `nyc mocha test/**/*.test.ts --exit` | 
...
| [Half-Shot/matrix-appservice-discord](https://github.com/Half-Shot/matrix-appservice-discord) | 156 | `npm run-script build && mocha --opts test/mocha.opts build/test/config.js build/test` | 
...
| [nomiclabs/buidler](https://github.com/nomiclabs/buidler) | 151 | `nyc mocha` | 
...
| [bradymholt/cRonstrue](https://github.com/bradymholt/cRonstrue) | 134 | `npx mocha --reporter spec --compilers ts:ts-node/register` | 
...
| [functionalone/serverless-iam-roles-per-function](https://github.com/functionalone/serverless-iam-roles-per-function) | 126 | `nyc mocha --require ts-node/register --require source-map-support/register  ./src/test/**/*.test.ts` | 
...
| [tycho01/typical](https://github.com/tycho01/typical) | 116 | `tsc | tee tsc.log && mocha lib/**/*.test.js 2>&1 | sed 's/[0-9]\+)/×/g' | tee errors.log` | 
...
| [googleapis/nodejs-pubsub](https://github.com/googleapis/nodejs-pubsub) | 108 | `nyc mocha build/test` | 
...
| [googleapis/nodejs-bigquery](https://github.com/googleapis/nodejs-bigquery) | 90 | `nyc mocha build/test` | 
...
| [timocov/dts-bundle-generator](https://github.com/timocov/dts-bundle-generator) | 80 | `mocha --timeout 10000 --slow 2500 tests/unittests/**/*.spec.js tests/functional-test-cases.js` | 
...
| [seansfkelley/synology-download-manager](https://github.com/seansfkelley/synology-download-manager) | 48 | `TS_NODE_PROJECT=test/tsconfig-test.json mocha --require ts-node/register 'test/**/*.{ts,tsx}'` | 
...
| [ecrmnn/trending-github](https://github.com/ecrmnn/trending-github) | 36 | `mocha -r ts-node/register test/tests.ts && npm run eslint` | 
