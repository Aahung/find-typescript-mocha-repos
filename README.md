...
The list was updated at 01:55:27 10/23/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 62528 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15376 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9516 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8790 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8176 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6872 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5919 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4930 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4460 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4103 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3319 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2764 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2708 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2482 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2410 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2254 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2056 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1816 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1789 | `mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1771 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1327 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
...
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1226 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [funkia/list](https://github.com/funkia/list) | 1188 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1138 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [watson-developer-cloud/node-sdk](https://github.com/watson-developer-cloud/node-sdk) | 1133 | `nyc mocha test/unit/ test/integration/ && nyc report --reporter=html` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1130 | `mocha --opts mocha.opts` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1077 | `nyc --reporter=html --reporter=text mocha` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1071 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1059 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 998 | `tsc -p ./ && mocha` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 997 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 912 | `mocha --opts test/mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 904 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 799 | `mocha bin/tests/test.js` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 629 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 555 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 534 | `mocha test` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 505 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 463 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 424 | `npm run mocha` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 411 | `cross-env NODE_ENV=test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 395 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 393 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 364 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 363 | `cd test && mocha -r ts-node/register *.ts` | 
| [jacobbogers/libRmath.js](https://github.com/jacobbogers/libRmath.js) | 362 | `cross-env-shell NODE_ENV=test TS_NODE_DISABLE_WARNINGS=true nyc mocha` | 
...
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 298 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 244 | `mocha test` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 239 | `mocha` | 
| [SpoonX/wetland](https://github.com/SpoonX/wetland) | 233 | `mocha dist/test/helper dist/test/unit/{*.spec.js,**/*.spec.js} --timeout 15000` | 
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 232 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 213 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 180 | `mocha-webpack "src/**/*.ts"` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 153 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [Talento90/typescript-node](https://github.com/Talento90/typescript-node) | 139 | `npm run build && mocha --exit --recursive dist/test/unit` | 
...
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 130 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 114 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 103 | `nyc --reporter=html --reporter=text mocha` | 
...
| [structured-log/structured-log](https://github.com/structured-log/structured-log) | 93 | `mocha --compilers ts:ts-node/register -r src/polyfills/objectAssign.js test/**/*.spec.ts` | 
...
| [mtmr0x/nucleo](https://github.com/mtmr0x/nucleo) | 67 | `mocha -r ts-node/register` | 
...
| [ethereum-ts/evm-ts](https://github.com/ethereum-ts/evm-ts) | 33 | `yarn lint && yarn test:mocha` | 
...
| [ste-vg/pop.svg](https://github.com/ste-vg/pop.svg) | 27 | `nyc mocha --require ./mocha.config.js -r ts-node/register 'src/**/*.spec.ts'  --exit --recursive --timeout 10000` | 