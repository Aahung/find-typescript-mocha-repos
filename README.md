...
The list was updated at 01:55:26 12/22/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 66098 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16336 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11146 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9846 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6994 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6211 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5327 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4601 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4407 | `npm-run-all test:pre -p test:mocha test:rules` | 
...
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2832 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2766 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
...
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2415 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1394 | `nyc -x '' mocha` | 
...
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1247 | `mocha --opts mocha.opts` | 
...
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 707 | `mocha` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 701 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 676 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 493 | `mocha test/unit` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 485 | `mocha --opts mocha.opts` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 485 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 468 | `mocha --opts mocha.opts` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 455 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 343 | `tsc && mocha test && yarn lint` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 297 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 288 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [alexcambose/motus](https://github.com/alexcambose/motus) | 283 | `cross-env mocha -r ts-node/register 'test/**/*.spec.ts'` | 
...
| [RisingStack/node-typescript-starter](https://github.com/RisingStack/node-typescript-starter) | 239 | `tsc && mocha dist/**/*.spec.js` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 188 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 166 | `nyc mocha` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 141 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [gcanti/prop-types-ts](https://github.com/gcanti/prop-types-ts) | 91 | `npm run lint && npm run prettier && npm run mocha` | 
...
| [bpatrik/pigallery2](https://github.com/bpatrik/pigallery2) | 77 | `ng test && mocha --recursive test/backend/unit && mocha --recursive test/backend/integration  && mocha --recursive test/common/unit ` | 
...
| [KennethanCeyer/browser-detect](https://github.com/KennethanCeyer/browser-detect) | 51 | `nyc mocha` | 
...
| [Jason3S/rx-stream](https://github.com/Jason3S/rx-stream) | 34 | `mocha --recursive "dist/**/*.test.js"` | 
