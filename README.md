...
The list was updated at 01:55:07 10/28/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 62872 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15451 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9639 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8867 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8203 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6884 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5946 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4977 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4465 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4123 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3327 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2770 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2734 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
...
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2283 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2070 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1782 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1682 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1398 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
...
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1240 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1087 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1040 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [google/clasp](https://github.com/google/clasp) | 919 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 914 | `mocha --opts test/mocha.opts` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 870 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
...
| [angular/dgeni](https://github.com/angular/dgeni) | 706 | `mocha --require ts-node/register -R spec src/**/*.spec.ts` | 
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 677 | `mocha` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 482 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 397 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 242 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 163 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [pdupavillon/express-recaptcha](https://github.com/pdupavillon/express-recaptcha) | 55 | `mocha --compilers ts:ts-node/register test/**/*.spec.ts` | 
| [jeswin/basho](https://github.com/jeswin/basho) | 55 | `./build.sh && mocha dist/test/test.js` | 
| [googleapis/node-gtoken](https://github.com/googleapis/node-gtoken) | 55 | `nyc mocha build/test` | 
...
| [balmbees/dynamo-types](https://github.com/balmbees/dynamo-types) | 43 | `AWS_REGION=us-east-1 AWS_ACCESS_KEY_ID=mock AWS_SECRET_ACCESS_KEY=mock DYNAMO_TYPES_ENDPOINT=http://127.0.0.1:8000 mocha -t 20000 dst/**/__test__/**/*.js` | 
