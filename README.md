...
The list was updated at 01:56:01 11/09/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 63561 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15677 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9895 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9067 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8300 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6908 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6002 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5064 | `npm run mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4173 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3342 | `mocha --opts mocha.opts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2914 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2914 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2786 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2564 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2416 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2371 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2113 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1807 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1520 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1364 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1322 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1270 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1232 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [funkia/list](https://github.com/funkia/list) | 1196 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1157 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1152 | `mocha --opts mocha.opts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1104 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1099 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [google/clasp](https://github.com/google/clasp) | 982 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 818 | `mocha bin/tests/test.js` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 751 | `mocha test/backend` | 
| [coinbase/gdax-tt](https://github.com/coinbase/gdax-tt) | 725 | `yarn run lint && yarn run test:mocha` | 
| [angular/dgeni](https://github.com/angular/dgeni) | 709 | `mocha --require ts-node/register -R spec src/**/*.spec.ts` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 687 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 684 | `mocha` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 678 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 586 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 423 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 410 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 404 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 378 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [R-js/libRmath.js](https://github.com/R-js/libRmath.js) | 369 | `cross-env-shell NODE_ENV=test TS_NODE_DISABLE_WARNINGS=true nyc mocha` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 266 | `mocha test` | 
...
| [ClickSimply/Nano-SQL](https://github.com/ClickSimply/Nano-SQL) | 197 | `mocha -r ts-node/register tests/index.ts` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 194 | `mocha-webpack "src/**/*.ts"` | 
...
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 182 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [microsoftgraph/msgraph-sdk-javascript](https://github.com/microsoftgraph/msgraph-sdk-javascript) | 167 | `mocha lib/spec/core` | 
| [pnp/office365-cli](https://github.com/pnp/office365-cli) | 166 | `nyc -r=lcov -r=text mocha "dist/**/*.spec.js"` | 
| [square/babel-codemod](https://github.com/square/babel-codemod) | 162 | `mocha "test/**/*Test.js"` | 
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 160 | `mocha --forbid-only "test/**/*.test.ts"` | 
| [drew-y/cliffy](https://github.com/drew-y/cliffy) | 157 | `tsc && cd dist && mocha` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 140 | `nyc mocha` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 133 | `cd test && mocha -r ts-node/register *.ts` | 
| [implydata/plyql](https://github.com/implydata/plyql) | 133 | `mocha` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 132 | `mocha test/unit` | 
...
| [Soluto/graphql-to-mongodb](https://github.com/Soluto/graphql-to-mongodb) | 112 | `ts-mocha tests/**/*.spec.ts` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 109 | `nyc --reporter=html --reporter=text mocha` | 
...
| [JoshGlazebrook/socks](https://github.com/JoshGlazebrook/socks) | 98 | `NODE_ENV=test mocha --recursive --compilers ts:ts-node/register test/**/*.ts` | 
...
| [atomist/sdm](https://github.com/atomist/sdm) | 89 | `nyc mocha --require espower-typescript/guess --require source-map-support/register "test/**/*.test.ts"` | 
...
| [timocov/dts-bundle-generator](https://github.com/timocov/dts-bundle-generator) | 52 | `mocha --timeout 10000 --slow 2500 tests/all-test-cases.js` | 
...
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 41 | `nyc --reporter=html mocha --timeout 0 --require ts-node/register --require source-map-support/register --recursive src/test.ts` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 40 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
