...
The list was updated at 01:55:29 12/07/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 65181 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16118 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10650 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9548 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8594 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6959 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6101 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5235 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4560 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4332 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3779 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3369 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2817 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2699 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2648 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2426 | `mocha 'test/**/*.ts'` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2386 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2183 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1855 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1670 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 20000 --max-parallel=1 --exit` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1400 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1357 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1340 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1233 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1231 | `mocha --opts mocha.opts` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1215 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1163 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
...
| [google/clasp](https://github.com/google/clasp) | 1065 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1037 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 954 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 927 | `mocha --opts test/mocha.opts` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 893 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
...
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 693 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
...
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 464 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [43081j/rar.js](https://github.com/43081j/rar.js) | 462 | `npm run build && mocha` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 461 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 314 | `tsc && mocha test && yarn lint` | 
...
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 238 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
...
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 235 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
...
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 226 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 210 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 183 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 171 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [Microsoft/vscode-vsce](https://github.com/Microsoft/vscode-vsce) | 135 | `gulp compile && mocha` | 
...
| [indutny/llhttp](https://github.com/indutny/llhttp) | 133 | `npm run mocha && npm run lint` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 113 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [nomiclabs/buidler](https://github.com/nomiclabs/buidler) | 110 | `nyc mocha` | 
...
| [grantila/fetch-h2](https://github.com/grantila/fetch-h2) | 106 | `node_modules/.bin/nyc npm run mocha` | 
...
| [indutny/llparse](https://github.com/indutny/llparse) | 92 | `npm run mocha && npm run lint` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 46 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [JustinBeckwith/retry-axios](https://github.com/JustinBeckwith/retry-axios) | 43 | `nyc mocha build/test --timeout 5000 --require source-map-support/register` | 
