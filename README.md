...
The list was updated at 01:56:44 03/28/19 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 72271 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17675 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13944 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11950 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7310 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6722 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5897 | `npm run mocha` | 
| [peers/peerjs](https://github.com/peers/peerjs) | 5766 | `mocha -r ts-node/register -r jsdom-global/register test/**/*.ts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 5118 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts && npm run test:packages` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4903 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4890 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4272 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3465 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3413 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3171 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [retejs/rete](https://github.com/retejs/rete) | 2992 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
...
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2396 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1958 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 1950 | `mocha test/unit` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1628 | `COLYSEUS_PRESENCE_SHORT_TIMEOUT=300 mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1606 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1557 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1528 | `nyc -x '' mocha` | 
...
| [cherow/cherow](https://github.com/cherow/cherow) | 1472 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [google/clasp](https://github.com/google/clasp) | 1388 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1387 | `mocha --opts mocha.opts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1285 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [funkia/list](https://github.com/funkia/list) | 1271 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
...
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 966 | `mocha --opts test/mocha.opts` | 
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 902 | `npm run mocha` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 821 | `mocha --require ts-node/register` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 807 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [szokodiakos/typegoose](https://github.com/szokodiakos/typegoose) | 631 | `npm run lint && nyc npm run mocha` | 
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 626 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 625 | `nyc mocha build/test` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 619 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [bbc/sqs-consumer](https://github.com/bbc/sqs-consumer) | 604 | `mocha` | 
| [JustClear/blurify](https://github.com/JustClear/blurify) | 598 | `mocha test/index.js` | 
| [pgilad/leasot](https://github.com/pgilad/leasot) | 596 | `mocha --require ts-node/register -R spec './tests/*.ts'` | 
| [hacksparrow/node-easyimage](https://github.com/hacksparrow/node-easyimage) | 596 | `npm run lint && npm run mocha` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 568 | `tsc && mocha test && yarn lint` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 553 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 527 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 503 | `npm run lint && npm run mocha` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 433 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 406 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 378 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 322 | `cd test && mocha -r ts-node/register *.ts` | 
| [mgechev/aspect.js](https://github.com/mgechev/aspect.js) | 306 | `tsc && mocha -R nyan ./dist/test/**/*.spec.js` | 
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 306 | `mocha-webpack "src/**/*.ts"` | 
...
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 195 | `tsc && mocha` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 179 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [chenhaozhi/Cpage.js](https://github.com/chenhaozhi/Cpage.js) | 150 | `mocha -r ./node_modules/ts-node/register test/**/*_spec.ts --reporter mochawesome` | 
| [atomist/sdm](https://github.com/atomist/sdm) | 149 | `mocha --require espower-typescript/guess "test/**/*.test.ts"` | 
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 147 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
| [Soluto/graphql-to-mongodb](https://github.com/Soluto/graphql-to-mongodb) | 147 | `ts-mocha tests/**/*.spec.ts` | 
...
| [rtfeldman/node-elm-compiler](https://github.com/rtfeldman/node-elm-compiler) | 135 | `rm -rf test/fixtures/elm-stuff && mocha test/**/*.ts --require ts-node/register --watch-extensions ts` | 
...
| [mysticatea/vue-eslint-parser](https://github.com/mysticatea/vue-eslint-parser) | 115 | `nyc npm run _mocha` | 
...
| [puzzle-js/puzzle-js](https://github.com/puzzle-js/puzzle-js) | 104 | `nyc --check-coverage --lines=85 cross-env NODE_ENV=production mocha -r ts-node/register  --recursive 'test/**/*.spec.ts'` | 
...
| [redhat-developer/vscode-yaml](https://github.com/redhat-developer/vscode-yaml) | 102 | `mocha --ui tdd out/test/extension.test.js` | 
...
| [levjj/esverify](https://github.com/levjj/esverify) | 100 | `TS_NODE_TRANSPILE_ONLY=true mocha -r ts-node/register tests/*.ts` | 
...
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 90 | `npm run build && npx nyc --reporter=html mocha --timeout 0 --recursive out/test.js && lua tests/spec.lua` | 
...
| [lolamtisch/MALSync](https://github.com/lolamtisch/MALSync) | 46 | `webpack --config webpackConfig/test.config.js && mocha --recursive --timeout 30000 --retries 2 test/headless` | 
