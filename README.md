...
The list was updated at 01:55:20 11/02/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 63194 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15549 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9743 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8945 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8245 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6894 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5973 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5021 | `npm run mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4142 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3332 | `mocha --opts mocha.opts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2795 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2774 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2524 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2412 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2315 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2095 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1827 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [staltz/xstream](https://github.com/staltz/xstream) | 1692 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1069 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1008 | `tsc -p ./ && mocha` | 
| [google/clasp](https://github.com/google/clasp) | 955 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 672 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 561 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 495 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 492 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 441 | `mocha --opts mocha.opts` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 431 | `npm run mocha` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 414 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts` | 
...
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 289 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 256 | `mocha test` | 
...
| [RisingStack/node-typescript-starter](https://github.com/RisingStack/node-typescript-starter) | 225 | `tsc && mocha dist/**/*.spec.js` | 
...
| [FormidableLabs/inspectpack](https://github.com/FormidableLabs/inspectpack) | 167 | `mocha "test/**/*.spec.ts"` | 
...
| [AlCalzone/node-tradfri-client](https://github.com/AlCalzone/node-tradfri-client) | 42 | `node_modules/.bin/mocha --watch` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 40 | `mocha` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 31 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
