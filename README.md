...
The list was updated at 01:56:01 02/07/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 68579 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16964 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12356 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10925 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7149 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6440 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5633 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4692 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4680 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4673 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3766 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3422 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3077 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2947 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2885 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2571 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2443 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2294 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2211 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1929 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1911 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1509 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1466 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1447 | `nyc -x '' mocha` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1416 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1362 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1317 | `mocha --opts mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1275 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [google/clasp](https://github.com/google/clasp) | 1243 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [funkia/list](https://github.com/funkia/list) | 1236 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1233 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1229 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1149 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1108 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1079 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 1018 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 947 | `mocha --opts test/mocha.opts` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 938 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 929 | `mocha bin/tests/test.js` | 
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 847 | `npm run mocha` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 772 | `mocha --require ts-node/register` | 
| [coinbase/gdax-tt](https://github.com/coinbase/gdax-tt) | 738 | `yarn run lint && yarn run test:mocha` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 735 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 725 | `mocha` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 723 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 679 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
| [laoqiren/mlhelper](https://github.com/laoqiren/mlhelper) | 645 | `mocha --recursive` | 
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 635 | `mocha "out/**/*.spec.js" -s 0` | 
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 618 | `mocha lib/test/unittest.js --check-leaks --color` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 616 | `mocha test/unit` | 
...
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 586 | `nyc mocha build/test` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 586 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [bbc/sqs-consumer](https://github.com/bbc/sqs-consumer) | 574 | `mocha` | 
...
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 558 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [benjamn/ast-types](https://github.com/benjamn/ast-types) | 500 | `npm run gen && npm run build && npm run mocha` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 495 | `tsc && mocha test && yarn lint` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 488 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 476 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
| [43081j/rar.js](https://github.com/43081j/rar.js) | 462 | `npm run build && mocha` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 461 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
| [amplify-education/serverless-domain-manager](https://github.com/amplify-education/serverless-domain-manager) | 372 | `tsc --project . && nyc mocha -r ts-node/register test/unit-tests/index.test.ts && nyc report --reporter=text-summary` | 
| [Polymer/prpl-server](https://github.com/Polymer/prpl-server) | 362 | `npm run build && mocha` | 
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 354 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 353 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 331 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 324 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 323 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 316 | `mocha` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 280 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 261 | `mocha-webpack "src/**/*.ts"` | 
...
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 236 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 230 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [googleapis/nodejs-storage](https://github.com/googleapis/nodejs-storage) | 226 | `nyc mocha build/test` | 
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 221 | `nyc mocha` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 216 | `nyc mocha test/**/*.test.ts --exit` | 
| [thiagobustamante/typescript-rest](https://github.com/thiagobustamante/typescript-rest) | 215 | `cross-env NODE_ENV=test mocha --exit` | 
...
| [bmewburn/intelephense](https://github.com/bmewburn/intelephense) | 203 | `mocha -r ts-node/register test/*.ts` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 161 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [Microsoft/vscode-vsce](https://github.com/Microsoft/vscode-vsce) | 154 | `gulp compile && mocha` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 150 | `nyc --reporter=html --reporter=text mocha` | 
...
| [Half-Shot/matrix-appservice-discord](https://github.com/Half-Shot/matrix-appservice-discord) | 144 | `npm run-script build && mocha --opts test/mocha.opts build/test/config.js build/test` | 
| [martysweet/cfn-lint](https://github.com/martysweet/cfn-lint) | 143 | `mocha lib/test` | 
| [atomist/sdm](https://github.com/atomist/sdm) | 138 | `mocha --require espower-typescript/guess "test/**/*.test.ts"` | 
| [featurist/hyperdom](https://github.com/featurist/hyperdom) | 138 | `./node_modules/.bin/tsc && npm run karma && npm run mocha && eslint . && npm run tslint` | 
...
| [DotJoshJohnson/vscode-xml](https://github.com/DotJoshJohnson/vscode-xml) | 136 | `npm run compile && mocha ./out/test/**/*.js` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 132 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
...
| [nomiclabs/buidler](https://github.com/nomiclabs/buidler) | 121 | `nyc mocha` | 
...
| [redhat-developer/yaml-language-server](https://github.com/redhat-developer/yaml-language-server) | 121 | `mocha --require ts-node/register --ui tdd ./test/*.test.ts` | 
...
| [functionalone/serverless-iam-roles-per-function](https://github.com/functionalone/serverless-iam-roles-per-function) | 119 | `nyc mocha --require ts-node/register --require source-map-support/register  ./src/test/**/*.test.ts` | 
| [moodysalem/react-tournament-bracket](https://github.com/moodysalem/react-tournament-bracket) | 118 | `mocha --require ts-node/register src/**/*.test.tsx` | 
...
| [englercj/tsd-jsdoc](https://github.com/englercj/tsd-jsdoc) | 112 | `mocha --ui tdd -r ts-node/register test/specs/**.ts` | 
| [Esri/react-arcgis](https://github.com/Esri/react-arcgis) | 112 | `nyc mocha` | 
...
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 100 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
...
| [bpatrik/pigallery2](https://github.com/bpatrik/pigallery2) | 95 | `ng test && mocha --recursive test/backend/unit && mocha --recursive test/backend/integration  && mocha --recursive test/common/unit ` | 
...
| [argoproj/argo-ci](https://github.com/argoproj/argo-ci) | 93 | `TS_NODE_PROJECT=./src/tests/tsconfig.json mocha --require ts-node/register ./src/tests/**/*spec.ts` | 
| [nwtgck/piping-server](https://github.com/nwtgck/piping-server) | 93 | `mocha --require ts-node/register --timeout 10000 test/**/*.ts` | 
| [redhat-developer/vscode-yaml](https://github.com/redhat-developer/vscode-yaml) | 92 | `mocha --ui tdd out/test/extension.test.js` | 
...
| [balassy/aws-lambda-typescript](https://github.com/balassy/aws-lambda-typescript) | 90 | `nyc mocha` | 
...
| [googleapis/nodejs-bigquery](https://github.com/googleapis/nodejs-bigquery) | 87 | `nyc mocha build/test` | 
...
| [puzzle-js/puzzle-js](https://github.com/puzzle-js/puzzle-js) | 69 | `nyc --check-coverage --lines=85 cross-env NODE_ENV=production mocha -r ts-node/register  --recursive 'test/**/*.spec.ts'` | 
| [alex-okrushko/backoff-rxjs](https://github.com/alex-okrushko/backoff-rxjs) | 69 | `yarn run lint && yarn run test:build && yarn run test:mocha` | 
...
| [mshanemc/shane-sfdx-plugins](https://github.com/mshanemc/shane-sfdx-plugins) | 59 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [vechain/thorify](https://github.com/vechain/thorify) | 52 | `NODE_ENV=test mocha --require ts-node/register --timeout 20000 --recursive  --exclude './test/browser/*.ts' './**/*.test.ts'` | 
...
| [thiagobustamante/typescript-rest-swagger](https://github.com/thiagobustamante/typescript-rest-swagger) | 51 | `cross-env NODE_ENV=test mocha` | 
...
| [angular-extensions/model](https://github.com/angular-extensions/model) | 49 | `npm run lint && npm run format:test && nyc mocha {lib,schematics}/**/*.test.ts --require ts-node/register --require source-map-support/register` | 
...
| [adumont/tplink-cloud-api](https://github.com/adumont/tplink-cloud-api) | 45 | `mocha -r ts-node/register -p tsconfig.json lib/**/*.spec.ts` | 
...
| [desertkun/hiera-editor](https://github.com/desertkun/hiera-editor) | 44 | `mocha --timeout 15000 dist/tests/**/*.js` | 
