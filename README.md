...
The list was updated at 00:39:21 11/26/17 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 39237 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 9382 | `cross-env TS_NODE_FAST=true mocha --compilers ts:ts-node/register --opts spec/support/coverage.opts "spec/**/*-spec.ts"` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 3843 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 2600 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 2521 | `nyc --require ts-node/register mocha src/**/*.spec.ts --reporter spec` | 
| [Microsoft/sqlopsstudio](https://github.com/Microsoft/sqlopsstudio) | 2286 | `mocha` | 
...
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 1393 | `mocha` | 
...
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 1216 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1207 | `rimraf .test && mocha --timeout 30000 dist/__test__` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 1009 | `cross-env TS_NODE_PROJECT=test/tsconfig.json TS_NODE_DISABLE_WARNINGS=1 nyc mocha --opts test/mocha.opts` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 897 | `mocha --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 810 | `mocha --opts test/mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 787 | `mocha test/specs/**/*.ts -R spec --bail` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 767 | `nyc -c -x '' mocha ./out/test --recursive` | 
...
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 630 | `npm run prettify && mocha --require ts-node/register test/**.ts test/**/*.ts` | 
| [laoqiren/mlhelper](https://github.com/laoqiren/mlhelper) | 527 | `mocha --recursive` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 441 | `mocha bin/tests/test.js` | 
...
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 323 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 322 | `mocha --opts mocha.opts` | 
...
| [coinbase/gdax-tt](https://github.com/coinbase/gdax-tt) | 306 | `yarn run lint && yarn run test:mocha` | 
...
| [felixfbecker/vscode-php-debug](https://github.com/felixfbecker/vscode-php-debug) | 248 | `mocha out/test --timeout 20000 --slow 1000 --retries 4` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 182 | `mocha -r ts-node/register test/**.test.ts` | 
...
| [anandanand84/technicalindicators](https://github.com/anandanand84/technicalindicators) | 167 | `mocha --compilers js:babel-register --require babel-polyfill` | 
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 164 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 161 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
