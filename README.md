...
The list was updated at 01:55:35 02/10/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 68865 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16986 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12458 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10980 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7158 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6460 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5640 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4747 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4695 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4682 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3775 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3425 | `mocha --opts mocha.opts` | 
...
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2888 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2578 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2446 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2299 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2216 | `npm run tsc && npm run mocha` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1514 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1451 | `nyc -x '' mocha` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1422 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1319 | `mocha --opts mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1279 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [google/clasp](https://github.com/google/clasp) | 1253 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1109 | `nyc --reporter=html --reporter=text mocha` | 
...
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 850 | `npm run mocha` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 775 | `mocha --require ts-node/register` | 
...
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 725 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
| [angular/dgeni](https://github.com/angular/dgeni) | 715 | `mocha --require ts-node/register -R spec src/**/*.spec.ts` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 703 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 626 | `mocha test/unit` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 589 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 579 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 501 | `tsc && mocha test && yarn lint` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 463 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 354 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 315 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 282 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 258 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 234 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [nwtgck/piping-server](https://github.com/nwtgck/piping-server) | 178 | `mocha --require ts-node/register --timeout 10000 test/**/*.ts` | 
...
| [nomiclabs/buidler](https://github.com/nomiclabs/buidler) | 127 | `nyc mocha` | 
...
| [AkashaProject/ipfs-connector](https://github.com/AkashaProject/ipfs-connector) | 97 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/.bin/_mocha  ./tests.js` | 
...
| [teamdomy/domy](https://github.com/teamdomy/domy) | 67 | `mocha --reporter spec --require ts-node/register 'tests/**/*.spec.ts'` | 
...
| [JustinBeckwith/retry-axios](https://github.com/JustinBeckwith/retry-axios) | 54 | `nyc mocha build/test --timeout 5000 --require source-map-support/register` | 
...
| [thiagobustamante/typescript-rest-swagger](https://github.com/thiagobustamante/typescript-rest-swagger) | 52 | `cross-env NODE_ENV=test mocha` | 
...
| [dalenguyen/firestore-backup-restore](https://github.com/dalenguyen/firestore-backup-restore) | 51 | `mocha --timeout 99999999 --exit -r ts-node/register test/**/*.spec.ts` | 
