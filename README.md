...
The list was updated at 01:56:59 03/27/19 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 72213 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17657 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13900 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11933 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7305 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6721 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5884 | `npm run mocha` | 
| [peers/peerjs](https://github.com/peers/peerjs) | 5763 | `mocha -r ts-node/register -r jsdom-global/register test/**/*.ts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 5108 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts && npm run test:packages` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4897 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4888 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4255 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3463 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3404 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3165 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [retejs/rete](https://github.com/retejs/rete) | 2991 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2931 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2733 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts'` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2469 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2393 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2308 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1984 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1953 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1814 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1811 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 1756 | `mocha test/unit` | 
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1626 | `COLYSEUS_PRESENCE_SHORT_TIMEOUT=300 mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1601 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1553 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1526 | `nyc -x '' mocha` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1524 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1471 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1387 | `mocha --opts mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 1382 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1284 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [google/gts](https://github.com/google/gts) | 1222 | `nyc mocha build/test` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1196 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1134 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1128 | `tsc -p ./ && mocha` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 1009 | `mocha bin/tests/test.js` | 
| [youzan/zan-proxy](https://github.com/youzan/zan-proxy) | 1004 | `nyc mocha dist/**/*.spec.js` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 991 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 964 | `mocha --opts test/mocha.opts` | 
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 901 | `npm run mocha` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 820 | `mocha --require ts-node/register` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 740 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 668 | `mocha "out/**/*.spec.js" -s 0` | 
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 654 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [szokodiakos/typegoose](https://github.com/szokodiakos/typegoose) | 629 | `npm run lint && nyc npm run mocha` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 625 | `nyc mocha build/test` | 
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 625 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 617 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 613 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 612 | `mocha --opts ./src/test/mocha.opts` | 
| [bbc/sqs-consumer](https://github.com/bbc/sqs-consumer) | 603 | `mocha` | 
...
| [pgilad/leasot](https://github.com/pgilad/leasot) | 591 | `mocha --require ts-node/register -R spec './tests/*.ts'` | 
| [emilioastarita/lyricfier](https://github.com/emilioastarita/lyricfier) | 567 | `mocha` | 
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 564 | `mocha test` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 564 | `tsc && mocha test && yarn lint` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 549 | `cd test && mocha -r ts-node/register *.ts` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 543 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 526 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
| [benjamn/ast-types](https://github.com/benjamn/ast-types) | 515 | `npm run gen && npm run build && npm run mocha` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 515 | `mocha --opts mocha.opts` | 
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 514 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 510 | `npm run mocha` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 502 | `npm run lint && npm run mocha` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 432 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
| [felixfbecker/vscode-php-debug](https://github.com/felixfbecker/vscode-php-debug) | 415 | `mocha out/test --timeout 20000 --slow 1000 --retries 4` | 
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 400 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 377 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 350 | `mocha` | 
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 342 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [alibaba/pont](https://github.com/alibaba/pont) | 332 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 331 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 328 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 321 | `cd test && mocha -r ts-node/register *.ts` | 
| [mgechev/aspect.js](https://github.com/mgechev/aspect.js) | 305 | `tsc && mocha -R nyan ./dist/test/**/*.spec.js` | 
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 304 | `mocha-webpack "src/**/*.ts"` | 
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 304 | `mocha lib/test` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 295 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 268 | `nyc mocha` | 
...
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 256 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [harttle/liquidjs](https://github.com/harttle/liquidjs) | 235 | `npm run build && mocha "test/**/*.ts"` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 177 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [ConquestArrow/dtsmake](https://github.com/ConquestArrow/dtsmake) | 155 | `mocha --compilers ts:ts-node/register test/*.ts` | 
...
| [Soluto/graphql-to-mongodb](https://github.com/Soluto/graphql-to-mongodb) | 147 | `ts-mocha tests/**/*.spec.ts` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 145 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 143 | `mocha` | 
...
| [redhat-developer/yaml-language-server](https://github.com/redhat-developer/yaml-language-server) | 138 | `mocha --require ts-node/register --ui tdd ./test/*.test.ts` | 
...
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 136 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
| [AzureAD/azure-activedirectory-library-for-nodejs](https://github.com/AzureAD/azure-activedirectory-library-for-nodejs) | 136 | `npm run tsc && mocha -R spec --ui tdd test` | 
...
| [matthew-matvei/freeman](https://github.com/matthew-matvei/freeman) | 132 | `xvfb-maybe electron-mocha --renderer __tests__` | 
...
| [Esri/react-arcgis](https://github.com/Esri/react-arcgis) | 127 | `nyc mocha` | 
...
| [wbhob/nest-middlewares](https://github.com/wbhob/nest-middlewares) | 101 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
...
| [puzzle-js/puzzle-js](https://github.com/puzzle-js/puzzle-js) | 99 | `nyc --check-coverage --lines=85 cross-env NODE_ENV=production mocha -r ts-node/register  --recursive 'test/**/*.spec.ts'` | 
...
| [sunzongzheng/musicApi](https://github.com/sunzongzheng/musicApi) | 98 | `mocha -t 30000 --require @babel/register 'test/*.test.js' --exit` | 
...
| [Cody2333/koa-swagger-decorator](https://github.com/Cody2333/koa-swagger-decorator) | 89 | `./node_modules/mocha/bin/mocha -r babel-core/register test/**/*.js --bail -t 2000000` | 
...
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 89 | `npm run build && npx nyc --reporter=html mocha --timeout 0 --recursive out/test.js && lua tests/spec.lua` | 
| [ui-jar/ui-jar](https://github.com/ui-jar/ui-jar) | 87 | `tsc && mocha "dist/test/**/*.js" ` | 
| [gcanti/elm-ts](https://github.com/gcanti/elm-ts) | 87 | `npm run lint && npm run mocha && npm run docs` | 
...
| [gcanti/hyper-ts](https://github.com/gcanti/hyper-ts) | 70 | `npm run prettier && npm run lint && npm run typings-checker && npm run mocha` | 
...
| [matthiasferch/tsm](https://github.com/matthiasferch/tsm) | 67 | `mocha -r ts-node/register test/**/*.spec.ts` | 
...
| [waitingsong/node-win32-api](https://github.com/waitingsong/node-win32-api) | 64 | `mocha --opts test/mocha.opts` | 
...
| [demipixel/factorio-blueprint](https://github.com/demipixel/factorio-blueprint) | 63 | `mocha` | 
...
| [mike-lischke/antlr4-c3](https://github.com/mike-lischke/antlr4-c3) | 62 | `tsc --version && tsc && mocha out/test` | 
...
| [eclipse/sprotty](https://github.com/eclipse/sprotty) | 51 | `jenkins-mocha --opts ./configs/mocha.opts "./src/**/*.spec.?(ts|tsx)"` | 
...
| [olivierlsc/swagger-express-ts](https://github.com/olivierlsc/swagger-express-ts) | 46 | `echo "Testing..." && npm run build && nyc mocha` | 
...
| [lolamtisch/MALSync](https://github.com/lolamtisch/MALSync) | 45 | `webpack --config webpackConfig/test.config.js && mocha --recursive --timeout 30000 --retries 2 test/headless` | 
...
| [aleris/zxing-typescript](https://github.com/aleris/zxing-typescript) | 42 | `mocha --compilers js:babel-core/register "build-node/test/core/**/*.js" --timeout 30000 --colors` | 
...
| [home-assistant/home-assistant-js-websocket](https://github.com/home-assistant/home-assistant-js-websocket) | 40 | `mocha test/*.spec.ts` | 
