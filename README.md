...
The list was updated at 01:55:05 12/16/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 65723 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16254 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10956 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9703 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6980 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6150 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5268 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4586 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4377 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3875 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3376 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2825 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2737 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
...
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2403 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1862 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1861 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1364 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1361 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1203 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1188 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1179 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha test/**/*.ts -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [itchio/itch](https://github.com/itchio/itch) | 966 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 930 | `mocha --opts test/mocha.opts` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 901 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 539 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 392 | `mocha test/unit` | 
...
| [Zarel/Pokemon-Showdown-Client](https://github.com/Zarel/Pokemon-Showdown-Client) | 198 | `eslint --config=.eslintrc.js --cache --cache-file=eslint-cache/base js/ data/ && eslint --config=build-tools/.eslintrc.js --cache --cache-file=eslint-cache/build build-tools/update build-tools/build-indexes && tsc && node build && mocha` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 282 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 237 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 223 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
| [renke/import-sort](https://github.com/renke/import-sort) | 221 | `mocha --require ts-node/register --recursive "packages/*/test/**/*.ts"` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 220 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 156 | `nyc mocha` | 
...
| [nodejs/llhttp](https://github.com/nodejs/llhttp) | 153 | `npm run mocha && npm run lint` | 
...
| [Microsoft/monaco-languages](https://github.com/Microsoft/monaco-languages) | 120 | `mocha` | 
...
| [stardust-ui/react](https://github.com/stardust-ui/react) | 120 | `$(npm bin)/mocha test/*.ts --require ts-node/register --recursive` | 
...
| [cyclejs/react](https://github.com/cyclejs/react) | 107 | `$(npm bin)/mocha test/*.ts --require ts-node/register --recursive` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 104 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 103 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 103 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 71 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
