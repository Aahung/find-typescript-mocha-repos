...
The list was updated at 01:56:26 03/26/19 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 72146 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17634 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13840 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11904 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7297 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6714 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5882 | `npm run mocha` | 
| [peers/peerjs](https://github.com/peers/peerjs) | 5760 | `mocha -r ts-node/register -r jsdom-global/register test/**/*.ts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 5094 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts && npm run test:packages` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4891 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4884 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4251 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3463 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3399 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3155 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [retejs/rete](https://github.com/retejs/rete) | 2989 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2930 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2730 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts'` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2468 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2390 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2305 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1980 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1815 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1806 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1623 | `COLYSEUS_PRESENCE_SHORT_TIMEOUT=300 mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1598 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1549 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1526 | `nyc -x '' mocha` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1522 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
...
| [google/clasp](https://github.com/google/clasp) | 1379 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 1364 | `mocha test/unit` | 
...
| [google/gts](https://github.com/google/gts) | 1219 | `nyc mocha build/test` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 1008 | `mocha bin/tests/test.js` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 819 | `mocha --require ts-node/register` | 
...
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 739 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 548 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 525 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 513 | `mocha --opts mocha.opts` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 397 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
...
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 340 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [alibaba/pont](https://github.com/alibaba/pont) | 331 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 330 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 325 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 319 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 303 | `mocha-webpack "src/**/*.ts"` | 
...
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 262 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
...
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 254 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [harttle/liquidjs](https://github.com/harttle/liquidjs) | 233 | `npm run build && mocha "test/**/*.ts"` | 
...
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 220 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [funkia/hareactive](https://github.com/funkia/hareactive) | 198 | `nyc mocha --recursive test/**/*.ts` | 
...
| [arfedulov/semantic-ui-calendar-react](https://github.com/arfedulov/semantic-ui-calendar-react) | 149 | `npx cross-env TS_NODE_COMPILER_OPTIONS="{""allowJs"":true}" npx mocha -r ts-node/register ./test/setup.js ./test/**/*.{js,jsx,ts,tsx}` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 144 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [wbhob/nest-middlewares](https://github.com/wbhob/nest-middlewares) | 99 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
...
| [sunzongzheng/musicApi](https://github.com/sunzongzheng/musicApi) | 96 | `mocha -t 30000 --require @babel/register 'test/*.test.js' --exit` | 
...
| [metadevpro/openapi3-ts](https://github.com/metadevpro/openapi3-ts) | 88 | `mocha --recursive --compilers ts:ts-node/register --require source-map-support/register "src/**/*.spec.ts"` | 
...
| [gcanti/hyper-ts](https://github.com/gcanti/hyper-ts) | 67 | `npm run prettier && npm run lint && npm run typings-checker && npm run mocha` | 
...
| [longlho/ts-transform-css-modules](https://github.com/longlho/ts-transform-css-modules) | 59 | `rm -rf test/fixture/*.js && mocha --require ts-node/register --recursive  test/**/*.test.ts` | 
