...
The list was updated at 00:43:26 01/23/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 42627 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 10389 | `cross-env TS_NODE_FAST=true mocha --compilers ts:ts-node/register --opts spec/support/coverage.opts "spec/**/*-spec.ts"` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 4130 | `mocha` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 3420 | `nyc --require ts-node/register mocha src/**/*.spec.ts --reporter spec` | 
| [Microsoft/sqlopsstudio](https://github.com/Microsoft/sqlopsstudio) | 3011 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 2813 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2270 | `mocha 'test/**/*.ts'` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2009 | `mocha` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1737 | `mocha` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1503 | `rimraf dist && tsc && cp -r test/fixtures dist/test && mocha dist/test --recursive` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 1410 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1389 | `npm run lint && npm run mocha && npm run doctest` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1308 | `rimraf .test && mocha --timeout 30000 dist/__test__` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 1228 | `cross-env TS_NODE_PROJECT=test/tsconfig.json TS_NODE_DISABLE_WARNINGS=1 nyc mocha --opts test/mocha.opts` | 
...
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 994 | `npm run prettify && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
...
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 794 | `mocha --require ts-node/register test/**Test.ts` | 
...
| [hacksparrow/node-easyimage](https://github.com/hacksparrow/node-easyimage) | 557 | `npm run lint && npm run mocha` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 511 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 494 | `mocha bin/tests/test.js` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 487 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
...
| [midwayjs/pandora](https://github.com/midwayjs/pandora) | 452 | `mocha` | 
...
| [Microsoft/BotFramework-WebChat](https://github.com/Microsoft/BotFramework-WebChat) | 368 | `concurrently  "node test/mock_dl/index.js" "mocha test" ` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 347 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 336 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
...
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 327 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit --reporter nyan` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 324 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [google/google-auth-library-nodejs](https://github.com/google/google-auth-library-nodejs) | 306 | `nyc mocha build/test` | 
...
| [felixfbecker/vscode-php-debug](https://github.com/felixfbecker/vscode-php-debug) | 267 | `mocha out/test --timeout 20000 --slow 1000 --retries 4` | 
...
| [anandanand84/technicalindicators](https://github.com/anandanand84/technicalindicators) | 260 | `mocha --compilers js:babel-register --require keras-js` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 248 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 mocha -r ts-node/register test/*.spec.ts` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 193 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 179 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [chbrown/rfc6902](https://github.com/chbrown/rfc6902) | 86 | `istanbul cover _mocha -- tests/ -R spec` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 55 | `yarn run lint && yarn run test:build && mocha build/fixtures-spec.js` | 
...
| [martysweet/cfn-lint](https://github.com/martysweet/cfn-lint) | 51 | `mocha lib/test` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 36 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [OmniSharp/omnisharp-node-client](https://github.com/OmniSharp/omnisharp-node-client) | 30 | `tsc && npm run lint && mocha` | 
...
| [jvilk/MakeTypes](https://github.com/jvilk/MakeTypes) | 24 | `npm-run-all --serial prepublish generate:test build:test mocha` | 
...
| [microsoftly/BotTester](https://github.com/microsoftly/BotTester) | 22 | `node_modules/mocha/bin/_mocha --require node_modules/ts-node/register test/*.spec.ts` | 
...
| [RxLeanCloud/rx-lean-js-core](https://github.com/RxLeanCloud/rx-lean-js-core) | 20 | `node out/test/utils/init.js && mocha --timeout 30000 $(find out/test -name '*.js')` | 
