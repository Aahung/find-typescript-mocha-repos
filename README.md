...
The list was updated at 01:55:51 12/27/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 66314 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16396 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11263 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9926 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7003 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6229 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5351 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4612 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4440 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3969 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3387 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2840 | `mocha` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2792 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2783 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2432 | `mocha 'test/**/*.ts'` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2427 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1874 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [staltz/xstream](https://github.com/staltz/xstream) | 1750 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1422 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1403 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1377 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1285 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1250 | `mocha --opts mocha.opts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1246 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1197 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [google/clasp](https://github.com/google/clasp) | 1117 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 915 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 593 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 557 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 514 | `mocha test/unit` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 492 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 455 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 351 | `tsc && mocha test && yarn lint` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 287 | `mocha` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 145 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 114 | `mocha` | 
...
| [googleapis/nodejs-pubsub](https://github.com/googleapis/nodejs-pubsub) | 89 | `nyc mocha build/test` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 82 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [Cody2333/koa-swagger-decorator](https://github.com/Cody2333/koa-swagger-decorator) | 74 | `./node_modules/mocha/bin/mocha -r babel-core/register test/**/*.js --bail -t 2000000` | 
...
| [rpgeeganage/async-ray](https://github.com/rpgeeganage/async-ray) | 60 | `nyc mocha` | 
...
| [camesine/Typescript-restful-starter](https://github.com/camesine/Typescript-restful-starter) | 43 | `cross-env NODE_ENV=test mocha test/**/*.ts` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 41 | `ttsc --project tsconfig-test.json && mocha` | 
