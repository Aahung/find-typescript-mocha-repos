...
The list was updated at 01:55:32 02/02/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 68352 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16907 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12229 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10770 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7116 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6399 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5612 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4686 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4651 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4511 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3747 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3418 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3073 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2932 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2878 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2547 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
...
| [benjamn/recast](https://github.com/benjamn/recast) | 2206 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1923 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [staltz/xstream](https://github.com/staltz/xstream) | 1781 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1502 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1428 | `nyc -x '' mocha` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1392 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1353 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1293 | `mocha --opts mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1271 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [funkia/list](https://github.com/funkia/list) | 1233 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
...
| [google/clasp](https://github.com/google/clasp) | 1223 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1075 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 1014 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 947 | `mocha --opts test/mocha.opts` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 934 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 924 | `mocha bin/tests/test.js` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 730 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 728 | `mocha` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 720 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 629 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 610 | `mocha test/unit` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 591 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 586 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 583 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 570 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 553 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 486 | `tsc && mocha test && yarn lint` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 481 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 478 | `cd test && mocha -r ts-node/register *.ts` | 
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 473 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 351 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [arangodb/arangojs](https://github.com/arangodb/arangojs) | 347 | `mocha --growl --reporter spec --require source-map-support/register --timeout 10000 lib/async/test` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 276 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 255 | `mocha-webpack "src/**/*.ts"` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 215 | `nyc mocha` | 
...
| [jedmao/eclint](https://github.com/jedmao/eclint) | 208 | `nyc npm run mocha -- --reporter lcov --reporter spec` | 
...
| [bmewburn/intelephense](https://github.com/bmewburn/intelephense) | 201 | `mocha -r ts-node/register test/*.ts` | 
| [zekelevu/typeframework](https://github.com/zekelevu/typeframework) | 200 | `mocha -R spec test/integration` | 
| [Polymer/polyserve](https://github.com/Polymer/polyserve) | 197 | `npm run build && mocha && tslint "src/**/*.ts"` | 
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 194 | `nyc mocha test/**/*.test.ts --exit` | 
...
| [pnp/office365-cli](https://github.com/pnp/office365-cli) | 181 | `nyc -r=lcov -r=text mocha "dist/**/*.spec.js"` | 
...
| [nodejs/llhttp](https://github.com/nodejs/llhttp) | 164 | `npm run mocha && npm run lint` | 
...
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 153 | `tsc && mocha` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 149 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
| [jgranstrom/zipson](https://github.com/jgranstrom/zipson) | 149 | `mocha --require ts-node/register --watch-extensions ts 'test/**/*.ts'` | 
...
| [Enterprise-JS/vscode-ts-node-debugging](https://github.com/Enterprise-JS/vscode-ts-node-debugging) | 134 | `npm run mocha --recursive ./src/**/__tests__/*` | 
...
| [googleapis/nodejs-pubsub](https://github.com/googleapis/nodejs-pubsub) | 102 | `nyc mocha build/test` | 
...
| [bpatrik/pigallery2](https://github.com/bpatrik/pigallery2) | 93 | `ng test && mocha --recursive test/backend/unit && mocha --recursive test/backend/integration  && mocha --recursive test/common/unit ` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 86 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
...
| [googleapis/nodejs-datastore](https://github.com/googleapis/nodejs-datastore) | 76 | `nyc mocha build/test` | 
...
| [timocov/dts-bundle-generator](https://github.com/timocov/dts-bundle-generator) | 75 | `mocha --timeout 10000 --slow 2500 tests/unittests/**/*.spec.js tests/functional-test-cases.js` | 
| [troch/path-parser](https://github.com/troch/path-parser) | 75 | `mocha -r ts-node/register 'test/main.js'` | 
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 75 | `nyc --reporter=html mocha --timeout 0 --require ts-node/register --require source-map-support/register --recursive src/test.ts && lua tests/spec.lua` | 
...
| [TonyRobotics/RoboWare-Studio](https://github.com/TonyRobotics/RoboWare-Studio) | 61 | `mocha` | 
...
| [angular-extensions/model](https://github.com/angular-extensions/model) | 44 | `npm run lint && npm run format:test && nyc mocha {lib,schematics}/**/*.test.ts --require ts-node/register --require source-map-support/register` | 
