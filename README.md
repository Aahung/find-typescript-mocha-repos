...
The list was updated at 01:55:38 11/11/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 63662 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15687 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9934 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9094 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8310 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6914 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6006 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5071 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4497 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4185 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3346 | `mocha --opts mocha.opts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2922 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2787 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2567 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2417 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2378 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2117 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1810 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1793 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1700 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1529 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1367 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1322 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1273 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1159 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1156 | `mocha --opts mocha.opts` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1107 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [google/clasp](https://github.com/google/clasp) | 985 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 500 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 426 | `cross-env NODE_ENV=test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 413 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 273 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 268 | `mocha test` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 251 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [Talento90/typescript-node](https://github.com/Talento90/typescript-node) | 144 | `npm run build && mocha --exit --recursive dist/test/unit` | 
...
| [IBM/Decentralized-Energy-Composer](https://github.com/IBM/Decentralized-Energy-Composer) | 102 | `mocha --recursive -t 4000` | 
...
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 101 | `mocha` | 
...
| [atomist/sdm](https://github.com/atomist/sdm) | 90 | `mocha --require espower-typescript/guess --require source-map-support/register "test/**/*.test.ts"` | 
...
| [argoproj/argo-ci](https://github.com/argoproj/argo-ci) | 65 | `TS_NODE_PROJECT=./src/tests/tsconfig.json mocha --require ts-node/register ./src/tests/**/*spec.ts` | 
...
| [adrien2p/nestjs-graphql](https://github.com/adrien2p/nestjs-graphql) | 63 | `mocha -r ts-node/register src/**/tests/*.ts` | 
...
| [indutny/llhttp](https://github.com/indutny/llhttp) | 53 | `npm run mocha && npm run lint` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 46 | `mocha` | 
...
| [alexeagle/tsetse](https://github.com/alexeagle/tsetse) | 27 | `tsc && mocha built/test/*.js` | 
...
| [Pravez/ReImproveJS](https://github.com/Pravez/ReImproveJS) | 27 | `mocha --reporter spec --compilers ts:ts-node/register 'test/*.spec.ts' --timeout 120000` | 
| [ngduc/node-rem](https://github.com/ngduc/node-rem) | 27 | `cross-env NODE_ENV=test nyc --reporter=html --reporter=text --reporter=lcov mocha --compilers ts:ts-node/register --full-trace --bail --timeout 20000 tests/**/*.ts` | 
...
| [ProjectOpenSea/opensea-js](https://github.com/ProjectOpenSea/opensea-js) | 26 | `./node_modules/.bin/mocha test/*.ts --require ts-node/register --timeout 10000` | 