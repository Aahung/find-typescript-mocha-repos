...
The list was updated at 01:55:43 11/14/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 63832 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15733 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10035 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9145 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8360 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6917 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6012 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5083 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4498 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4197 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3350 | `mocha --opts mocha.opts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2999 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2791 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2582 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2418 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2403 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2122 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1837 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1817 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1546 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1372 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1330 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1277 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1164 | `mocha --opts mocha.opts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1163 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1118 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1110 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1085 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1081 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1017 | `tsc -p ./ && mocha` | 
| [google/clasp](https://github.com/google/clasp) | 1000 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 824 | `mocha bin/tests/test.js` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 755 | `mocha test/backend` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 691 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 650 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 435 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 431 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 427 | `cross-env NODE_ENV=test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 410 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 383 | `cd test && mocha -r ts-node/register *.ts` | 
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 380 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 296 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 294 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
...
| [mgechev/aspect.js](https://github.com/mgechev/aspect.js) | 277 | `tsc && mocha -R nyan ./dist/test/**/*.spec.js` | 
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 277 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 274 | `mocha test` | 
...
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 271 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 252 | `mocha` | 
...
| [renke/import-sort](https://github.com/renke/import-sort) | 217 | `mocha --require ts-node/register --recursive "packages/*/test/**/*.ts"` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 206 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [HerringtonDarkholme/av-ts](https://github.com/HerringtonDarkholme/av-ts) | 200 | `mocha dist/test.js` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 197 | `mocha-webpack "src/**/*.ts"` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 181 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 179 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [drew-y/cliffy](https://github.com/drew-y/cliffy) | 160 | `tsc && cd dist && mocha` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 145 | `mocha test/unit` | 
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 145 | `nyc mocha` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 136 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [martysweet/cfn-lint](https://github.com/martysweet/cfn-lint) | 134 | `mocha lib/test` | 
...
| [Half-Shot/matrix-appservice-discord](https://github.com/Half-Shot/matrix-appservice-discord) | 120 | `npm run-script build && mocha --opts test/mocha.opts build/test/config.js build/test` | 
...
| [Enterprise-JS/vscode-ts-node-debugging](https://github.com/Enterprise-JS/vscode-ts-node-debugging) | 114 | `npm run mocha --recursive ./src/**/__tests__/*` | 
...
| [toolness/p5.js-widget](https://github.com/toolness/p5.js-widget) | 105 | `webpack && mocha-phantomjs test/index.html` | 
| [IBM/Decentralized-Energy-Composer](https://github.com/IBM/Decentralized-Energy-Composer) | 104 | `mocha --recursive -t 4000` | 
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 103 | `mocha` | 
...
| [matthew-matvei/freeman](https://github.com/matthew-matvei/freeman) | 96 | `xvfb-maybe electron-mocha --renderer __tests__` | 
...
| [nicksenger/react-arcgis](https://github.com/nicksenger/react-arcgis) | 95 | `nyc mocha` | 
...
| [dsherret/ts-nameof](https://github.com/dsherret/ts-nameof) | 88 | `yarn run --silent copy-test-files && nyc --reporter=lcov mocha --opts mocha.opts` | 
...
| [CityOfZion/neo-js](https://github.com/CityOfZion/neo-js) | 75 | `mocha --reporter spec` | 
...
| [httptoolkit/mockttp](https://github.com/httptoolkit/mockttp) | 74 | `npm run build && npm run test:mocha && npm run test:browser` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 63 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [alex-okrushko/backoff-rxjs](https://github.com/alex-okrushko/backoff-rxjs) | 54 | `mocha --opts spec/mocha.opts spec/**/*-spec.ts` | 
...
| [timocov/dts-bundle-generator](https://github.com/timocov/dts-bundle-generator) | 54 | `mocha --timeout 10000 --slow 2500 tests/unittests/**/*.spec.js tests/functional-test-cases.js` | 
...
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 44 | `nyc --reporter=html mocha --timeout 0 --require ts-node/register --require source-map-support/register --recursive src/test.ts` | 
...
| [ashleydavis/grademark](https://github.com/ashleydavis/grademark) | 39 | `nyc mocha --opts ./src/test/mocha.opts` | 
