...
The list was updated at 01:56:20 01/28/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 68061 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16830 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12073 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10638 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7093 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6372 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5574 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4678 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4620 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4445 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3525 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3412 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3037 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2908 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2870 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2534 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2443 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2273 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1898 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [google/clasp](https://github.com/google/clasp) | 1211 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 919 | `mocha bin/tests/test.js` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1136 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1106 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1068 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 1012 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
...
| [pgilad/leasot](https://github.com/pgilad/leasot) | 580 | `mocha --require ts-node/register -R spec './tests/*.ts'` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 564 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 492 | `mocha --opts mocha.opts` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 477 | `tsc && mocha test && yarn lint` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 470 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 427 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 334 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [worr/node-imdb-api](https://github.com/worr/node-imdb-api) | 272 | `nyc --require ts-node/register --reporter=lcov node_modules/mocha/bin/mocha test/*.ts` | 
| [albburtsev/bem-cn](https://github.com/albburtsev/bem-cn) | 267 | `mocha src/**/*.spec.ts` | 
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 266 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
...
| [SpoonX/wetland](https://github.com/SpoonX/wetland) | 244 | `mocha dist/test/helper dist/test/unit/{*.spec.js,**/*.spec.js} --timeout 15000` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 210 | `nyc mocha` | 
...
| [pnp/office365-cli](https://github.com/pnp/office365-cli) | 179 | `nyc -r=lcov -r=text mocha "dist/**/*.spec.js"` | 
| [ohjames/rxjs-websockets](https://github.com/ohjames/rxjs-websockets) | 179 | `npm run build && npm run mocha` | 
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 178 | `nyc mocha test/**/*.test.ts --exit` | 
...
| [Microsoft/vscode-vsce](https://github.com/Microsoft/vscode-vsce) | 150 | `gulp compile && mocha` | 
...
| [colyseus/colyseus.js](https://github.com/colyseus/colyseus.js) | 125 | `mocha test/*.ts --require ts-node/register` | 
...
| [matthew-matvei/freeman](https://github.com/matthew-matvei/freeman) | 120 | `xvfb-maybe electron-mocha --renderer __tests__` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 108 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [Azure/azure-cosmos-js](https://github.com/Azure/azure-cosmos-js) | 85 | `mocha -r ./src/test/common/setup.ts ./lib/src/test/ --recursive --timeout 100000 -i -g .*ignore.js` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 69 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
...
| [ninoseki/mitaka](https://github.com/ninoseki/mitaka) | 68 | `nyc mocha -r ts-node/register "src/**/*.spec.ts"` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 48 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
...
| [Microsoft/vscode-html-languageservice](https://github.com/Microsoft/vscode-html-languageservice) | 43 | `npm run compile && mocha && npm run lint` | 
