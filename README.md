...
The list was updated at 01:55:36 11/06/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 63385 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15615 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9808 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9012 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8274 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6901 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5987 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5041 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4484 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4153 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3342 | `mocha --opts mocha.opts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2866 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2782 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2544 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2412 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2342 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2103 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1802 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1492 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1315 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1261 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1151 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1147 | `mocha --opts mocha.opts` | 
...
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1101 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1083 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [google/clasp](https://github.com/google/clasp) | 969 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [itchio/itch](https://github.com/itchio/itch) | 938 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 916 | `mocha --opts test/mocha.opts` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 877 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 678 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 675 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 638 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 566 | `mocha lib/test/unittest.js --check-leaks --color` | 
| [emilioastarita/lyricfier](https://github.com/emilioastarita/lyricfier) | 547 | `mocha` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 541 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 500 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 433 | `npm run mocha` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 427 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 424 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 376 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 372 | `cd test && mocha -r ts-node/register *.ts` | 
| [R-js/libRmath.js](https://github.com/R-js/libRmath.js) | 365 | `cross-env-shell NODE_ENV=test TS_NODE_DISABLE_WARNINGS=true nyc mocha` | 
...
| [arangodb/arangojs](https://github.com/arangodb/arangojs) | 326 | `mocha --growl --reporter spec --require source-map-support/register --timeout 10000 lib/async/test` | 
...
| [SpoonX/wetland](https://github.com/SpoonX/wetland) | 236 | `mocha dist/test/helper dist/test/unit/{*.spec.js,**/*.spec.js} --timeout 15000` | 
| [liangzeng/cqrs](https://github.com/liangzeng/cqrs) | 231 | `tsc && mocha` | 
| [FormidableLabs/inspectpack](https://github.com/FormidableLabs/inspectpack) | 228 | `mocha "test/**/*.spec.ts"` | 
...
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 225 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 197 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [R-js/blasjs](https://github.com/R-js/blasjs) | 185 | `cross-env-shell NODE_ENV=test TS_NODE_DISABLE_WARNINGS=true nyc mocha` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 178 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
| [funkia/hareactive](https://github.com/funkia/hareactive) | 174 | `nyc mocha --recursive test/**/*.ts` | 
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 173 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 136 | `nyc mocha` | 
...
| [Half-Shot/matrix-appservice-discord](https://github.com/Half-Shot/matrix-appservice-discord) | 118 | `npm run-script build && mocha --opts test/mocha.opts build/test` | 
...
| [secret-tech/backend-ico-dashboard](https://github.com/secret-tech/backend-ico-dashboard) | 93 | `nyc mocha ./src/**/*.spec.ts --require test/prepare.ts` | 
...
| [inversify/inversify-express-example](https://github.com/inversify/inversify-express-example) | 91 | `nyc --clean --all --require ts-node/register --require reflect-metadata/Reflect --extension .ts -- mocha --exit --timeout 5000` | 
...
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 85 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
...
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 76 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
...
| [indutny/llparse](https://github.com/indutny/llparse) | 70 | `npm run mocha && npm run lint` | 
...
| [puzzle-js/PuzzleJs](https://github.com/puzzle-js/PuzzleJs) | 58 | `nyc --check-coverage --lines=85 cross-env NODE_ENV=production mocha -r ts-node/register  --recursive 'test/**/*.spec.ts'` | 
...
| [indutny/llhttp](https://github.com/indutny/llhttp) | 46 | `npm run mocha && npm run lint` | 
| [TonyRobotics/RoboWare-Studio](https://github.com/TonyRobotics/RoboWare-Studio) | 45 | `mocha` | 
| [mshanemc/shane-sfdx-plugins](https://github.com/mshanemc/shane-sfdx-plugins) | 45 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [Microsoft/node-jsonc-parser](https://github.com/Microsoft/node-jsonc-parser) | 43 | `npm run compile && mocha` | 
...
| [googleapis/nodejs-spanner](https://github.com/googleapis/nodejs-spanner) | 38 | `nyc mocha build/test` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 37 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
| [OmniSharp/omnisharp-node-client](https://github.com/OmniSharp/omnisharp-node-client) | 37 | `tsc && npm run lint && mocha` | 
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 37 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [ethereum-ts/evm-ts](https://github.com/ethereum-ts/evm-ts) | 36 | `yarn lint && yarn test:mocha` | 
...
| [lazerwalker/storyboard](https://github.com/lazerwalker/storyboard) | 28 | `mocha-webpack tests` | 
...
| [Webtomizer/typeorm-loader](https://github.com/Webtomizer/typeorm-loader) | 27 | `npm run build && [ -d tests ] && NODE_ENV=test mocha $NODE_DEBUG_OPTION -r ts-node/register -r tslib tests/test_**.ts` | 
