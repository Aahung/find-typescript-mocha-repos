...
The list was updated at 01:56:40 03/06/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 70306 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17301 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13177 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11509 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7238 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6595 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5775 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4993 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4790 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4766 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4129 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3445 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3259 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3052 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [retejs/rete](https://github.com/retejs/rete) | 2933 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2924 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2670 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts'` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2461 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2346 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2268 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1959 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1936 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1811 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1797 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1570 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1528 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1494 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1492 | `nyc -x '' mocha` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1463 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1361 | `mocha --opts mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 1338 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1307 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1264 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1176 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1127 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1111 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 1032 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 967 | `mocha bin/tests/test.js` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 957 | `mocha --opts test/mocha.opts` | 
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 880 | `npm run mocha` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 798 | `mocha --require ts-node/register` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 729 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
| [angular/dgeni](https://github.com/angular/dgeni) | 718 | `mocha --require ts-node/register -R spec src/**/*.spec.ts` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 700 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 666 | `mocha test/unit` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 643 | `mocha lib/test/unittest.js --check-leaks --color` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 623 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 609 | `nyc mocha build/test` | 
| [szokodiakos/typegoose](https://github.com/szokodiakos/typegoose) | 607 | `npm run lint && nyc npm run mocha` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 604 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 603 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 600 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [bbc/sqs-consumer](https://github.com/bbc/sqs-consumer) | 591 | `mocha` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 545 | `tsc && mocha test && yarn lint` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 527 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 520 | `cd test && mocha -r ts-node/register *.ts` | 
| [benjamn/ast-types](https://github.com/benjamn/ast-types) | 508 | `npm run gen && npm run build && npm run mocha` | 
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 507 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 507 | `mocha --opts mocha.opts` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 501 | `npm run mocha` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 498 | `npm run lint && npm run mocha` | 
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 496 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 493 | `mocha --opts mocha.opts` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 481 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 442 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
...
| [amplify-education/serverless-domain-manager](https://github.com/amplify-education/serverless-domain-manager) | 388 | `tsc --project . && nyc mocha -r ts-node/register test/unit-tests/index.test.ts && nyc report --reporter=text-summary` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 354 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 343 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 331 | `mocha` | 
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 326 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
...
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 318 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 304 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
| [alexcambose/motus](https://github.com/alexcambose/motus) | 301 | `cross-env mocha -r ts-node/register 'test/**/*.spec.ts'` | 
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 299 | `mocha lib/test` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 283 | `mocha-webpack "src/**/*.ts"` | 
| [spiffcode/ghedit](https://github.com/spiffcode/ghedit) | 282 | `mocha` | 
| [nwtgck/piping-server](https://github.com/nwtgck/piping-server) | 280 | `mocha --require ts-node/register --timeout 10000 test/**/*.ts` | 
| [cdonohue/polychrome](https://github.com/cdonohue/polychrome) | 279 | `mocha --compilers js:babel-register test/**/*.js` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 278 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 273 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [nefe/pont](https://github.com/nefe/pont) | 260 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 258 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 256 | `nyc mocha` | 
| [AmirTugi/tea-school](https://github.com/AmirTugi/tea-school) | 253 | `npx ts-mocha ./src/tests/**.ts` | 
...
| [googleapis/nodejs-storage](https://github.com/googleapis/nodejs-storage) | 244 | `nyc mocha build/test` | 
| [liangzeng/cqrs](https://github.com/liangzeng/cqrs) | 241 | `tsc && mocha` | 
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 241 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 234 | `nyc mocha test/**/*.test.ts --exit` | 
| [renke/import-sort](https://github.com/renke/import-sort) | 233 | `mocha --require ts-node/register --recursive "packages/*/test/**/*.ts"` | 
| [duniter/duniter](https://github.com/duniter/duniter) | 226 | `nyc --reporter html mocha` | 
| [thiagobustamante/typescript-rest](https://github.com/thiagobustamante/typescript-rest) | 225 | `cross-env NODE_ENV=test mocha --exit` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 219 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 216 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 173 | `mocha --delay` | 
...
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 171 | `tsc && mocha` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 164 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 162 | `nyc --reporter=html --reporter=text mocha` | 
...
| [Soluto/graphql-to-mongodb](https://github.com/Soluto/graphql-to-mongodb) | 139 | `ts-mocha tests/**/*.spec.ts` | 
| [implydata/plyql](https://github.com/implydata/plyql) | 139 | `mocha` | 
| [bradymholt/cRonstrue](https://github.com/bradymholt/cRonstrue) | 137 | `npx mocha --reporter spec --compilers ts:ts-node/register` | 
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 137 | `mocha` | 
...
| [TrustWallet/trust-ray](https://github.com/TrustWallet/trust-ray) | 141 | `cross-env NODE_ENV=test mocha --recursive --require ts-node/register 'test/**/*.test.ts' --exit` | 
...
| [Esri/react-arcgis](https://github.com/Esri/react-arcgis) | 120 | `nyc mocha` | 
...
| [googleapis/nodejs-pubsub](https://github.com/googleapis/nodejs-pubsub) | 112 | `nyc mocha build/test` | 
...
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 109 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
...
| [wbhob/nest-middlewares](https://github.com/wbhob/nest-middlewares) | 93 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
| [sunzongzheng/musicApi](https://github.com/sunzongzheng/musicApi) | 93 | `mocha -t 30000 --require @babel/register 'test/*.test.js' --exit` | 
...
| [puzzle-js/puzzle-js](https://github.com/puzzle-js/puzzle-js) | 86 | `nyc --check-coverage --lines=85 cross-env NODE_ENV=production mocha -r ts-node/register  --recursive 'test/**/*.spec.ts'` | 
...
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 85 | `npm run build && npx nyc --reporter=html mocha --timeout 0 --recursive out/test.js && lua tests/spec.lua` | 
...
| [JustinBeckwith/retry-axios](https://github.com/JustinBeckwith/retry-axios) | 67 | `nyc mocha build/test --timeout 5000 --require source-map-support/register` | 
...
| [mshanemc/shane-sfdx-plugins](https://github.com/mshanemc/shane-sfdx-plugins) | 65 | `mocha --forbid-only "test/**/*.test.ts"` | 
| [TonyRobotics/RoboWare-Studio](https://github.com/TonyRobotics/RoboWare-Studio) | 65 | `mocha` | 
...
| [SqrTT/prophet](https://github.com/SqrTT/prophet) | 64 | `node ./node_modules/mocha/bin/mocha -u tdd ./out/tests/` | 
...
| [angular-extensions/model](https://github.com/angular-extensions/model) | 60 | `npm run lint && npm run format:test && nyc mocha {lib,schematics}/**/*.test.ts --require ts-node/register --require source-map-support/register` | 
| [mstssk/sw2dts](https://github.com/mstssk/sw2dts) | 59 | `mocha test/*.js` | 
...
| [RobinCK/typeorm-fixtures](https://github.com/RobinCK/typeorm-fixtures) | 45 | `nyc mocha` | 
...
| [ecrmnn/trending-github](https://github.com/ecrmnn/trending-github) | 37 | `mocha -r ts-node/register test/tests.ts && npm run eslint` | 
...
| [nicolaspanel/three-orbitcontrols-ts](https://github.com/nicolaspanel/three-orbitcontrols-ts) | 37 | `mocha --opts mocha.opts` | 
| [lebinh/cloudflare-workers](https://github.com/lebinh/cloudflare-workers) | 36 | `mocha -r ts-node/register 'tests/**/*_test.ts'` | 
| [nickpisacane/mips](https://github.com/nickpisacane/mips) | 36 | `__TS_PROJECT_PATH__=./test ts-mocha test/**/*.test.ts` | 
| [googleapis/github-repo-automation](https://github.com/googleapis/github-repo-automation) | 36 | `nyc mocha build/test` | 
...
| [juliantellez/lambcycle](https://github.com/juliantellez/lambcycle) | 35 | `mocha --opts config/mocha/mocha.opts` | 
...
| [mulesoft-labs/yaml-ast-parser](https://github.com/mulesoft-labs/yaml-ast-parser) | 35 | `npm run build && mocha --ui tdd dist/test` | 
...
| [eherve/mongoose-datatable](https://github.com/eherve/mongoose-datatable) | 35 | `docker run -p 4242:27017 --name datatable --rm -d mongo && tsc -p ./tsconfig.test.json && c8 mocha -R spec dist/**.spec.js ; docker stop $(docker ps -a -f name=datatable -q)` | 
...
| [nemtech/nem2-sdk-typescript-javascript](https://github.com/nemtech/nem2-sdk-typescript-javascript) | 34 | `mocha --ui bdd --recursive ./dist/test --timeout 90000` | 
| [davetemplin/web-request](https://github.com/davetemplin/web-request) | 34 | `mocha` | 
| [GoodgameStudios/RobotlegsJS](https://github.com/GoodgameStudios/RobotlegsJS) | 34 | `nyc mocha` | 
| [siegebell/vsc-prettify-symbols-mode](https://github.com/siegebell/vsc-prettify-symbols-mode) | 34 | `tsc -p ./ && mocha -u tdd ./out/test` | 
| [forthright/vile](https://github.com/forthright/vile) | 34 | `globstar -- _mocha "test/spec/**/*.coffee"` | 
| [lolamtisch/MALSync](https://github.com/lolamtisch/MALSync) | 34 | `webpack --config webpackConfig/test.config.js && mocha --recursive --timeout 30000 --retries 2 test/headless` | 
| [vrudikov/typescript-rest-boilerplate](https://github.com/vrudikov/typescript-rest-boilerplate) | 34 | `cross-env NODE_ENV=test mocha --exit` | 
