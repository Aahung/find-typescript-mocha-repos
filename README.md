...
The list was updated at 01:55:28 01/06/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 66748 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16520 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11450 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10131 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7027 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6269 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5433 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4626 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4490 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4016 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3401 | `mocha --opts mocha.opts` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 2876 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2862 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2853 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2816 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2457 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2436 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2233 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1401 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1308 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1274 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
...
| [google/clasp](https://github.com/google/clasp) | 1132 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [itchio/itch](https://github.com/itchio/itch) | 983 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 878 | `mocha bin/tests/test.js` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 569 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 506 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 488 | `mocha --opts mocha.opts` | 
...
| [incrediblesound/story-graph](https://github.com/incrediblesound/story-graph) | 444 | `_mocha --` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 444 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 444 | `tsc && mocha test && yarn lint` | 
| [vvakame/typescript-formatter](https://github.com/vvakame/typescript-formatter) | 419 | `npm run build && mocha --reporter spec --timeout 20000 --require intelli-espower-loader` | 
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 403 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
| [felixfbecker/vscode-php-debug](https://github.com/felixfbecker/vscode-php-debug) | 395 | `mocha out/test --timeout 20000 --slow 1000 --retries 4` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 293 | `mocha` | 
...
| [cbowdon/TsMonad](https://github.com/cbowdon/TsMonad) | 285 | `mocha lib/test` | 
| [cdonohue/polychrome](https://github.com/cdonohue/polychrome) | 277 | `mocha --compilers js:babel-register test/**/*.js` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 200 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 171 | `nyc mocha` | 
...
| [Chinachu/Mirakurun](https://github.com/Chinachu/Mirakurun) | 161 | `mocha --exit test/*.spec.js` | 
...
| [Microsoft/TypeScript-TmLanguage](https://github.com/Microsoft/TypeScript-TmLanguage) | 110 | `mocha --full-trace tests/test.js  --reporter mocha-multi-reporters` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 84 | `nyc mocha test/**/*.test.ts` | 
...
| [michaelolof/vue-literal-compiler](https://github.com/michaelolof/vue-literal-compiler) | 67 | `mocha -r ts-node/register test/**/*.test.ts --reporter=min --watch --watch-extensions ts` | 
...
| [hg-pyun/iterize](https://github.com/hg-pyun/iterize) | 49 | `mocha --recursive ./test/*.ts --require ts-node/register` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 45 | `ttsc --project tsconfig-test.json && mocha` | 
...
| [NativeScript/nativescript-dev-appium](https://github.com/NativeScript/nativescript-dev-appium) | 44 | `mocha --timeout 999999` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 35 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
