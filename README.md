...
The list was updated at 01:55:05 12/15/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 65676 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16246 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10940 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9696 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [nexe/nexe](https://github.com/nexe/nexe) | 6143 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5267 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4585 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4376 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3870 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3373 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2826 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2732 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2719 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2428 | `mocha 'test/**/*.ts'` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2399 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1861 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1859 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1363 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1359 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1196 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
...
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1115 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1092 | `nyc --reporter=html --reporter=text mocha` | 
| [google/clasp](https://github.com/google/clasp) | 1092 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1040 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 965 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 930 | `mocha --opts test/mocha.opts` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 900 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 585 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 473 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 437 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 413 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 386 | `mocha test/unit` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 325 | `tsc && mocha test && yarn lint` | 
...
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 309 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 281 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 242 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
...
| [Zarel/Pokemon-Showdown-Client](https://github.com/Zarel/Pokemon-Showdown-Client) | 197 | `eslint --config=.eslintrc.js --cache --cache-file=eslint-cache/base js/ data/ && eslint --config=build-tools/.eslintrc.js --cache --cache-file=eslint-cache/build build-tools/update build-tools/build-indexes && tsc && node build && mocha` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 178 | `cd test && mocha -r ts-node/register *.ts` | 
| [microsoftgraph/msgraph-sdk-javascript](https://github.com/microsoftgraph/msgraph-sdk-javascript) | 178 | `mocha lib/spec/core` | 
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 176 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [drew-y/cliffy](https://github.com/drew-y/cliffy) | 166 | `tsc && cd dist && mocha` | 
...
| [nodejs/llhttp](https://github.com/nodejs/llhttp) | 152 | `npm run mocha && npm run lint` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 131 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 124 | `nyc --reporter=html --reporter=text mocha` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 103 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 102 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
| [rjmacarthy/express-typescript-starter](https://github.com/rjmacarthy/express-typescript-starter) | 101 | `mocha -r ts-node/register -w ./spec/**/*.spec.ts` | 
...
| [vrimar/construct-ui](https://github.com/vrimar/construct-ui) | 82 | `cross-env TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [cartant/rxjs-observe](https://github.com/cartant/rxjs-observe) | 43 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
