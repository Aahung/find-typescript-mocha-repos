...
The list was updated at 01:56:23 02/20/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 69523 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17127 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12791 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11208 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7183 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6524 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5693 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4834 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4729 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4729 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3884 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3437 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3144 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2995 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2902 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2624 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2450 | `mocha 'test/**/*.ts'` | 
...
| [benjamn/recast](https://github.com/benjamn/recast) | 2240 | `npm run tsc && npm run mocha` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1928 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1546 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1479 | `nyc -x '' mocha` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1456 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1420 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1339 | `mocha --opts mocha.opts` | 
...
| [google/clasp](https://github.com/google/clasp) | 1290 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1094 | `tsc -p ./ && mocha` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 944 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 939 | `mocha bin/tests/test.js` | 
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 861 | `npm run mocha` | 
...
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 715 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 691 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
| [laoqiren/mlhelper](https://github.com/laoqiren/mlhelper) | 646 | `mocha --recursive` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 643 | `mocha test/unit` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 602 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 598 | `nyc mocha build/test` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 597 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
...
| [bbc/sqs-consumer](https://github.com/bbc/sqs-consumer) | 581 | `mocha` | 
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 577 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 516 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 513 | `tsc && mocha test && yarn lint` | 
| [benjamn/ast-types](https://github.com/benjamn/ast-types) | 502 | `npm run gen && npm run build && npm run mocha` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 500 | `mocha --opts mocha.opts` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 497 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 488 | `npm run lint && npm run mocha` | 
...
| [amplify-education/serverless-domain-manager](https://github.com/amplify-education/serverless-domain-manager) | 378 | `tsc --project . && nyc mocha -r ts-node/register test/unit-tests/index.test.ts && nyc report --reporter=text-summary` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 323 | `mocha` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 272 | `mocha-webpack "src/**/*.ts"` | 
| [nwtgck/piping-server](https://github.com/nwtgck/piping-server) | 270 | `mocha --require ts-node/register --timeout 10000 test/**/*.ts` | 
...
| [FormidableLabs/inspectpack](https://github.com/FormidableLabs/inspectpack) | 265 | `mocha "test/**/*.spec.ts"` | 
...
| [HerringtonDarkholme/av-ts](https://github.com/HerringtonDarkholme/av-ts) | 208 | `mocha dist/test.js` | 
...
| [emmanueltouzery/prelude-ts](https://github.com/emmanueltouzery/prelude-ts) | 183 | `rm tests/apidoc-*; tsc && node ./dist/tests/Comments.js && tsc && ./node_modules/mocha/bin/mocha --throw-deprecation --timeout 60000 ./dist/tests/*.js` | 
...
| [chenhaozhi/Cpage.js](https://github.com/chenhaozhi/Cpage.js) | 151 | `mocha -r ./node_modules/ts-node/register test/**/*_spec.ts --reporter mochawesome` | 
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 148 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
| [Half-Shot/matrix-appservice-discord](https://github.com/Half-Shot/matrix-appservice-discord) | 148 | `npm run-script build && mocha --opts test/mocha.opts build/test/config.js build/test` | 
| [cartant/rxjs-marbles](https://github.com/cartant/rxjs-marbles) | 147 | `yarn run lint && yarn run test:build && cross-env FAILING=0 yarn run test:ava && cross-env FAILING=0 yarn run test:jasmine && cross-env FAILING=0 yarn run test:jasmine-angular && cross-env FAILING=0 yarn run test:jest && cross-env FAILING=0 yarn run test:mocha && cross-env FAILING=0 yarn run test:tape` | 
| [ConquestArrow/dtsmake](https://github.com/ConquestArrow/dtsmake) | 147 | `mocha --compilers ts:ts-node/register test/*.ts` | 
| [martysweet/cfn-lint](https://github.com/martysweet/cfn-lint) | 145 | `mocha lib/test` | 
| [calidion/vig](https://github.com/calidion/vig) | 144 | `npm run build && nyc --reporter=text --reporter=html --reporter=lcov mocha --bail --compilers ts:ts-node/register --recursive 'test/**/*.test.ts'` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 126 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [Esri/react-arcgis](https://github.com/Esri/react-arcgis) | 116 | `nyc mocha` | 
| [englercj/tsd-jsdoc](https://github.com/englercj/tsd-jsdoc) | 114 | `mocha --ui tdd -r ts-node/register test/specs/**.ts` | 
...
| [metadevpro/openapi3-ts](https://github.com/metadevpro/openapi3-ts) | 78 | `mocha --recursive --compilers ts:ts-node/register --require source-map-support/register "src/**/*.spec.ts"` | 
| [ninoseki/mitaka](https://github.com/ninoseki/mitaka) | 78 | `nyc mocha -r ts-node/register "src/**/*.spec.ts"` | 
...
| [alex-okrushko/backoff-rxjs](https://github.com/alex-okrushko/backoff-rxjs) | 73 | `yarn run lint && yarn run test:build && yarn run test:mocha` | 
...
| [dupski/json-to-graphql-query](https://github.com/dupski/json-to-graphql-query) | 59 | `mocha -r ts-node/register --recursive "./src/**/__tests__/*"` | 
...
| [wearetheledger/fabric-node-chaincode-utils](https://github.com/wearetheledger/fabric-node-chaincode-utils) | 57 | `mocha -r ts-node/register test/**/*.spec.ts --reporter spec` | 
