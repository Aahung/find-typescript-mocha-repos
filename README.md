...
The list was updated at 01:55:38 12/21/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 66046 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16326 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11130 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9833 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6992 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6203 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5319 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4598 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4403 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3938 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3381 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2830 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2762 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2754 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2431 | `mocha 'test/**/*.ts'` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2414 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2205 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1866 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [staltz/xstream](https://github.com/staltz/xstream) | 1746 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1418 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1390 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1365 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1273 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1246 | `mocha --opts mocha.opts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1233 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1227 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [funkia/list](https://github.com/funkia/list) | 1221 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1191 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [google/clasp](https://github.com/google/clasp) | 1106 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 910 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 867 | `mocha bin/tests/test.js` | 
...
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 705 | `mocha` | 
...
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 560 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 559 | `nyc mocha build/test` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 549 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 548 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 542 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 485 | `mocha --opts mocha.opts` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 483 | `mocha test/unit` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 483 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 465 | `mocha --opts mocha.opts` | 
| [43081j/rar.js](https://github.com/43081j/rar.js) | 463 | `npm run build && mocha` | 
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 453 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 450 | `npm run mocha` | 
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 447 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
| [incrediblesound/story-graph](https://github.com/incrediblesound/story-graph) | 444 | `_mocha --` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 438 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 438 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 425 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [Polymer/prpl-server](https://github.com/Polymer/prpl-server) | 351 | `npm run build && mocha` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 342 | `tsc && mocha test && yarn lint` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 322 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 315 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 305 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 286 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 285 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 284 | `mocha` | 
...
| [RisingStack/node-typescript-starter](https://github.com/RisingStack/node-typescript-starter) | 238 | `tsc && mocha dist/**/*.spec.js` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 230 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 214 | `mocha-webpack "src/**/*.ts"` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 190 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 187 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
| [JumpFm/jumpfm](https://github.com/JumpFm/jumpfm) | 187 | `mocha js` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 187 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 165 | `nyc mocha` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 140 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [cartant/rxjs-marbles](https://github.com/cartant/rxjs-marbles) | 128 | `yarn run lint && yarn run test:build && cross-env FAILING=0 yarn run test:ava && cross-env FAILING=0 yarn run test:jasmine && cross-env FAILING=0 yarn run test:jasmine-angular && cross-env FAILING=0 yarn run test:jest && cross-env FAILING=0 yarn run test:mocha && cross-env FAILING=0 yarn run test:tape` | 
...
| [rohitpaulk/todoist-tribute](https://github.com/rohitpaulk/todoist-tribute) | 104 | `mocha --compilers ts:ts-node/register app/javascript/packs/tests/**/*.ts` | 
| [rohitpaulk/todoist-tribute](https://github.com/rohitpaulk/todoist-tribute) | 104 | `mocha --compilers ts:ts-node/register app/javascript/packs/tests/**/*.ts` | 
...
| [horiuchi/dtsgenerator](https://github.com/horiuchi/dtsgenerator) | 100 | `istanbul cover _mocha test/*.js test/**/*.js` | 
...
| [mysticatea/vue-eslint-parser](https://github.com/mysticatea/vue-eslint-parser) | 96 | `nyc npm run _mocha` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 78 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [bpatrik/pigallery2](https://github.com/bpatrik/pigallery2) | 75 | `ng test && mocha --recursive test/backend/unit && mocha --recursive test/backend/integration  && mocha --recursive test/common/unit ` | 
...
| [adrien2p/nestjs-graphql](https://github.com/adrien2p/nestjs-graphql) | 73 | `mocha -r ts-node/register src/**/tests/*.ts` | 
...
| [alex-okrushko/backoff-rxjs](https://github.com/alex-okrushko/backoff-rxjs) | 60 | `mocha --opts spec/mocha.opts spec/**/*-spec.ts` | 
...
| [cartant/rxjs-etc](https://github.com/cartant/rxjs-etc) | 64 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [SqrTT/prophet](https://github.com/SqrTT/prophet) | 58 | `node ./node_modules/mocha/bin/mocha -u tdd ./out/tests/` | 
...
| [rpgeeganage/async-ray](https://github.com/rpgeeganage/async-ray) | 54 | `nyc mocha` | 
...
| [lukeautry/ts-app](https://github.com/lukeautry/ts-app) | 50 | `cross-env TS_NODE_PROJECT=./api/tsconfig.json mocha -t 15000 -r ts-node/register "./api/**/*.spec.ts"` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 37 | `ttsc --project tsconfig-test.json && mocha` | 
...
| [jaystack/odata-v4-server](https://github.com/jaystack/odata-v4-server) | 36 | `nyc mocha --reporter mochawesome --reporter-options reportDir=report,reportName=odata-v4-server,reportTitle="OData V4 Server" src/test/**/*.spec.ts` | 
