...
The list was updated at 01:56:29 02/08/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 68701 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16977 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12395 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10946 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7155 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6450 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5637 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4694 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4692 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4678 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3768 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3423 | `mocha --opts mocha.opts` | 
...
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2953 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2885 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2574 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1931 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1512 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1467 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1449 | `nyc -x '' mocha` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1418 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1365 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1318 | `mocha --opts mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1277 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [google/clasp](https://github.com/google/clasp) | 1246 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [funkia/list](https://github.com/funkia/list) | 1236 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1235 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1229 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1150 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 931 | `mocha bin/tests/test.js` | 
| [stryker-mutator/stryker](https://github.com/stryker-mutator/stryker) | 848 | `npm run mocha` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 773 | `mocha --require ts-node/register` | 
| [coinbase/gdax-tt](https://github.com/coinbase/gdax-tt) | 738 | `yarn run lint && yarn run test:mocha` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 736 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 725 | `mocha` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 724 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 621 | `mocha test/unit` | 
...
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 590 | `nyc mocha build/test` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 577 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [amplify-education/serverless-domain-manager](https://github.com/amplify-education/serverless-domain-manager) | 373 | `tsc --project . && nyc mocha -r ts-node/register test/unit-tests/index.test.ts && nyc report --reporter=text-summary` | 
...
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 332 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 318 | `mocha` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 281 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 253 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 253 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 233 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 225 | `nyc mocha` | 
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 220 | `nyc mocha test/**/*.test.ts --exit` | 
...
| [bmewburn/intelephense](https://github.com/bmewburn/intelephense) | 204 | `mocha -r ts-node/register test/*.ts` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 162 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [Microsoft/vscode-vsce](https://github.com/Microsoft/vscode-vsce) | 155 | `gulp compile && mocha` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 151 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 145 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 134 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
| [nwtgck/piping-server](https://github.com/nwtgck/piping-server) | 134 | `mocha --require ts-node/register --timeout 10000 test/**/*.ts` | 
...
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 123 | `mocha` | 
...
| [googleapis/nodejs-datastore](https://github.com/googleapis/nodejs-datastore) | 79 | `nyc mocha build/test` | 
...
| [Microsoft/vscode-mock-debug](https://github.com/Microsoft/vscode-mock-debug) | 75 | `mocha -u tdd ./out/tests/` | 
...
| [googleapis/node-gtoken](https://github.com/googleapis/node-gtoken) | 65 | `nyc mocha build/test` | 
...
| [NativeScript/nativescript-vscode-extension](https://github.com/NativeScript/nativescript-vscode-extension) | 61 | `mocha --opts ./src/tests/config/mocha.opts` | 
| [zenclabs/codetree](https://github.com/zenclabs/codetree) | 61 | `mocha -r ts-node/register src/**/*.spec.ts` | 
| [duffman/tspath](https://github.com/duffman/tspath) | 61 | `mocha -r ts-node/register test/**.*/test.ts` | 
...
| [Microsoft/node-jsonc-parser](https://github.com/Microsoft/node-jsonc-parser) | 56 | `npm run compile && mocha` | 
...
| [JustinBeckwith/retry-axios](https://github.com/JustinBeckwith/retry-axios) | 53 | `nyc mocha build/test --timeout 5000 --require source-map-support/register` | 
...
| [angular-extensions/model](https://github.com/angular-extensions/model) | 51 | `npm run lint && npm run format:test && nyc mocha {lib,schematics}/**/*.test.ts --require ts-node/register --require source-map-support/register` | 
