...
The list was updated at 01:55:04 12/09/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 65266 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16142 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10684 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9580 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8596 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6967 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6109 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5241 | `npm run mocha` | 
...
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3796 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
...
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2708 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2659 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2425 | `mocha 'test/**/*.ts'` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2390 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2187 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1850 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1683 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 20000 --max-parallel=1 --exit` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1402 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1358 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1348 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1233 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1233 | `mocha --opts mocha.opts` | 
...
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1170 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
...
| [google/clasp](https://github.com/google/clasp) | 1072 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1037 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 957 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 661 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 553 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 529 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 406 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 276 | `mocha` | 
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 274 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 230 | `mocha test/unit` | 
...
| [microsoftgraph/msgraph-sdk-javascript](https://github.com/microsoftgraph/msgraph-sdk-javascript) | 173 | `mocha lib/spec/core` | 
| [ohjames/rxjs-websockets](https://github.com/ohjames/rxjs-websockets) | 173 | `npm run build && npm run mocha` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 163 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [dsherret/ts-nameof](https://github.com/dsherret/ts-nameof) | 108 | `yarn run --silent copy-test-files && nyc --reporter=lcov mocha --opts mocha.opts` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 107 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [Azure/azure-cosmos-js](https://github.com/Azure/azure-cosmos-js) | 71 | `mocha -r ./src/test/common/setup.ts ./lib/src/test/ --recursive --timeout 100000 -i -g .*ignore.js` | 
...
| [AlCalzone/node-tradfri-client](https://github.com/AlCalzone/node-tradfri-client) | 50 | `node_modules/.bin/mocha --watch` | 
...
| [ninoseki/mitaka](https://github.com/ninoseki/mitaka) | 49 | `nyc mocha -r ts-node/register "src/**/*.spec.ts"` | 
