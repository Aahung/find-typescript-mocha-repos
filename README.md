...
The list was updated at 01:55:33 12/18/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 65848 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16282 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11024 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9752 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6986 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6185 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5296 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4592 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4385 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3891 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3379 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2826 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2746 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2731 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2429 | `mocha 'test/**/*.ts'` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2407 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1863 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1380 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1364 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1254 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1215 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1189 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1117 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [google/clasp](https://github.com/google/clasp) | 1095 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [itchio/itch](https://github.com/itchio/itch) | 968 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 732 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 659 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 587 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 546 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 476 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 443 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 436 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 415 | `cd test && mocha -r ts-node/register *.ts` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 407 | `mocha test/unit` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 339 | `tsc && mocha test && yarn lint` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 225 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 222 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 183 | `cd test && mocha -r ts-node/register *.ts` | 
| [funkia/hareactive](https://github.com/funkia/hareactive) | 183 | `nyc mocha --recursive test/**/*.ts` | 
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 179 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 160 | `nyc mocha` | 
...
| [googleapis/nodejs-translate](https://github.com/googleapis/nodejs-translate) | 151 | `nyc mocha build/test` | 
...
| [nozer/quill-delta-to-html](https://github.com/nozer/quill-delta-to-html) | 135 | `./node_modules/nyc/bin/nyc.js ./node_modules/mocha/bin/mocha --compilers ts:ts-node/register -b "./test/**/*.ts"  ` | 
| [implydata/plyql](https://github.com/implydata/plyql) | 135 | `mocha` | 
| [PeterDing/chord](https://github.com/PeterDing/chord) | 134 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [nomiclabs/buidler](https://github.com/nomiclabs/buidler) | 114 | `nyc mocha` | 
...
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 111 | `mocha` | 
...
| [matthew-matvei/freeman](https://github.com/matthew-matvei/freeman) | 107 | `xvfb-maybe electron-mocha --renderer __tests__` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 106 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [Esri/react-arcgis](https://github.com/Esri/react-arcgis) | 102 | `nyc mocha` | 
...
| [jvilk/MakeTypes](https://github.com/jvilk/MakeTypes) | 97 | `npm-run-all --serial prepublish generate:test build:test mocha` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 75 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
| [balassy/aws-lambda-typescript](https://github.com/balassy/aws-lambda-typescript) | 74 | `nyc mocha` | 
...
| [darkoverlordofdata/entitas-ts](https://github.com/darkoverlordofdata/entitas-ts) | 53 | `NODE_ENV=test mocha --compilers coffee:coffee-script --require test/test_helper.js --recursive` | 
...
| [waitingsong/node-win32-api](https://github.com/waitingsong/node-win32-api) | 49 | `mocha --opts test/mocha.opts` | 
...
| [cartant/rxjs-observe](https://github.com/cartant/rxjs-observe) | 45 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 35 | `ttsc --project tsconfig-test.json && mocha` | 
