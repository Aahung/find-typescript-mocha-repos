...
The list was updated at 00:43:49 09/22/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 59735 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 14885 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 8835 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8280 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6756 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5659 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4769 | `npm run mocha` | 
| [Microsoft/sqlopsstudio](https://github.com/Microsoft/sqlopsstudio) | 4353 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 3965 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3254 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2735 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2547 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2404 | `mocha 'test/**/*.ts'` | 
...
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2034 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1780 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1181 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 832 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 641 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 528 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 477 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 428 | `mocha --opts mocha.opts` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 384 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 382 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
...
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 265 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 201 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [ClickSimply/Nano-SQL](https://github.com/ClickSimply/Nano-SQL) | 182 | `mocha -r ts-node/register tests/index.ts` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 153 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 88 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [atomist/sdm](https://github.com/atomist/sdm) | 73 | `nyc mocha --require espower-typescript/guess --require source-map-support/register "test/**/*.test.ts"` | 
...
| [Microsoft/NoSQLProvider](https://github.com/Microsoft/NoSQLProvider) | 65 | `mocha dist/tests/NoSqlProviderTests.js --timeout 5000` | 
...
| [DhyanaChina/koa2-typescript-guide](https://github.com/DhyanaChina/koa2-typescript-guide) | 43 | `mocha` | 
