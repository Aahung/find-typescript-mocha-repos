...
The list was updated at 01:55:28 12/28/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 66359 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16417 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11286 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9940 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7006 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6232 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5363 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4615 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4452 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3972 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3388 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2843 | `mocha` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2801 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2788 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2432 | `mocha 'test/**/*.ts'` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2430 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2212 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1871 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1799 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1753 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1423 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1403 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1380 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1286 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1250 | `mocha --opts mocha.opts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1248 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
...
| [google/clasp](https://github.com/google/clasp) | 1118 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 917 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 739 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 595 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 559 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 517 | `mocha test/unit` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 494 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 403 | `tsc && mocha test && yarn lint` | 
...
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 293 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 234 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 221 | `mocha-webpack "src/**/*.ts"` | 
...
| [thiagobustamante/typescript-rest](https://github.com/thiagobustamante/typescript-rest) | 199 | `cross-env NODE_ENV=test mocha --exit` | 
...
| [danvk/localturk](https://github.com/danvk/localturk) | 147 | `mocha --require ts-node/register test/**/*.ts` | 
| [jgranstrom/zipson](https://github.com/jgranstrom/zipson) | 147 | `mocha --require ts-node/register --watch-extensions ts 'test/**/*.ts'` | 
| [PeterDing/chord](https://github.com/PeterDing/chord) | 146 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [Enterprise-JS/vscode-ts-node-debugging](https://github.com/Enterprise-JS/vscode-ts-node-debugging) | 123 | `npm run mocha --recursive ./src/**/__tests__/*` | 
...
| [vrimar/construct-ui](https://github.com/vrimar/construct-ui) | 103 | `cross-env TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [firebase/firebase-functions-test](https://github.com/firebase/firebase-functions-test) | 64 | `mocha .tmp/spec/index.spec.js` | 
...
| [pact-foundation/pact-node](https://github.com/pact-foundation/pact-node) | 63 | `cross-env LOGLEVEL=debug PACT_DO_NOT_TRACK=true mocha -r ts-node/register -R mocha-unfunk-reporter -t 15000 -s 5000 -b --check-leaks --exit "{src,test,bin,standalone}/**/*.spec.ts"` | 
...
| [ikr/react-star-rating-input](https://github.com/ikr/react-star-rating-input) | 42 | `mocha -r ts-node/register -r tests/helpers/enzyme -b tests/*.spec.*` | 
| [mrmlnc/vscode-csscomb](https://github.com/mrmlnc/vscode-csscomb) | 42 | `mocha out/{,**/}*.spec.js -s 0` | 
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 42 | `ttsc --project tsconfig-test.json && mocha` | 
...
| [Jiasm/typescript-example](https://github.com/Jiasm/typescript-example) | 37 | `mocha -r ts-node/register test/**/*.spec.ts` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 33 | `nyc mocha test/**/*.test.ts` | 
| [teamdomy/domy-cli](https://github.com/teamdomy/domy-cli) | 33 | `mocha --reporter spec --require ts-node/register 'tests/**/*.spec.ts'` | 
