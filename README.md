...
The list was updated at 00:44:00 09/21/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 59696 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 14874 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 8808 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8264 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6754 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5617 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4766 | `npm run mocha` | 
| [Microsoft/sqlopsstudio](https://github.com/Microsoft/sqlopsstudio) | 4348 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 3962 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3252 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2732 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2532 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2403 | `mocha 'test/**/*.ts'` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2365 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2027 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 1988 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1787 | `mocha` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1779 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1724 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1647 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1226 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1179 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [funkia/list](https://github.com/funkia/list) | 1172 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1118 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1061 | `mocha --opts mocha.opts` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1035 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 829 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [google/clasp](https://github.com/google/clasp) | 790 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 527 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 510 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 349 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 208 | `mocha test` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 198 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [codeaholicguy/wowcup](https://github.com/codeaholicguy/wowcup) | 185 | `nyc mocha --forbid-only "test/**/*.test.ts"` | 
| [ClickSimply/Nano-SQL](https://github.com/ClickSimply/Nano-SQL) | 181 | `mocha -r ts-node/register tests/index.ts` | 
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 179 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 178 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [jacobbogers/blasjs](https://github.com/jacobbogers/blasjs) | 175 | `cross-env-shell NODE_ENV=test TS_NODE_DISABLE_WARNINGS=true nyc mocha` | 
...
| [Talento90/typescript-node](https://github.com/Talento90/typescript-node) | 134 | `npm run build && mocha --exit --recursive dist/test/unit` | 
...
| [cyclejs/react](https://github.com/cyclejs/react) | 91 | `$(npm bin)/mocha test/*.ts --require ts-node/register --recursive` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 87 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [atomist/sdm](https://github.com/atomist/sdm) | 72 | `nyc mocha --require espower-typescript/guess --require source-map-support/register "test/**/*.test.ts"` | 
...
| [codius/codiusd](https://github.com/codius/codiusd) | 69 | `npm run lint && nyc mocha` | 
...
| [flagello/Essence](https://github.com/flagello/Essence) | 68 | `mocha` | 
...
| [stardust-ui/react](https://github.com/stardust-ui/react) | 54 | `$(npm bin)/mocha test/*.ts --require ts-node/register --recursive` | 
...
| [voryx/thruway.js](https://github.com/voryx/thruway.js) | 23 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
...
| [akamud/vscode-caniuse](https://github.com/akamud/vscode-caniuse) | 23 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec --ui tdd ./out/test/extension.test.js` | 
| [acrazing/mobx-sync](https://github.com/acrazing/mobx-sync) | 23 | `mocha --require ts-node/register --slow 1000 ./src/**/*.spec.ts` | 
...
| [poelstra/ts-promise](https://github.com/poelstra/ts-promise) | 23 | `npm run -s build && npm run -s lint && npm run -s mocha` | 
| [0xProject/0x-relayer-registry](https://github.com/0xProject/0x-relayer-registry) | 23 | `yarn build; mocha ./lib/test/*_test.js` | 
| [nefe/kiwi-intl](https://github.com/nefe/kiwi-intl) | 23 | `mocha --compilers ts:ts-node/register test/**/*.ts -R spec` | 
| [googleapis/github-repo-automation](https://github.com/googleapis/github-repo-automation) | 23 | `nyc --reporter=lcov mocha build/test && nyc report` | 
| [c9s/typeloy](https://github.com/c9s/typeloy) | 23 | `mocha lib/tests` | 
| [kinotto/geonames.js](https://github.com/kinotto/geonames.js) | 23 | `mocha ./spec/test-server.js --timeout 50000` | 
| [lostintime/node-typematcher](https://github.com/lostintime/node-typematcher) | 23 | `tsc && mocha "dist/test/"` | 
