...
The list was updated at 01:56:10 02/18/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 69380 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17093 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12719 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11147 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7179 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6511 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5683 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4823 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4720 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4717 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3868 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3435 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3129 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2986 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2897 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2612 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2448 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2314 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2235 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1943 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1925 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1538 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1466 | `nyc -x '' mocha` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1451 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1413 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1330 | `mocha --opts mocha.opts` | 
...
| [google/clasp](https://github.com/google/clasp) | 1284 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 938 | `mocha bin/tests/test.js` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 748 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 730 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 687 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 640 | `mocha test/unit` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 598 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 571 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 494 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 484 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 245 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 235 | `nyc mocha` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 155 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 146 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
| [Half-Shot/matrix-appservice-discord](https://github.com/Half-Shot/matrix-appservice-discord) | 146 | `npm run-script build && mocha --opts test/mocha.opts build/test/config.js build/test` | 
...
| [TrustWallet/trust-ray](https://github.com/TrustWallet/trust-ray) | 138 | `cross-env NODE_ENV=test mocha --recursive --require ts-node/register 'test/**/*.test.ts' --exit` | 
...
| [functionalone/serverless-iam-roles-per-function](https://github.com/functionalone/serverless-iam-roles-per-function) | 121 | `nyc mocha --require ts-node/register --require source-map-support/register  ./src/test/**/*.test.ts` | 
...
| [ninoseki/mitaka](https://github.com/ninoseki/mitaka) | 75 | `nyc mocha -r ts-node/register "src/**/*.spec.ts"` | 
...
| [mysticatea/regexpp](https://github.com/mysticatea/regexpp) | 55 | `nyc _mocha "test/*.ts" --reporter dot --timeout 10000` | 
...
| [dalenguyen/firestore-backup-restore](https://github.com/dalenguyen/firestore-backup-restore) | 54 | `mocha --timeout 99999999 --exit -r ts-node/register test/**/*.spec.ts` | 
...
| [konvajs/ng2-konva](https://github.com/konvajs/ng2-konva) | 35 | `mocha --require ts-node/register test/**/*.spec.ts --recursive` | 
...
| [ecrmnn/trending-github](https://github.com/ecrmnn/trending-github) | 35 | `mocha -r ts-node/register test/tests.ts && npm run eslint` | 