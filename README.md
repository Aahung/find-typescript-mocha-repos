...
The list was updated at 01:55:42 12/29/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 66397 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16438 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11302 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9958 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7006 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6238 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5372 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4618 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4463 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3976 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3389 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2845 | `mocha` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2812 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
...
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2433 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2432 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2214 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1876 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1799 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1754 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1404 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1382 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1290 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1254 | `mocha --opts mocha.opts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1251 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1232 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [funkia/list](https://github.com/funkia/list) | 1222 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
...
| [google/clasp](https://github.com/google/clasp) | 1120 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1096 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1046 | `tsc -p ./ && mocha` | 
...
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 907 | `npm run bundle:browser && TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 520 | `mocha test/unit` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 437 | `cd test && mocha -r ts-node/register *.ts` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 424 | `tsc && mocha test && yarn lint` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 303 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [alexcambose/motus](https://github.com/alexcambose/motus) | 292 | `cross-env mocha -r ts-node/register 'test/**/*.spec.ts'` | 
| [FinNLP/en-inflectors](https://github.com/FinNLP/en-inflectors) | 290 | `mocha` | 
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 288 | `mocha` | 
...
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 229 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 222 | `mocha-webpack "src/**/*.ts"` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 195 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [Microsoft/vscode-node-debug](https://github.com/Microsoft/vscode-node-debug) | 159 | `gulp compile && mocha --timeout 10000 -u tdd ./out/tests/` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 130 | `nyc --reporter=html --reporter=text mocha` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 115 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [vrimar/construct-ui](https://github.com/vrimar/construct-ui) | 110 | `cross-env TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [matthew-matvei/freeman](https://github.com/matthew-matvei/freeman) | 109 | `xvfb-maybe electron-mocha --renderer __tests__` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 83 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [Cody2333/koa-swagger-decorator](https://github.com/Cody2333/koa-swagger-decorator) | 75 | `./node_modules/mocha/bin/mocha -r babel-core/register test/**/*.js --bail -t 2000000` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 69 | `nyc mocha test/**/*.test.ts` | 
...
| [getsentry/sentry-electron](https://github.com/getsentry/sentry-electron) | 60 | `cross-env TS_NODE_PROJECT=tsconfig.json xvfb-maybe electron-mocha --require ts-node/register/transpile-only --timeout 3000 ./test/unit/**/*.ts` | 
...
| [teamdomy/domy-cli](https://github.com/teamdomy/domy-cli) | 51 | `mocha --reporter spec --require ts-node/register 'tests/**/*.spec.ts'` | 
