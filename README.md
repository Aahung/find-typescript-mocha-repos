...
The list was updated at 01:55:43 11/18/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 64051 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15785 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10129 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9208 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8387 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6925 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6019 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5107 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4508 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4215 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3352 | `mocha --opts mocha.opts` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3114 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2794 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2598 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2432 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2421 | `mocha 'test/**/*.ts'` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1838 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1820 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1792 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1705 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1565 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 20000 --max-parallel=1 --exit` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1379 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1332 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1290 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1133 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1088 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
...
| [google/clasp](https://github.com/google/clasp) | 1012 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 685 | `mocha` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 645 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 305 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 299 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 255 | `mocha` | 
...
| [RisingStack/node-typescript-starter](https://github.com/RisingStack/node-typescript-starter) | 230 | `tsc && mocha dist/**/*.spec.js` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 150 | `mocha test/unit` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 147 | `nyc mocha` | 
...
| [jvilk/MakeTypes](https://github.com/jvilk/MakeTypes) | 93 | `npm-run-all --serial prepublish generate:test build:test mocha` | 
...
| [indutny/llparse](https://github.com/indutny/llparse) | 80 | `npm run mocha && npm run lint` | 
...
| [indutny/llhttp](https://github.com/indutny/llhttp) | 74 | `npm run mocha && npm run lint` | 
...
| [MariusAlch/json-to-ts](https://github.com/MariusAlch/json-to-ts) | 63 | `npm run build && mocha ./test/js-integration/index.js && mocha ./build/test` | 
...
| [googleapis/node-gtoken](https://github.com/googleapis/node-gtoken) | 60 | `nyc mocha build/test` | 
...
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 49 | `nyc --reporter=html mocha --timeout 0 --require ts-node/register --require source-map-support/register --recursive src/test.ts` | 
...
| [breakstring/xunfeisdk](https://github.com/breakstring/xunfeisdk) | 46 | `tsc && mocha -R nyan -t 15000 -r ts-node/register "./test/**/*.ts"` | 
...
| [ethereum-ts/evm-ts](https://github.com/ethereum-ts/evm-ts) | 39 | `yarn lint && yarn test:mocha` | 
...
| [gcanti/hyper-ts](https://github.com/gcanti/hyper-ts) | 31 | `npm run prettier && npm run lint && npm run typings-checker && npm run mocha` | 
...
| [aleixmorgadas/nem-library-ts](https://github.com/aleixmorgadas/nem-library-ts) | 31 | `mocha --ui bdd --recursive ./dist/test ./dist/integration_test --timeout 60000` | 
