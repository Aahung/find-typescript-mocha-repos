...
The list was updated at 01:55:40 02/24/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 69724 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17181 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12910 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11278 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7204 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6542 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5713 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4930 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4754 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4745 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3909 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3438 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3161 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
...
| [retejs/rete](https://github.com/retejs/rete) | 2894 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2639 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
...
| [benjamn/recast](https://github.com/benjamn/recast) | 2245 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1949 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1484 | `nyc -x '' mocha` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1472 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [google/clasp](https://github.com/google/clasp) | 1303 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 948 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 946 | `mocha bin/tests/test.js` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 788 | `mocha --require ts-node/register` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 783 | `mocha test/backend` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 762 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 653 | `mocha "out/**/*.spec.js" -s 0` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 649 | `mocha test/unit` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 608 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 585 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 520 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 505 | `mocha --opts mocha.opts` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 504 | `cd test && mocha -r ts-node/register *.ts` | 
| [benjamn/ast-types](https://github.com/benjamn/ast-types) | 503 | `npm run gen && npm run build && npm run mocha` | 
...
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 495 | `npm run mocha` | 
...
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 368 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 344 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 314 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 295 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
...
| [nefe/pont](https://github.com/nefe/pont) | 225 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
...
| [bmewburn/intelephense](https://github.com/bmewburn/intelephense) | 209 | `mocha -r ts-node/register test/*.ts` | 
...
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 165 | `tsc && mocha` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 160 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [Half-Shot/matrix-appservice-discord](https://github.com/Half-Shot/matrix-appservice-discord) | 154 | `npm run-script build && mocha --opts test/mocha.opts build/test/config.js build/test` | 
...
| [redhat-developer/vscode-yaml](https://github.com/redhat-developer/vscode-yaml) | 96 | `mocha --ui tdd out/test/extension.test.js` | 
