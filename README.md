...
The list was updated at 01:55:27 12/20/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 65995 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16310 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11092 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9810 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6989 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6194 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5314 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4594 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4398 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3925 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
...
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2755 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2746 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2430 | `mocha 'test/**/*.ts'` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2410 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2203 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1795 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1745 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1416 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1388 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1365 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1268 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1244 | `mocha --opts mocha.opts` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1233 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1226 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [funkia/list](https://github.com/funkia/list) | 1220 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
...
| [google/clasp](https://github.com/google/clasp) | 1103 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 909 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 865 | `mocha bin/tests/test.js` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 661 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 559 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 547 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 484 | `mocha --opts mocha.opts` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 482 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 468 | `mocha test/unit` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 467 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 467 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 464 | `mocha --opts mocha.opts` | 
...
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 449 | `npm run mocha` | 
| [Romakita/ts-express-decorators](https://github.com/Romakita/ts-express-decorators) | 446 | `npm run clean && npm run tsc && npm run tslint && cross-env NODE_ENV=test nyc --reporter=html --reporter=text _mocha --recursive` | 
...
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 437 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 420 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 321 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 314 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [zlq4863947/triangular-arbitrage](https://github.com/zlq4863947/triangular-arbitrage) | 304 | `cross-env NODE_ENV=test mocha dist/**/*.test.js --timeout 5000 --require intelli-espower-loader` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 229 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [googleapis/nodejs-storage](https://github.com/googleapis/nodejs-storage) | 204 | `nyc mocha build/test` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 164 | `nyc mocha` | 
...
| [danvk/localturk](https://github.com/danvk/localturk) | 143 | `mocha --require ts-node/register test/**/*.ts` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 137 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [cartant/rxjs-marbles](https://github.com/cartant/rxjs-marbles) | 127 | `yarn run lint && yarn run test:build && cross-env FAILING=0 yarn run test:ava && cross-env FAILING=0 yarn run test:jasmine && cross-env FAILING=0 yarn run test:jasmine-angular && cross-env FAILING=0 yarn run test:jest && cross-env FAILING=0 yarn run test:mocha && cross-env FAILING=0 yarn run test:tape` | 
...
| [dsherret/ts-nameof](https://github.com/dsherret/ts-nameof) | 114 | `yarn run --silent copy-test-files && nyc --reporter=lcov mocha --opts mocha.opts` | 
| [VirgilSecurity/twilio-sample-backend-nodejs](https://github.com/VirgilSecurity/twilio-sample-backend-nodejs) | 113 | `mocha --timeout 5000 -r ts-node/register -r tsconfig-paths/register ./api/tests/*.test.ts` | 
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 112 | `mocha` | 
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 110 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 107 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
...
| [cartant/ts-action](https://github.com/cartant/ts-action) | 91 | `yarn run lint && yarn run test:build && mocha ./build/**/*-spec.js` | 
...
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 62 | `nyc --reporter=html mocha --timeout 0 --require ts-node/register --require source-map-support/register --recursive src/test.ts && lua tests/spec.lua` | 
...
| [mshanemc/shane-sfdx-plugins](https://github.com/mshanemc/shane-sfdx-plugins) | 50 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [rpgeeganage/async-ray](https://github.com/rpgeeganage/async-ray) | 49 | `nyc mocha` | 
...
| [lukeautry/ts-app](https://github.com/lukeautry/ts-app) | 48 | `cross-env TS_NODE_PROJECT=./api/tsconfig.json mocha -t 15000 -r ts-node/register "./api/**/*.spec.ts"` | 
| [xmlking/koa-router-decorators](https://github.com/xmlking/koa-router-decorators) | 48 | `mocha .tmp/test/**/*.spec.js` | 
| [teppeis/closure-ts](https://github.com/teppeis/closure-ts) | 48 | `npm-run-all --aggregate-output -p lint:ts build -p lint:js mocha` | 
...
| [Unibeautify/vscode](https://github.com/Unibeautify/vscode) | 43 | `mocha` | 
