...
The list was updated at 01:55:20 01/05/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 66715 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16514 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11432 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10101 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7023 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6265 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5425 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4626 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4484 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4008 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3400 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2855 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2853 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2814 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 2807 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2454 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2435 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2231 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1876 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1411 | `nyc -x '' mocha` | 
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1396 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1306 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1266 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1266 | `mocha --opts mocha.opts` | 
...
| [cherow/cherow](https://github.com/cherow/cherow) | 1213 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha test/**/*.ts -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1052 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 975 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 935 | `mocha --opts test/mocha.opts` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 922 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 877 | `mocha bin/tests/test.js` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 685 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 682 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 603 | `mocha lib/test/unittest.js --check-leaks --color` | 
| [hacksparrow/node-easyimage](https://github.com/hacksparrow/node-easyimage) | 593 | `npm run lint && npm run mocha` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 568 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 548 | `mocha test/unit` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 548 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 505 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 462 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 447 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 443 | `tsc && mocha test && yarn lint` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 402 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
...
| [cdonohue/polychrome](https://github.com/cdonohue/polychrome) | 276 | `mocha --compilers js:babel-register test/**/*.js` | 
...
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 243 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 237 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [cartant/rxjs-marbles](https://github.com/cartant/rxjs-marbles) | 131 | `yarn run lint && yarn run test:build && cross-env FAILING=0 yarn run test:ava && cross-env FAILING=0 yarn run test:jasmine && cross-env FAILING=0 yarn run test:jasmine-angular && cross-env FAILING=0 yarn run test:jest && cross-env FAILING=0 yarn run test:mocha && cross-env FAILING=0 yarn run test:tape` | 
| [atomist/sdm](https://github.com/atomist/sdm) | 131 | `mocha --require espower-typescript/guess "test/**/*.test.ts"` | 
...
| [vrimar/construct-ui](https://github.com/vrimar/construct-ui) | 124 | `cross-env TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [teamdomy/domy-cli](https://github.com/teamdomy/domy-cli) | 61 | `mocha --reporter spec --require ts-node/register 'tests/**/*.spec.ts'` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 44 | `ttsc --project tsconfig-test.json && mocha` | 
...
| [pokemongo-dev-contrib/pokemongo-json-pokedex](https://github.com/pokemongo-dev-contrib/pokemongo-json-pokedex) | 34 | `mocha --recursive --compilers ts:ts-node/register,ts:tsconfig-paths/register test/*.ts test/**/*.ts` | 
