...
The list was updated at 01:55:54 02/01/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 68290 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16903 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12199 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10747 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7111 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6392 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5607 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4685 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4646 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4492 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3723 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3416 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3070 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2929 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2876 | `mocha` | 
...
| [benjamn/recast](https://github.com/benjamn/recast) | 2204 | `npm run tsc && npm run mocha` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1494 | `mocha --require ts-node/register test/**Test.ts --exit` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1390 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1349 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1292 | `mocha --opts mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1270 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [google/clasp](https://github.com/google/clasp) | 1222 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 724 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 675 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 608 | `mocha test/unit` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 590 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 569 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 552 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 485 | `tsc && mocha test && yarn lint` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 480 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 476 | `cd test && mocha -r ts-node/register *.ts` | 
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 472 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
...
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 352 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 350 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [arangodb/arangojs](https://github.com/arangodb/arangojs) | 346 | `mocha --growl --reporter spec --require source-map-support/register --timeout 10000 lib/async/test` | 
...
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 313 | `mocha` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 191 | `nyc mocha test/**/*.test.ts --exit` | 
...
| [TreeGateway/tree-gateway](https://github.com/TreeGateway/tree-gateway) | 121 | `cross-env NODE_ENV=test mocha --exit` | 
...
| [grantila/fetch-h2](https://github.com/grantila/fetch-h2) | 117 | `npm run lint && node_modules/.bin/nyc --require source-map-support/register npm run mocha` | 
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 115 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 85 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
| [googleapis/nodejs-bigquery](https://github.com/googleapis/nodejs-bigquery) | 85 | `nyc mocha build/test` | 
...
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 74 | `nyc --reporter=html mocha --timeout 0 --require ts-node/register --require source-map-support/register --recursive src/test.ts && lua tests/spec.lua` | 
...
| [waitingsong/node-win32-api](https://github.com/waitingsong/node-win32-api) | 55 | `mocha --opts test/mocha.opts` | 
...
| [angular-extensions/model](https://github.com/angular-extensions/model) | 42 | `npm run lint && npm run format:test && nyc mocha {lib,schematics}/**/*.test.ts --require ts-node/register --require source-map-support/register` | 
