...
The list was updated at 01:56:16 03/03/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 70126 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17260 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13102 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11445 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7228 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6583 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5755 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4981 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4778 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4763 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4066 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3441 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3226 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3040 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2921 | `mocha` | 
| [retejs/rete](https://github.com/retejs/rete) | 2920 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2658 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts'` | 
...
| [benjamn/recast](https://github.com/benjamn/recast) | 2262 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1956 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1560 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1509 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1491 | `nyc -x '' mocha` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1490 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1449 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1356 | `mocha --opts mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 1327 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1304 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1125 | `nyc --reporter=html --reporter=text mocha` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 785 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 663 | `mocha test/unit` | 
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 660 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 618 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
...
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 606 | `nyc mocha build/test` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 605 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 602 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [szokodiakos/typegoose](https://github.com/szokodiakos/typegoose) | 602 | `npm run lint && nyc npm run mocha` | 
...
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 594 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [mateogianolio/vectorious](https://github.com/mateogianolio/vectorious) | 554 | `nyc mocha -r ts-node/register ./src/*.spec.ts` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 538 | `tsc && mocha test && yarn lint` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 478 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 371 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 351 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 302 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 274 | `cd test && mocha -r ts-node/register *.ts` | 
| [albburtsev/bem-cn](https://github.com/albburtsev/bem-cn) | 270 | `mocha src/**/*.spec.ts` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 270 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 251 | `nyc mocha` | 
...
| [liangzeng/cqrs](https://github.com/liangzeng/cqrs) | 240 | `tsc && mocha` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 212 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [microsoftgraph/msgraph-sdk-javascript](https://github.com/microsoftgraph/msgraph-sdk-javascript) | 199 | `mocha lib/spec/core` | 
...
| [pnp/office365-cli](https://github.com/pnp/office365-cli) | 188 | `nyc -r=lcov -r=text mocha "dist/**/*.spec.js"` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 171 | `mocha --delay` | 
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 170 | `tsc && mocha` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 165 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [tunnelvisionlabs/antlr4ts](https://github.com/tunnelvisionlabs/antlr4ts) | 132 | `mocha` | 
...
| [jf3096/json-typescript-mapper](https://github.com/jf3096/json-typescript-mapper) | 102 | `mocha ./spec/*.js` | 
...
| [sudheerj/generator-jhipster-primeng](https://github.com/sudheerj/generator-jhipster-primeng) | 99 | `mocha test/* --timeout 500000` | 
...
| [carlansley/swagger2-koa](https://github.com/carlansley/swagger2-koa) | 89 | `npm run build && _mocha $(find build -name '*.spec.js') && npm run lint` | 
| [Cody2333/koa-swagger-decorator](https://github.com/Cody2333/koa-swagger-decorator) | 87 | `./node_modules/mocha/bin/mocha -r babel-core/register test/**/*.js --bail -t 2000000` | 
| [gcanti/elm-ts](https://github.com/gcanti/elm-ts) | 86 | `npm run lint && npm run mocha` | 
| [koltyakov/sp-rest-proxy](https://github.com/koltyakov/sp-rest-proxy) | 86 | `ts-node ./test/init && mocha --opts test/mocha.opts || ECHO.` | 
| [rh389/dynamodb-geo.js](https://github.com/rh389/dynamodb-geo.js) | 85 | `mocha --require ts-node/register test/**/*.ts` | 
| [shlomiassaf/ngc-webpack](https://github.com/shlomiassaf/ngc-webpack) | 84 | `npm run build-test && ./node_modules/.bin/mocha dist/test/*.spec.js --recursive` | 
| [ui-jar/ui-jar](https://github.com/ui-jar/ui-jar) | 84 | `tsc && mocha "dist/test/**/*.js" ` | 
...
| [puzzle-js/puzzle-js](https://github.com/puzzle-js/puzzle-js) | 75 | `nyc --check-coverage --lines=85 cross-env NODE_ENV=production mocha -r ts-node/register  --recursive 'test/**/*.spec.ts'` | 
...
| [dupski/json-to-graphql-query](https://github.com/dupski/json-to-graphql-query) | 69 | `mocha -r ts-node/register --recursive "./src/**/__tests__/*"` | 
...
| [angular-extensions/model](https://github.com/angular-extensions/model) | 59 | `npm run lint && npm run format:test && nyc mocha {lib,schematics}/**/*.test.ts --require ts-node/register --require source-map-support/register` | 
...
| [ngduc/node-rem](https://github.com/ngduc/node-rem) | 49 | `cross-env NODE_ENV=test nyc --reporter=html --reporter=text --reporter=lcov mocha --require ts-node/register --full-trace --bail --timeout 20000 --exit tests/**/*.ts` | 
...
| [RobinCK/typeorm-fixtures](https://github.com/RobinCK/typeorm-fixtures) | 42 | `nyc mocha` | 
