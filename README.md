...
The list was updated at 01:56:22 03/17/19 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 71515 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 17476 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 13451 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 11714 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7274 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6666 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5828 | `npm run mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 5055 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4855 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4790 | `mocha` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 4228 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3454 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3344 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 3103 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [retejs/rete](https://github.com/retejs/rete) | 2965 | `BABEL_ENV=test mocha -r ts-node/register test/**.ts` | 
...
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2371 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1560 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1512 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1511 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1505 | `nyc -x '' mocha` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1447 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1373 | `mocha --opts mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 1362 | `nyc --cache false mocha --timeout 100000 -- 'tests/**/*.js'` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1123 | `tsc -p ./ && mocha` | 
...
| [youzan/zan-proxy](https://github.com/youzan/zan-proxy) | 996 | `nyc mocha dist/**/*.spec.js` | 
...
| [dsherret/ts-morph](https://github.com/dsherret/ts-morph) | 615 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 535 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 516 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 491 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
...
| [felixfbecker/vscode-php-debug](https://github.com/felixfbecker/vscode-php-debug) | 409 | `mocha out/test --timeout 20000 --slow 1000 --retries 4` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 354 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
...
| [alibaba/pont](https://github.com/alibaba/pont) | 301 | `mocha --timeout 15000 -r ts-node/register test/**/test.ts` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 300 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 238 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
...
| [Microsoft/TypeScript-TmLanguage](https://github.com/Microsoft/TypeScript-TmLanguage) | 125 | `mocha --full-trace tests/test.js  --reporter mocha-multi-reporters` | 
...
| [eclipse/sprotty](https://github.com/eclipse/sprotty) | 47 | `jenkins-mocha --opts ./configs/mocha.opts "./src/**/*.spec.?(ts|tsx)"` | 
