...
The list was updated at 00:43:42 10/14/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 61703 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15219 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9344 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8645 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8138 | `mocha --opts mocha.opts && agadoo shared.js` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6844 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5830 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4884 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4436 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4063 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3298 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2754 | `mocha` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2640 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2434 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2410 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2193 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2034 | `./node_modules/.bin/mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1758 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [itchio/itch](https://github.com/itchio/itch) | 923 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 909 | `mocha --opts test/mocha.opts` | 
| [google/clasp](https://github.com/google/clasp) | 891 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 887 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 772 | `mocha bin/tests/test.js` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 887 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 710 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
...
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 655 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
| [laoqiren/mlhelper](https://github.com/laoqiren/mlhelper) | 644 | `mocha --recursive` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 637 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [emilioastarita/lyricfier](https://github.com/emilioastarita/lyricfier) | 542 | `mocha` | 
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 541 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 527 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 405 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 377 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts` | 
...
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 197 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 176 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 169 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
...
| [microsoftgraph/msgraph-sdk-javascript](https://github.com/microsoftgraph/msgraph-sdk-javascript) | 159 | `mocha lib/spec/core` | 
...
| [emmanueltouzery/prelude.ts](https://github.com/emmanueltouzery/prelude.ts) | 143 | `rm tests/apidoc-*; tsc && node ./dist/tests/Comments.js && tsc && ./node_modules/mocha/bin/mocha --throw-deprecation --timeout 60000 ./dist/tests/*.js` | 
...
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 130 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [Microsoft/monaco-languages](https://github.com/Microsoft/monaco-languages) | 112 | `mocha` | 
| [TreeGateway/tree-gateway](https://github.com/TreeGateway/tree-gateway) | 110 | `cross-env NODE_ENV=test mocha --exit` | 
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 108 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 96 | `nyc --reporter=html --reporter=text mocha` | 
...
| [atlassian/nucleus](https://github.com/atlassian/nucleus) | 76 | `mocha --compilers ts:ts-node/register src/__spec__/rest.ts src/**/__spec__/*_spec.ts src/**/**/__spec__/*_spec.ts` | 
...
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 71 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
...
| [duffman/tspath](https://github.com/duffman/tspath) | 43 | `mocha -r ts-node/register test/**.*/test.ts` | 
