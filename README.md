...
The list was updated at 01:55:27 12/05/18 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 65060 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16080 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 10581 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 9481 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8585 | `mocha --opts mocha.opts` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6952 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6093 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5229 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4558 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4318 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 3765 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3367 | `mocha --opts mocha.opts` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2815 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2685 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2621 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2426 | `mocha 'test/**/*.ts'` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2383 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2175 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
...
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1845 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 1660 | `find web/js -name '*Test.js' | xargs mocha-parallel-tests --timeout 20000 --max-parallel=1 --exit` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1353 | `nyc -x '' mocha` | 
| [gamestdio/colyseus](https://github.com/gamestdio/colyseus) | 1334 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [Polymer/polymer-bundler](https://github.com/Polymer/polymer-bundler) | 1233 | `tsc && tslint -c tslint.json src/*.ts src/**/*.ts && mocha` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1213 | `mocha --opts mocha.opts` | 
| [funkia/list](https://github.com/funkia/list) | 1211 | `nyc mocha --timeout 10000 --recursive test/*.ts` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1210 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1180 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1153 | `npm run vscode:prepublish && node ./node_modules/bin/mocha --recursive` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1106 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1090 | `nyc --reporter=html --reporter=text mocha` | 
| [google/clasp](https://github.com/google/clasp) | 1056 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 854 | `mocha bin/tests/test.js` | 
...
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 724 | `mocha --compilers ts:ts-node/register test/*.js || true` | 
...
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 652 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 595 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 526 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 443 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
...
| [spiffcode/ghedit](https://github.com/spiffcode/ghedit) | 271 | `mocha` | 
| [cdonohue/polychrome](https://github.com/cdonohue/polychrome) | 270 | `mocha --compilers js:babel-register test/**/*.js` | 
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 270 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [dubzzz/fast-check](https://github.com/dubzzz/fast-check) | 234 | `npm run build && nyc mocha "test/unit/**/*.spec.ts"` | 
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 232 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
| [veonim/veonim](https://github.com/veonim/veonim) | 225 | `mocha test/unit` | 
...
| [bmewburn/intelephense](https://github.com/bmewburn/intelephense) | 189 | `mocha -r ts-node/register test/*.ts` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 153 | `nyc mocha` | 
...
| [Microsoft/vscode-vsce](https://github.com/Microsoft/vscode-vsce) | 133 | `gulp compile && mocha` | 
...
| [ConquestArrow/dtsmake](https://github.com/ConquestArrow/dtsmake) | 132 | `mocha --compilers ts:ts-node/register test/*.ts` | 
...
| [atomist/sdm](https://github.com/atomist/sdm) | 114 | `mocha --require espower-typescript/guess "test/**/*.test.ts"` | 
...
| [functionalone/serverless-iam-roles-per-function](https://github.com/functionalone/serverless-iam-roles-per-function) | 106 | `nyc mocha --require ts-node/register --require source-map-support/register  ./src/test/**/*.test.ts` | 
...
| [dsherret/ts-nameof](https://github.com/dsherret/ts-nameof) | 105 | `yarn run --silent copy-test-files && nyc --reporter=lcov mocha --opts mocha.opts` | 
...
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 100 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
| [rjmacarthy/express-typescript-starter](https://github.com/rjmacarthy/express-typescript-starter) | 100 | `mocha -r ts-node/register -w ./spec/**/*.spec.ts` | 
| [rohitpaulk/todoist-tribute](https://github.com/rohitpaulk/todoist-tribute) | 100 | `mocha --compilers ts:ts-node/register app/javascript/packs/tests/**/*.ts` | 
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 100 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
...
| [vrimar/construct-ui](https://github.com/vrimar/construct-ui) | 77 | `cross-env TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [bpatrik/pigallery2](https://github.com/bpatrik/pigallery2) | 55 | `ng test && mocha --recursive test/backend/unit && mocha --recursive test/backend/integration  && mocha --recursive test/common/unit ` | 
...
| [dupski/json-to-graphql-query](https://github.com/dupski/json-to-graphql-query) | 48 | `mocha -r ts-node/register --recursive "./src/**/__tests__/*"` | 
