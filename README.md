...
The list was updated at 01:55:30 01/26/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 67982 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16807 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 12018 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10602 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7092 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6362 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5565 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4678 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4613 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4409 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3508 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3412 | `mocha --opts mocha.opts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 3024 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2906 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2867 | `mocha` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2527 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2443 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2269 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2197 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1913 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1895 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1809 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1778 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1456 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1436 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1426 | `nyc -x '' mocha` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1369 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1329 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1286 | `mocha --opts mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1259 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1219 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [google/clasp](https://github.com/google/clasp) | 1209 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1136 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [firebase/geofire-js](https://github.com/firebase/geofire-js) | 1106 | `nyc --reporter=html --reporter=text mocha` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1069 | `tsc -p ./ && mocha` | 
...
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 929 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 913 | `mocha bin/tests/test.js` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 775 | `mocha test/backend` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 767 | `mocha --require ts-node/register` | 
| [coinbase/gdax-tt](https://github.com/coinbase/gdax-tt) | 737 | `yarn run lint && yarn run test:mocha` | 
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 727 | `mocha` | 
| [ClusterWS/ClusterWS](https://github.com/ClusterWS/ClusterWS) | 716 | `mocha -r ts-node/register ./tests/specs/*.spec.ts --exit` | 
| [angular/dgeni](https://github.com/angular/dgeni) | 713 | `mocha --require ts-node/register -R spec src/**/*.spec.ts` | 
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 711 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 696 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
| [alexjlockwood/avocado](https://github.com/alexjlockwood/avocado) | 672 | `./node_modules/.bin/mocha --require ts-node/register ./test/**/*.spec.ts` | 
| [laoqiren/mlhelper](https://github.com/laoqiren/mlhelper) | 645 | `mocha --recursive` | 
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 627 | `mocha "out/**/*.spec.js" -s 0` | 
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 611 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 599 | `mocha test/unit` | 
...
| [data-forge/data-forge-ts](https://github.com/data-forge/data-forge-ts) | 587 | `nyc mocha --opts ./src/test/mocha.opts` | 
| [RxJS-CN/RxJS-Docs-CN](https://github.com/RxJS-CN/RxJS-Docs-CN) | 585 | `npm-run-all clean_spec build_spec test_mocha clean_spec` | 
| [googleapis/google-auth-library-nodejs](https://github.com/googleapis/google-auth-library-nodejs) | 580 | `nyc mocha build/test` | 
| [pgilad/leasot](https://github.com/pgilad/leasot) | 579 | `mocha --require ts-node/register -R spec './tests/*.ts'` | 
| [YousefED/typescript-json-schema](https://github.com/YousefED/typescript-json-schema) | 575 | `npm run build && mocha -t 5000 --require source-map-support/register test` | 
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 563 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 558 | `mocha test` | 
| [emilioastarita/lyricfier](https://github.com/emilioastarita/lyricfier) | 557 | `mocha` | 
| [SierraSoftworks/Iridium](https://github.com/SierraSoftworks/Iridium) | 539 | `mocha --opts test/mocha.opts dist/test` | 
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 538 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 494 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 489 | `mocha --opts mocha.opts` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 489 | `mocha --opts mocha.opts` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 478 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 477 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
| [firebase/firebase-functions](https://github.com/firebase/firebase-functions) | 473 | `npm run mocha` | 
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 471 | `tsc && mocha test && yarn lint` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 469 | `cd test && mocha -r ts-node/register *.ts` | 
| [Cookie-AutoDelete/Cookie-AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) | 466 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec ./test/*` | 
| [43081j/rar.js](https://github.com/43081j/rar.js) | 462 | `npm run build && mocha` | 
| [pact-foundation/pact-js](https://github.com/pact-foundation/pact-js) | 456 | `nyc --check-coverage --reporter=html --reporter=text-summary mocha` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 449 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
...
| [line/line-bot-sdk-nodejs](https://github.com/line/line-bot-sdk-nodejs) | 410 | `API_BASE_URL=http://localhost:1234/ TEST_PORT=1234 TS_NODE_CACHE=0 nyc mocha` | 
| [felixfbecker/vscode-php-debug](https://github.com/felixfbecker/vscode-php-debug) | 402 | `mocha out/test --timeout 20000 --slow 1000 --retries 4` | 
...
| [Microsoft/node-pty](https://github.com/Microsoft/node-pty) | 348 | `cross-env NODE_ENV=test mocha -R spec --exit lib/*.test.js` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 332 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 326 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 319 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 317 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts extension/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [GoogleChrome/chrome-launcher](https://github.com/GoogleChrome/chrome-launcher) | 309 | `mocha --require ts-node/register --reporter=dot test/**/*-test.ts --timeout=10000` | 
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 307 | `mocha` | 
| [SweetIQ/schemats](https://github.com/SweetIQ/schemats) | 303 | `npm run lint && npm run build && npm run dependency-check && mocha` | 
...
| [mgechev/aspect.js](https://github.com/mgechev/aspect.js) | 291 | `tsc && mocha -R nyan ./dist/test/**/*.spec.js` | 
...
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 263 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec --bail` | 
| [FormidableLabs/inspectpack](https://github.com/FormidableLabs/inspectpack) | 256 | `mocha "test/**/*.spec.ts"` | 
| [RisingStack/node-typescript-starter](https://github.com/RisingStack/node-typescript-starter) | 252 | `tsc && mocha dist/**/*.spec.js` | 
...
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 250 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 248 | `mocha-webpack "src/**/*.ts"` | 
...
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 232 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 221 | `cd test && mocha -r ts-node/register *.ts` | 
| [googleapis/nodejs-storage](https://github.com/googleapis/nodejs-storage) | 221 | `nyc mocha build/test` | 
...
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 209 | `nyc mocha` | 
...
| [jedmao/eclint](https://github.com/jedmao/eclint) | 206 | `nyc npm run mocha -- --reporter lcov --reporter spec` | 
| [Zarel/Pokemon-Showdown-Client](https://github.com/Zarel/Pokemon-Showdown-Client) | 202 | `eslint --config=.eslintrc.js --cache --cache-file=eslint-cache/base js/ data/ && eslint --config=build-tools/.eslintrc.js --cache --cache-file=eslint-cache/build build-tools/update build-tools/build-indexes && tslint --project . && tsc && node build && mocha` | 
| [R-js/blasjs](https://github.com/R-js/blasjs) | 202 | `cross-env-shell NODE_ENV=test TS_NODE_DISABLE_WARNINGS=true nyc mocha` | 
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 200 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
...
| [pnp/office365-cli](https://github.com/pnp/office365-cli) | 178 | `nyc -r=lcov -r=text mocha "dist/**/*.spec.js"` | 
...
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 170 | `nyc mocha test/**/*.test.ts --exit` | 
...
| [PeterDing/chord](https://github.com/PeterDing/chord) | 155 | `./node_modules/mocha/bin/mocha --delay` | 
...
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 150 | `tsc && mocha` | 
| [Microsoft/vscode-vsce](https://github.com/Microsoft/vscode-vsce) | 149 | `gulp compile && mocha` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 143 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 143 | `nyc --reporter=html --reporter=text mocha` | 
...
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 139 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [TrustWallet/trust-ray](https://github.com/TrustWallet/trust-ray) | 134 | `cross-env NODE_ENV=test mocha --recursive --require ts-node/register 'test/**/*.test.ts' --exit` | 
| [rhysd/neovim-component](https://github.com/rhysd/neovim-component) | 133 | `mocha test/unit/ --exit` | 
| [vrimar/construct-ui](https://github.com/vrimar/construct-ui) | 132 | `cross-env TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [Enterprise-JS/vscode-ts-node-debugging](https://github.com/Enterprise-JS/vscode-ts-node-debugging) | 131 | `npm run mocha --recursive ./src/**/__tests__/*` | 
...
| [colyseus/colyseus.js](https://github.com/colyseus/colyseus.js) | 123 | `mocha test/*.ts --require ts-node/register` | 
...
| [matthew-matvei/freeman](https://github.com/matthew-matvei/freeman) | 118 | `xvfb-maybe electron-mocha --renderer __tests__` | 
| [TreeGateway/tree-gateway](https://github.com/TreeGateway/tree-gateway) | 118 | `cross-env NODE_ENV=test mocha --exit` | 
| [redhat-developer/yaml-language-server](https://github.com/redhat-developer/yaml-language-server) | 118 | `mocha --require ts-node/register --ui tdd ./test/*.test.ts` | 
...
| [functionalone/serverless-iam-roles-per-function](https://github.com/functionalone/serverless-iam-roles-per-function) | 114 | `nyc mocha --require ts-node/register --require source-map-support/register  ./src/test/**/*.test.ts` | 
...
| [grantila/fetch-h2](https://github.com/grantila/fetch-h2) | 112 | `npm run lint && node_modules/.bin/nyc --require source-map-support/register npm run mocha` | 
...
| [englercj/tsd-jsdoc](https://github.com/englercj/tsd-jsdoc) | 110 | `mocha --ui tdd -r ts-node/register test/specs/**.ts` | 
| [Esri/react-arcgis](https://github.com/Esri/react-arcgis) | 110 | `nyc mocha` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 106 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
...
| [jvilk/MakeTypes](https://github.com/jvilk/MakeTypes) | 104 | `npm-run-all --serial prepublish generate:test build:test mocha` | 
...
| [atlassian/nucleus](https://github.com/atlassian/nucleus) | 102 | `mocha --compilers ts:ts-node/register src/__spec__/rest.ts src/**/__spec__/*_spec.ts src/**/**/__spec__/*_spec.ts` | 
...
| [gcanti/prop-types-ts](https://github.com/gcanti/prop-types-ts) | 99 | `npm run lint && npm run prettier && npm run mocha` | 
...
| [kimamula/ts-transformer-keys](https://github.com/kimamula/ts-transformer-keys) | 95 | `tsc && node ./test/compileMain.js && mocha ./test/main.js` | 
...
| [argoproj/argo-ci](https://github.com/argoproj/argo-ci) | 88 | `TS_NODE_PROJECT=./src/tests/tsconfig.json mocha --require ts-node/register ./src/tests/**/*spec.ts` | 
| [carlansley/swagger2-koa](https://github.com/carlansley/swagger2-koa) | 88 | `npm run build && _mocha $(find build -name '*.spec.js') && npm run lint` | 
...
| [balassy/aws-lambda-typescript](https://github.com/balassy/aws-lambda-typescript) | 83 | `nyc mocha` | 
| [Azure/azure-cosmos-js](https://github.com/Azure/azure-cosmos-js) | 83 | `mocha -r ./src/test/common/setup.ts ./lib/src/test/ --recursive --timeout 100000 -i -g .*ignore.js` | 
...
| [googleapis/nodejs-bigquery](https://github.com/googleapis/nodejs-bigquery) | 82 | `nyc mocha build/test` | 
...
| [metadevpro/openapi3-ts](https://github.com/metadevpro/openapi3-ts) | 75 | `mocha --recursive --compilers ts:ts-node/register --require source-map-support/register "src/**/*.spec.ts"` | 
...
| [roblox-ts/roblox-ts](https://github.com/roblox-ts/roblox-ts) | 72 | `nyc --reporter=html mocha --timeout 0 --require ts-node/register --require source-map-support/register --recursive src/test.ts && lua tests/spec.lua` | 
...
| [ninoseki/mitaka](https://github.com/ninoseki/mitaka) | 66 | `nyc mocha -r ts-node/register "src/**/*.spec.ts"` | 
| [deerawan/vscode-dash](https://github.com/deerawan/vscode-dash) | 65 | `./node_modules/istanbul/lib/cli.js cover ./node_modules/mocha/bin/_mocha -- -R spec --ui tdd ./out/test/extension.test.js` | 
...
| [teamdomy/domy](https://github.com/teamdomy/domy) | 62 | `mocha --reporter spec --require ts-node/register 'tests/**/*.spec.ts'` | 
...
| [duffman/tspath](https://github.com/duffman/tspath) | 58 | `mocha -r ts-node/register test/**.*/test.ts` | 
...
| [woutervh-/typescript-is](https://github.com/woutervh-/typescript-is) | 57 | `npm run lint && npm run build && ttsc --project tsconfig-test.json && mocha` | 
...
| [lukeautry/ts-app](https://github.com/lukeautry/ts-app) | 56 | `cross-env TS_NODE_PROJECT=./api/tsconfig.json mocha -t 15000 -r ts-node/register "./api/**/*.spec.ts"` | 
| [nhabuiduc/react-filter-box](https://github.com/nhabuiduc/react-filter-box) | 56 | `node --max-old-space-size=16000 ./node_modules/.bin/mocha-webpack --require ignore-styles -r jsdom-global/register --webpack-config webpack.test.config.js --watch "./test/**/*.ts"` | 
...
| [jsonapi-suite/jsorm](https://github.com/jsonapi-suite/jsorm) | 56 | `NODE_ENV=test mocha --opts test/mocha.opts` | 
| [w11k/ngx-componentdestroyed](https://github.com/w11k/ngx-componentdestroyed) | 55 | `mocha --opts spec/mocha.opts src/**/*test.ts` | 
...
| [rcjsuen/dockerfile-language-server-nodejs](https://github.com/rcjsuen/dockerfile-language-server-nodejs) | 52 | `mocha out/test` | 
...
| [Microsoft/vscode-json-languageservice](https://github.com/Microsoft/vscode-json-languageservice) | 50 | `npm run compile && mocha && npm run lint` | 
...
| [JustinBeckwith/retry-axios](https://github.com/JustinBeckwith/retry-axios) | 48 | `nyc mocha build/test --timeout 5000 --require source-map-support/register` | 
...
| [aykutkardas/Json-Function](https://github.com/aykutkardas/Json-Function) | 47 | `cross-env TS_NODE_COMPILER_OPTIONS='{ "module": "commonjs" }' mocha -r ts-node/register -r ignore-styles -r jsdom-global/register test/**/*.spec.ts` | 
| [AEB-labs/cruddl](https://github.com/AEB-labs/cruddl) | 47 | `tsc --noEmit --skipLibCheck && mocha --opts ./spec/mocha.opts` | 
| [rgraphql/soyuz](https://github.com/rgraphql/soyuz) | 47 | `npm run lint && npm run mocha` | 
| [argoproj/argo-ui](https://github.com/argoproj/argo-ui) | 46 | `mocha --require ts-node/register ./src/app/**/*.spec.ts` | 
...
| [Grademark/grademark](https://github.com/Grademark/grademark) | 45 | `nyc mocha --opts ./src/test/mocha.opts` | 
...
| [seansfkelley/synology-download-manager](https://github.com/seansfkelley/synology-download-manager) | 44 | `TS_NODE_PROJECT=test/tsconfig-test.json mocha --require ts-node/register 'test/**/*.{ts,tsx}'` | 
...
| [Microsoft/vscode-html-languageservice](https://github.com/Microsoft/vscode-html-languageservice) | 42 | `npm run compile && mocha && npm run lint` | 
...
| [jackrobertscott/graphql-api-demo](https://github.com/jackrobertscott/graphql-api-demo) | 42 | `NODE_ENV=test mocha --require=ts-node/register --recursive --exit 'src/**/*.spec.ts'` | 
...
| [dhruvrajvanshi/ts-failable](https://github.com/dhruvrajvanshi/ts-failable) | 40 | `mocha --compilers ts:ts-node/register './test/**/*[tj]s'` | 
...
| [pokemongo-dev-contrib/pokemongo-json-pokedex](https://github.com/pokemongo-dev-contrib/pokemongo-json-pokedex) | 39 | `mocha --recursive --compilers ts:ts-node/register,ts:tsconfig-paths/register test/*.ts test/**/*.ts` | 
...
| [angular-extensions/model](https://github.com/angular-extensions/model) | 35 | `npm run lint && npm run format:test && nyc mocha {lib,schematics}/**/*.test.ts --require ts-node/register --require source-map-support/register` | 
...
| [yesmeck/waque](https://github.com/yesmeck/waque) | 34 | `nyc mocha --forbid-only "test/**/*.test.ts"` | 
| [strongloop/loopback4-example-shopping](https://github.com/strongloop/loopback4-example-shopping) | 34 | `lb-mocha --allow-console-logs "dist/test"` | 
...
| [bromne/typescript-optional](https://github.com/bromne/typescript-optional) | 34 | `nyc mocha src/*` | 
