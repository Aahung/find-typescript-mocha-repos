...
The list was updated at 01:55:35 01/15/19 PST
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 67346 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 16655 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 11677 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 10354 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 7044 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 6304 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 5514 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4653 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4552 | `npm-run-all test:pre -p test:mocha test:rules` | 
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 4263 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [williamngan/pts](https://github.com/williamngan/pts) | 3408 | `mocha --opts mocha.opts` | 
| [rrweb-io/rrweb](https://github.com/rrweb-io/rrweb) | 3276 | `npm run bundle:browser && cross-env TS_NODE_CACHE=false TS_NODE_FILES=true mocha -r ts-node/register test/**/*.test.ts` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2937 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
| [michaelgrosner/tribeca](https://github.com/michaelgrosner/tribeca) | 2866 | `mocha` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2852 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [electron-userland/electron-forge](https://github.com/electron-userland/electron-forge) | 2489 | `cross-env TS_NODE_FILES=true yarn run mocha './tools/test-globber.ts' --opts mocha.opts` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2437 | `mocha 'test/**/*.ts'` | 
| [compodoc/compodoc](https://github.com/compodoc/compodoc) | 2249 | `mocha-parallel-tests test && node test/dist/cli/cli-revert-root-folder.js` | 
| [benjamn/recast](https://github.com/benjamn/recast) | 2176 | `npm run tsc && npm run mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1891 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1884 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1807 | `mocha` | 
| [staltz/xstream](https://github.com/staltz/xstream) | 1767 | `npm run lint && npm run test-types && npm run mocha && npm run doctest` | 
| [Microsoft/vscode-chrome-debug](https://github.com/Microsoft/vscode-chrome-debug) | 1442 | `mocha --exit --timeout 20000 -s 2000 -u tdd --colors "./out/test/*.test.js"` | 
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1418 | `nyc -x '' mocha` | 
| [colyseus/colyseus](https://github.com/colyseus/colyseus) | 1408 | `mocha --require ts-node/register test/**Test.ts --exit` | 
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 1334 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [shanalikhan/code-settings-sync](https://github.com/shanalikhan/code-settings-sync) | 1292 | `npm run tslint-check && tsc -p ./ && mocha --recursive "./out/test/**/*.js"` | 
| [sveltejs/sapper](https://github.com/sveltejs/sapper) | 1277 | `mocha --opts mocha.opts` | 
| [cherow/cherow](https://github.com/cherow/cherow) | 1233 | `cross-env TS_NODE_PROJECT="test/tsconfig.json" mocha "test/**/*.ts" -c -R progress -r ts-node/register -r source-map-support/register --recursive --globals expect` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1209 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
| [google/clasp](https://github.com/google/clasp) | 1160 | `nyc --cache false mocha --timeout 100000 -- tests/*.js` | 
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 1061 | `tsc -p ./ && mocha` | 
| [itchio/itch](https://github.com/itchio/itch) | 1005 | `cross-env TS_NODE_PROJECT=tsconfig.test.json mocha -r ts-node/register -r tsconfig-paths/register ./src/**/*.spec.ts` | 
| [WuTheFWasThat/vimflowy](https://github.com/WuTheFWasThat/vimflowy) | 940 | `mocha --opts test/mocha.opts` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 925 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
| [Microsoft/dts-gen](https://github.com/Microsoft/dts-gen) | 893 | `mocha bin/tests/test.js` | 
| [netgusto/nodebook](https://github.com/netgusto/nodebook) | 771 | `mocha test/backend` | 
| [simonbengtsson/jsPDF-AutoTable](https://github.com/simonbengtsson/jsPDF-AutoTable) | 757 | `mocha --require ts-node/register` | 
| [coinbase/gdax-tt](https://github.com/coinbase/gdax-tt) | 735 | `yarn run lint && yarn run test:mocha` | 
| [iotaledger/iota.js](https://github.com/iotaledger/iota.js) | 719 | `mocha` | 
...
| [davidkpiano/flipping](https://github.com/davidkpiano/flipping) | 702 | `NODE_ENV=test && mocha -r ts-node/register test/**.test.ts` | 
| [rubyide/vscode-ruby](https://github.com/rubyide/vscode-ruby) | 691 | `node ./node_modules/mocha/bin/mocha --recursive ./out/*.test.js` | 
...
| [mrmlnc/fast-glob](https://github.com/mrmlnc/fast-glob) | 618 | `mocha "out/**/*.spec.js" -s 0` | 
...
| [opentracing/opentracing-javascript](https://github.com/opentracing/opentracing-javascript) | 605 | `mocha lib/test/unittest.js --check-leaks --color` | 
...
| [veonim/veonim](https://github.com/veonim/veonim) | 579 | `mocha test/unit` | 
...
| [andrerpena/react-mde](https://github.com/andrerpena/react-mde) | 556 | `mocha --timeout 15000 -r ts-node/register ./test/*Spec.ts` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 520 | `cross-env TS_NODE_COMPILER="ttypescript" TS_NODE_TRANSPILE_ONLY="true" mocha --opts mocha.opts --grep @performance --invert` | 
| [benjamn/ast-types](https://github.com/benjamn/ast-types) | 495 | `npm run gen && npm run tsc && npm run mocha` | 
| [Rich-Harris/devalue](https://github.com/Rich-Harris/devalue) | 487 | `mocha --opts mocha.opts` | 
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 485 | `cross-env NODE_ENV=tsoa_test mocha **/*.spec.ts --exit --compilers ts:ts-node/register` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 483 | `mocha --opts mocha.opts` | 
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 472 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [sourcegraph/javascript-typescript-langserver](https://github.com/sourcegraph/javascript-typescript-langserver) | 470 | `mocha --require source-map-support/register --timeout 7000 --slow 2000 lib/test/**/*.js` | 
| [43081j/rar.js](https://github.com/43081j/rar.js) | 462 | `npm run build && mocha` | 
| [championswimmer/vuex-persist](https://github.com/championswimmer/vuex-persist) | 461 | `cd test && mocha -r ts-node/register *.ts` | 
...
| [whitecolor/yalc](https://github.com/whitecolor/yalc) | 458 | `tsc && mocha test && yarn lint` | 
...
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 446 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
...
| [felixfbecker/vscode-php-debug](https://github.com/felixfbecker/vscode-php-debug) | 398 | `mocha out/test --timeout 20000 --slow 1000 --retries 4` | 
...
| [arangodb/arangojs](https://github.com/arangodb/arangojs) | 341 | `mocha --growl --reporter spec --require source-map-support/register --timeout 10000 lib/async/test` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 329 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
| [biesbjerg/ngx-translate-extract](https://github.com/biesbjerg/ngx-translate-extract) | 320 | `mocha -r ts-node/register tests/**/*.spec.ts` | 
...
| [Canner/apollo-link-firebase](https://github.com/Canner/apollo-link-firebase) | 310 | `TS_NODE_COMPILER_OPTIONS='{"module":"commonjs"}' mocha --timeout 10000 --compilers ts:ts-node/register --recursive --exit "test/**/*.spec.ts"` | 
| [dividab/tsconfig-paths](https://github.com/dividab/tsconfig-paths) | 303 | `mocha` | 
...
| [codemirror/codemirror.next](https://github.com/codemirror/codemirror.next) | 301 | `mocha -r ts-node/register/transpile-only doc/test/test-*.ts state/test/test-*.ts history/test/test-*.ts rangeset/test/test-rangeset.ts keymap/test/test-*.ts legacy-modes/test/test-*.ts view/test/test-heightmap.ts` | 
...
| [FormidableLabs/inspectpack](https://github.com/FormidableLabs/inspectpack) | 252 | `mocha "test/**/*.spec.ts"` | 
...
| [ReactiveX/rxjs-tslint](https://github.com/ReactiveX/rxjs-tslint) | 246 | `rimraf dist && tsc && mocha -R nyan dist/test --recursive` | 
| [Kononnable/typeorm-model-generator](https://github.com/Kononnable/typeorm-model-generator) | 246 | `istanbul cover ./node_modules/mocha/bin/_mocha dist/test/**/*.test.js  -- -R spec` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 242 | `mocha-webpack "src/**/*.ts"` | 
| [rubenspgcavalcante/webpack-chrome-extension-reloader](https://github.com/rubenspgcavalcante/webpack-chrome-extension-reloader) | 241 | `NODE_ENV=test webpack && mocha dist/tests.js` | 
...
| [styleguidist/react-docgen-typescript](https://github.com/styleguidist/react-docgen-typescript) | 224 | `tsc && mocha --timeout 10000 ./lib/**/__tests__/**.js` | 
...
| [championswimmer/vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) | 213 | `cd test && mocha -r ts-node/register *.ts` | 
| [googleapis/nodejs-storage](https://github.com/googleapis/nodejs-storage) | 213 | `nyc mocha build/test` | 
...
| [cartant/rxjs-tslint-rules](https://github.com/cartant/rxjs-tslint-rules) | 205 | `yarn run lint && yarn run test:build && yarn run test:mocha && yarn run test:tslint-v5 && yarn run test:tslint-v6 && yarn run test:tslint-v6-compat` | 
...
| [fabiandev/ts-runtime](https://github.com/fabiandev/ts-runtime) | 196 | `NODE_ENV=test TS_NODE_CACHE=false ./node_modules/mocha/bin/_mocha` | 
| [JumpFm/jumpfm](https://github.com/JumpFm/jumpfm) | 188 | `mocha js` | 
| [kubernetes-client/javascript](https://github.com/kubernetes-client/javascript) | 188 | `nyc mocha` | 
| [oclif/cli-ux](https://github.com/oclif/cli-ux) | 187 | `mocha --forbid-only "test/**/*.test.ts"` | 
| [microsoftgraph/msgraph-sdk-javascript](https://github.com/microsoftgraph/msgraph-sdk-javascript) | 187 | `mocha lib/spec/core` | 
...
| [ohjames/rxjs-websockets](https://github.com/ohjames/rxjs-websockets) | 176 | `npm run build && npm run mocha` | 
...
| [nozer/quill-delta-to-html](https://github.com/nozer/quill-delta-to-html) | 150 | `./node_modules/nyc/bin/nyc.js ./node_modules/mocha/bin/mocha --compilers ts:ts-node/register -b "./test/**/*.ts"  ` | 
| [nestjs/cqrs](https://github.com/nestjs/cqrs) | 148 | `tsc && mocha` | 
...
| [cartant/rxjs-marbles](https://github.com/cartant/rxjs-marbles) | 138 | `yarn run lint && yarn run test:build && cross-env FAILING=0 yarn run test:ava && cross-env FAILING=0 yarn run test:jasmine && cross-env FAILING=0 yarn run test:jasmine-angular && cross-env FAILING=0 yarn run test:jest && cross-env FAILING=0 yarn run test:mocha && cross-env FAILING=0 yarn run test:tape` | 
...
| [geofirestore/geofirestore-js](https://github.com/geofirestore/geofirestore-js) | 134 | `nyc --reporter=html --reporter=text mocha` | 
...
| [Microsoft/monaco-languages](https://github.com/Microsoft/monaco-languages) | 131 | `mocha` | 
| [nestjs/typeorm](https://github.com/nestjs/typeorm) | 130 | `rimraf ./build && tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 60000 ./build/compiled/test` | 
...
| [Microsoft/typescript-tslint-plugin](https://github.com/Microsoft/typescript-tslint-plugin) | 129 | `mocha ./out/**/*.test.js --slow 2000 --timeout 10000` | 
...
| [Soluto/graphql-to-mongodb](https://github.com/Soluto/graphql-to-mongodb) | 129 | `ts-mocha tests/**/*.spec.ts` | 
...
| [Enterprise-JS/vscode-ts-node-debugging](https://github.com/Enterprise-JS/vscode-ts-node-debugging) | 129 | `npm run mocha --recursive ./src/**/__tests__/*` | 
...
| [arfedulov/semantic-ui-calendar-react](https://github.com/arfedulov/semantic-ui-calendar-react) | 123 | `npx cross-env TS_NODE_COMPILER_OPTIONS="{""allowJs"":true}" npx mocha -r ts-node/register ./test/setup.js ./test/**/*.{js,jsx,ts,tsx}` | 
...
| [tfoxy/chrome-promise](https://github.com/tfoxy/chrome-promise) | 122 | `mocha --timeout 10000` | 
| [Odi-ts/odi](https://github.com/Odi-ts/odi) | 121 | `nyc mocha test/**/*.test.ts` | 
| [bradymholt/cRonstrue](https://github.com/bradymholt/cRonstrue) | 120 | `npx mocha --reporter spec --compilers ts:ts-node/register` | 
| [ajafff/tsutils](https://github.com/ajafff/tsutils) | 120 | `mocha test/*Tests.js && tslint --test 'test/rules/**/tslint.json'` | 
...
| [matthew-matvei/freeman](https://github.com/matthew-matvei/freeman) | 114 | `xvfb-maybe electron-mocha --renderer __tests__` | 
...
| [horiuchi/dtsgenerator](https://github.com/horiuchi/dtsgenerator) | 103 | `istanbul cover _mocha test/*.js test/**/*.js` | 
...
| [atlassian/nucleus](https://github.com/atlassian/nucleus) | 99 | `mocha --compilers ts:ts-node/register src/__spec__/rest.ts src/**/__spec__/*_spec.ts src/**/**/__spec__/*_spec.ts` | 
...
| [szdc/tiktok-api](https://github.com/szdc/tiktok-api) | 95 | `TS_NODE_PROJECT=test/tsconfig.json mocha` | 
| [googleapis/nodejs-pubsub](https://github.com/googleapis/nodejs-pubsub) | 95 | `nyc mocha build/test` | 
...
| [ynab/ynab-sdk-js](https://github.com/ynab/ynab-sdk-js) | 92 | `TS_NODE_PROJECT=./test/tsconfig.json npx mocha --reporter spec --require ts-node/register 'test/**/*.ts'` | 
...
| [balassy/aws-lambda-typescript](https://github.com/balassy/aws-lambda-typescript) | 79 | `nyc mocha` | 
...
| [MariusAlch/json-to-ts](https://github.com/MariusAlch/json-to-ts) | 76 | `npm run build && mocha ./test/js-integration/index.js && mocha ./build/test` | 
...
| [googleapis/nodejs-bigquery](https://github.com/googleapis/nodejs-bigquery) | 76 | `nyc mocha build/test` | 
| [MariusAlch/json-to-ts](https://github.com/MariusAlch/json-to-ts) | 76 | `npm run build && mocha ./test/js-integration/index.js && mocha ./build/test` | 
| [codius/codiusd](https://github.com/codius/codiusd) | 76 | `npm run lint && nyc mocha` | 
| [funkia/jabz](https://github.com/funkia/jabz) | 75 | `nyc mocha --recursive test/**/*.ts` | 
| [suksant/sequelize-typescript-examples](https://github.com/suksant/sequelize-typescript-examples) | 75 | `gulp compile && mocha 'build/*/test/**/*.js'` | 
| [Microsoft/vscode-chrome-debug-core](https://github.com/Microsoft/vscode-chrome-debug-core) | 75 | `mocha --exit --recursive -u tdd ./out/test/` | 
...
| [mshanemc/shane-sfdx-plugins](https://github.com/mshanemc/shane-sfdx-plugins) | 53 | `mocha --forbid-only "test/**/*.test.ts"` | 
...
| [mike-lischke/antlr4-c3](https://github.com/mike-lischke/antlr4-c3) | 52 | `tsc --version && tsc && mocha out/test` | 
...
| [balmbees/dynamo-types](https://github.com/balmbees/dynamo-types) | 51 | `AWS_REGION=us-east-1 AWS_ACCESS_KEY_ID=mock AWS_SECRET_ACCESS_KEY=mock DYNAMO_TYPES_ENDPOINT=http://127.0.0.1:8000 mocha -t 20000 dst/**/__test__/**/*.js` | 
| [realm/realm-graphql](https://github.com/realm/realm-graphql) | 50 | `mocha --opts config/mocha.opts` | 
| [Anonyfox/vuex-store-module-example](https://github.com/Anonyfox/vuex-store-module-example) | 50 | `rm -rf dist && tsc -p . && npm run lint && mocha dist/test` | 
...
| [realm/realm-studio](https://github.com/realm/realm-studio) | 47 | `mocha-webpack --opts=configs/mocha-webpack.opts` | 
...
| [dalenguyen/firestore-backup-restore](https://github.com/dalenguyen/firestore-backup-restore) | 46 | `mocha --reporter spec` | 
...
| [danrevah/typeserializer](https://github.com/danrevah/typeserializer) | 41 | `NODE_ENV=test mocha -r ts-node/register src/*.spec.ts src/**/*.spec.ts` | 
...
| [FontoXML/fontoxpath](https://github.com/FontoXML/fontoxpath) | 39 | `ts-mocha --require test/testhook.js "test/specs/**/*.ts"` | 
...
| [huang6349/ts-dva](https://github.com/huang6349/ts-dva) | 38 | `atool-test-mocha ./src/**/*-test.js` | 
...
| [olivierlsc/swagger-express-ts](https://github.com/olivierlsc/swagger-express-ts) | 37 | `echo "Testing..." && npm run build && nyc mocha` | 
...
| [acrazing/mobx-sync](https://github.com/acrazing/mobx-sync) | 34 | `mocha --require ts-node/register --slow 1000 ./src/**/*.spec.ts` | 
...
| [jackrobertscott/graphql-api-demo](https://github.com/jackrobertscott/graphql-api-demo) | 33 | `NODE_ENV=test mocha --require=ts-node/register --recursive --exit 'src/**/*.spec.ts'` | 
...
| [nemtech/nem2-sdk-typescript-javascript](https://github.com/nemtech/nem2-sdk-typescript-javascript) | 32 | `mocha --ui bdd --recursive ./dist/test --timeout 90000` | 