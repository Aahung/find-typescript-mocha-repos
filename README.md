...
The list was updated at 00:43:52 10/08/18 PDT
...
| --- | --- | --- |
| [Microsoft/vscode](https://github.com/Microsoft/vscode) | 61135 | `mocha` | 
| [ReactiveX/rxjs](https://github.com/ReactiveX/rxjs) | 15128 | `cross-env TS_NODE_PROJECT=spec/tsconfig.json mocha --opts spec/support/default.opts "spec/**/*-spec.ts"` | 
| [nestjs/nest](https://github.com/nestjs/nest) | 9203 | `nyc --require ts-node/register mocha packages/**/*.spec.ts --reporter spec --require 'node_modules/reflect-metadata/Reflect.js'` | 
| [typeorm/typeorm](https://github.com/typeorm/typeorm) | 8530 | `tsc && mocha --file ./build/compiled/test/utils/test-setup.js --bail --recursive --timeout 30000  ./build/compiled/test` | 
| [sveltejs/svelte](https://github.com/sveltejs/svelte) | 8112 | `mocha --opts mocha.opts && agadoo shared.js` | 
| [googleapis/google-api-nodejs-client](https://github.com/googleapis/google-api-nodejs-client) | 6821 | `nyc mocha build/test` | 
| [nexe/nexe](https://github.com/nexe/nexe) | 5786 | `mocha` | 
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | 4857 | `npm run mocha` | 
| [Microsoft/azuredatastudio](https://github.com/Microsoft/azuredatastudio) | 4417 | `mocha` | 
| [palantir/tslint](https://github.com/palantir/tslint) | 4036 | `npm-run-all test:pre -p test:mocha test:rules` | 
...
| [davidkpiano/xstate](https://github.com/davidkpiano/xstate) | 2597 | `npm run build:cjs && mocha --require ts-node/register test/**.ts test/**/*.test.ts` | 
| [vuejs/vue-class-component](https://github.com/vuejs/vue-class-component) | 2408 | `npm run build && webpack --config test/webpack.config.js && mocha test/test.build.js` | 
| [decaffeinate/decaffeinate](https://github.com/decaffeinate/decaffeinate) | 2406 | `mocha 'test/**/*.ts'` | 
| [thx/rap2-delos](https://github.com/thx/rap2-delos) | 2092 | `cross-env NODE_ENV=development cross-env TEST_MODE=true nyc mocha --exit` | 
...
| [mgechev/codelyzer](https://github.com/mgechev/codelyzer) | 1801 | `rimraf dist && tsc && ncp test/fixtures dist/test/fixtures && mocha dist/test --recursive` | 
| [yortus/asyncawait](https://github.com/yortus/asyncawait) | 1790 | `mocha` | 
| [s-panferov/awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) | 1746 | `rimraf .test && mocha --trace-warnings --timeout 30000 --exit dist/__test__` | 
...
| [vscode-icons/vscode-icons](https://github.com/vscode-icons/vscode-icons) | 1278 | `nyc -x '' mocha` | 
...
| [jakubroztocil/rrule](https://github.com/jakubroztocil/rrule) | 1127 | `TS_NODE_PROJECT=tsconfig.test.json mocha **/*.test.ts` | 
...
| [Keyang/node-csvtojson](https://github.com/Keyang/node-csvtojson) | 1047 | `rm -Rf .ts-node && TS_NODE_CACHE_DIRECTORY=.ts-node mocha -r ts-node/register src/**/*.test.ts ./test/*.ts -R spec` | 
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 987 | `tsc -p ./ && mocha` | 
...
| [strongloop/loopback-next](https://github.com/strongloop/loopback-next) | 866 | `node packages/build/bin/run-nyc npm run mocha --scripts-prepend-node-path` | 
| [mgechev/ngrev](https://github.com/mgechev/ngrev) | 841 | `electron-mocha app/specs.js.autogenerated --renderer --require source-map-support/register` | 
...
| [jaysoo/todomvc-redux-react-typescript](https://github.com/jaysoo/todomvc-redux-react-typescript) | 597 | `tsc && mocha --require test-setup --recursive ./dist/**/__spec__/**/*-spec.js` | 
| [burtonator/polar-bookshelf](https://github.com/burtonator/polar-bookshelf) | 588 | `mocha-parallel-tests --timeout 10000 --max-parallel=1 --exit --recursive web/js/**/*Test.js` | 
...
| [brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) | 510 | `mocha test` | 
...
| [electron/electron-rebuild](https://github.com/electron/electron-rebuild) | 441 | `mocha --compilers ts:ts-node/register ./test/*.ts` | 
| [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators) | 427 | `mocha --opts mocha.opts` | 
| [szwacz/fs-jetpack](https://github.com/szwacz/fs-jetpack) | 420 | `mocha -r ts-node/register "spec/**/*.spec.ts"` | 
...
| [lukeautry/tsoa](https://github.com/lukeautry/tsoa) | 395 | `cross-env NODE_ENV=test mocha **/*.spec.ts --compilers ts:ts-node/register` | 
...
| [dsherret/ts-simple-ast](https://github.com/dsherret/ts-simple-ast) | 370 | `cross-env TS_NODE_COMPILER="ttypescript" mocha --opts mocha.opts` | 
...
| [cartant/rxjs-spy](https://github.com/cartant/rxjs-spy) | 292 | `yarn run lint && yarn run test:build && yarn run test:karma && yarn run test:mocha` | 
...
| [RisingStack/node-typescript-starter](https://github.com/RisingStack/node-typescript-starter) | 208 | `tsc && mocha dist/**/*.spec.js` | 
...
| [dolanmiu/docx](https://github.com/dolanmiu/docx) | 163 | `mocha-webpack "src/**/*.ts"` | 
...
| [hydux/hydux](https://github.com/hydux/hydux) | 130 | `npm run mocha -- "src/test/unit/*.test.ts"` | 
...
| [wonderful-panda/vue-tsx-support](https://github.com/wonderful-panda/vue-tsx-support) | 84 | `npm-run-all prettier tsc-test mocha` | 
...
| [flagello/Essence](https://github.com/flagello/Essence) | 72 | `mocha` | 
...
| [Azure/azure-cosmos-js](https://github.com/Azure/azure-cosmos-js) | 57 | `mocha -r ./src/test/common/setup.ts ./lib/test/ --recursive --timeout 100000 -i -g .*ignore.js` | 
...
| [matthiasferch/tsm](https://github.com/matthiasferch/tsm) | 51 | `mocha -r ts-node/register test/**/*.spec.ts` | 
